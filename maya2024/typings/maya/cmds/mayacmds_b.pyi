...
def backgroundEvaluationManager(flaginterrupt: boolean, flagmode: string, flagpause: boolean, flagresume: boolean) -> None:
    """Synopsis:
---
---
...
def bakeClip(flagblend: tuple[uint, uint], flagclipIndex: uint, flagkeepOriginals: boolean, flagname: string) -> string:
    """Synopsis:
---
---
...
def bakeDeformer(flagbakeRangeOfMotion: boolean, flagcolorizeSkeleton: boolean, flagcustomRangeOfMotion: timerange, flagdstMeshName: string, flagdstSkeletonName: string, flaghierarchy: boolean, flaginfluences: list[string], flagmaxInfluences: int, flagpruneWeights: float, flagsmoothWeights: int, flagsrcMeshName: string, flagsrcSkeletonName: string) -> string:
    """Synopsis:
---
---
...
def bakePartialHistory(flagallShapes: boolean, flagpostSmooth: boolean, flagpreCache: boolean, flagpreDeformers: boolean, flagprePostDeformers: boolean) -> string:
    """Synopsis:
---
---
...
def bakeResults(flaganimation: string, flagattribute: string, flagbakeOnOverrideLayer: boolean, flagcontrolPoints: boolean, flagdestinationLayer: string, flagdisableImplicitControl: boolean, flagfloat: floatrange, flaghierarchy: string, flagincludeUpperBound: boolean, flagindex: uint, flagminimizeRotation: boolean, flagoversamplingRate: uint, flagpreserveOutsideKeys: boolean, flagremoveBakedAnimFromLayer: boolean, flagremoveBakedAttributeFromLayer: boolean, flagresolveWithoutLayer: string, flagsampleBy: time, flagshape: boolean, flagsimulation: boolean, flagsmart: bool | list[boolean, float], flagsparseAnimCurveBake: boolean, flagtime: timerange) -> int:
    """Synopsis:
---
---
 bakeResults(
...
def bakeSimulation(flaganimation: string, flagattribute: string, flagbakeOnOverrideLayer: boolean, flagcontrolPoints: boolean, flagdestinationLayer: string, flagdisableImplicitControl: boolean, flagfloat: floatrange, flaghierarchy: string, flagincludeUpperBound: boolean, flagindex: uint, flagminimizeRotation: boolean, flagpreserveOutsideKeys: boolean, flagremoveBakedAnimFromLayer: boolean, flagremoveBakedAttributeFromLayer: boolean, flagresolveWithoutLayer: string, flagsampleBy: time, flagshape: boolean, flagsimulation: boolean, flagsmart: bool | list[boolean, float], flagsparseAnimCurveBake: boolean, flagtime: timerange) -> None:
    """Synopsis:
---
---
 bakeSimulation(
...
def baseTemplate(flagexists: boolean, flagfileName: string, flagforce: boolean, flagload: boolean, flagmatchFile: string, flagsilent: boolean, flagunload: boolean, flagviewList: string) -> None:
    """Synopsis:
---
---
...
def baseView(flagitemInfo: string, flagitemList: boolean, flagviewDescription: boolean, flagviewLabel: boolean, flagviewList: boolean, flagviewName: string) -> None:
    """Synopsis:
---
---
...
def batchRender(flagfilename: string, flagmelCommand: string, flagnumProcs: int, flagpreRenderCommand: string, flagremoteRenderMachine: string, flagrenderCommandOptions: string, flagshowImage: boolean, flagstatus: string, flaguseRemoteRender: boolean, flaguseStandalone: boolean, flagverbosity: int) -> None:
    """Synopsis:
---
---
...
def bevel(flagbevelShapeType: int, flagcaching: boolean, flagconstructionHistory: boolean, flagcornerType: int, flagdepth: linear, flagextrudeDepth: linear, flagjoinSurfaces: boolean, flagname: string, flagnodeState: int, flagnumberOfSides: int, flagobject: boolean, flagpolygon: int, flagrange: boolean, flagtolerance: linear, flagwidth: linear) -> list[string]:
    """Synopsis:
---
---
 bevel(
...
def bevelPlus(flagbevelInside: boolean, flagcapSides: int, flagconstructionHistory: boolean, flaginnerStyle: int, flagjoinSurfaces: boolean, flagname: string, flagnormalsOutwards: boolean, flagnumberOfSides: int, flagouterStyle: int, flagpolygon: int, flagrange: boolean) -> list[string]:
    """Synopsis:
---
---
 bevelPlus(
...
def bezierAnchorPreset(flagpreset: int) -> int:
    """Synopsis:
---
---
...
def bezierAnchorState(flageven: boolean, flagsmooth: boolean) -> int:
    """Synopsis:
---
---
...
def bezierInfo(flaganchorFromCV: int, flagcvFromAnchor: int, flagisAnchorSelected: boolean, flagisTangentSelected: boolean, flagonlyAnchorsSelected: boolean, flagonlyTangentsSelected: boolean) -> int:
    """Synopsis:
---
---
...
def binMembership(flagaddToBin: string, flagexists: string, flaginheritBinsFromNodes: name, flagisValidBinName: string, flaglistBins: boolean, flagmakeExclusive: string, flagnotifyChanged: boolean, flagremoveFromBin: string) -> boolean:
    """Synopsis:
---
---
...
def bindSkin(flagbyClosestPoint: boolean, flagbyPartition: boolean, flagcolorJoints: boolean, flagdelete: boolean, flagdoNotDescend: boolean, flagenable: boolean, flagname: string, flagpartition: string, flagtoAll: boolean, flagtoSelectedBones: boolean, flagtoSkeleton: boolean, flagunbind: boolean, flagunbindKeepHistory: boolean, flagunlock: boolean) -> string:
    """Synopsis:
---
---
 bindSkin(
...
def blend2(flagautoAnchor: boolean, flagautoNormal: boolean, flagcaching: boolean, flagconstructionHistory: boolean, flagcrvsInFirstRail: int, flagflipLeftNormal: boolean, flagflipRightNormal: boolean, flagleftAnchor: float, flagleftEnd: float, flagleftStart: float, flagmultipleKnots: boolean, flagname: string, flagnodeState: int, flagobject: boolean, flagpolygon: int, flagpositionTolerance: float, flagreverseLeft: boolean, flagreverseRight: boolean, flagrightAnchor: float, flagrightEnd: float, flagrightStart: float, flagtangentTolerance: float) -> list[string]:
    """Synopsis:
---
---
 blend2(
...
def blendShape(flagafter: boolean, flagafterReference: boolean, flagautomatic: boolean, flagbefore: boolean, flagcomponents: boolean, flagcopyDelta: tuple[uint, uint, uint], flagcopyInBetweenDelta: tuple[uint, uint, uint, uint], flagcopyWeights: tuple[uint, uint, uint], flagdeformerTools: boolean, flageditTarget: boolean, flagenvelope: float, flagexclusive: string, flagexport: string, flagexportTarget: tuple[int, int], flagflipTarget: tuple[uint, uint], flagfrontOfChain: boolean, flaggeometry: string, flaggeometryIndices: boolean, flagignoreSelected: boolean, flaginBetween: boolean, flaginBetweenIndex: uint, flaginBetweenType: string, flagincludeHiddenSelections: boolean, flagip: string, flagmergeSource: int, flagmergeTarget: uint, flagmirrorDirection: uint, flagmirrorTarget: tuple[uint, uint], flagname: string, flagnormalizationGroups: boolean, flagorigin: string, flagparallel: boolean, flagprune: boolean, flagremove: boolean, flagresetTargetDelta: tuple[uint, uint], flagselectedComponents: boolean, flagsplit: boolean, flagsuppressDialog: boolean, flagsymmetryAxis: string, flagsymmetryEdge: string, flagsymmetrySpace: uint, flagtangentSpace: boolean, flagtarget: [string, uint, string, float], flagtopologyCheck: boolean, flagtransform: string, flaguseComponentTags: boolean, flagweight: tuple[uint, float], flagweightCount: uint) -> list[string]:
    """Synopsis:
---
---
 blendShape(
...
def blendShapeEditor(flagcontrol: boolean, flagdefineTemplate: string, flagdocTag: string, flagexists: boolean, flagfilter: string, flagforceMainConnection: string, flaghighlightConnection: string, flaglockMainConnection: boolean, flagmainListConnection: string, flagpanel: string, flagparent: string, flagselectionConnection: string, flagstateString: boolean, flagtargetControlList: boolean, flagtargetList: boolean, flagunParent: boolean, flagunlockMainConnection: boolean, flagupdateMainConnection: boolean, flaguseTemplate: string, flagverticalSliders: boolean) -> string:
    """Synopsis:
---
---
 blendShapeEditor(
...
def blendTwoAttr(flagattribute: string, flagattribute0: name, flagattribute1: name, flagblender: name, flagcontrolPoints: boolean, flagdriver: int, flagname: string, flagshape: boolean, flagtime: timerange) -> list[string]:
    """Synopsis:
---
---
 blendTwoAttr(
...
def blindDataType(flagdataType: string, flaglongDataName: string, flaglongNames: boolean, flagquery: boolean, flagshortDataName: string, flagshortNames: boolean, flagtypeId: int, flagtypeNames: boolean) -> string:
    """Synopsis:
---
---
...
def bluePencilFrame(flagactiveViewport: boolean, flagclear: boolean, flagcopy: boolean, flagcutFrame: boolean, flagdelete: boolean, flagduplicate: boolean, flagexportFrames: boolean, flagimportFrames: boolean, flaginsert: boolean, flagmove: tuple[int, int, int], flagmoveCopy: tuple[int, int, int], flagmoveToNext: boolean, flagpaste: boolean, flagrelative: boolean, flagretime: int, flagscale: tuple[float, boolean, int, int], flagscaleCopy: tuple[float, boolean, int, int], flagstepBack: boolean, flagstepForward: boolean) -> None:
    """Synopsis:
---
---
...
def bluePencilLayer(flagactive: int, flagaddLayer: boolean, flagcount: boolean, flagdelete: int, flagdeleteAll: boolean, flageditLocked: tuple[boolean, int], flageditName: tuple[string, int], flageditOpacity: tuple[float, int], flageditState: tuple[int, int], flageditVis: tuple[boolean, int], flaginsert: int, flaglayerState: tuple[int, int], flagmove: tuple[int, int], flagmoveAll: boolean, flagname: tuple[string, int], flagnewCamera: string, flagqueryLocked: int, flagqueryName: int, flagqueryOpacity: int, flagqueryState: int, flagqueryVis: int) -> None:
    """Synopsis:
---
---
...
def bluePencilNode(flagcamera: string, flagexists: boolean, flagframe: boolean, flaglayer: boolean, flaglayerName: string, flaglayerState: uint, flagrefresh: boolean, flagrefreshGhosting: boolean) -> None:
    """Synopsis:
---
---
...
def bluePencilStroke(flagframeAdded: boolean, flaglayerAdded: int) -> None:
    """Synopsis:
---
---
...
def bluePencilUtil(flagadjustBrushSize: boolean, flagadjustOpacity: boolean, flagarrowOptions: tuple[int, int], flagarrowTool: boolean, flagbrushOptions: tuple[int, int, int, int, int], flagbrushTool: boolean, flagdraw: boolean, flagdrawColor: tuple[int, int, int], flagellipseOptions: tuple[int, int], flagellipseTool: boolean, flageraserOptions: tuple[int, int, int, int, int], flageraserTool: boolean, flagghostColorNext: tuple[int, int, int], flagghostColorOverride: boolean, flagghostColorPrevious: tuple[int, int, int], flagghostNext: boolean, flagghostNextCount: int, flagghostPrevious: boolean, flagghostPreviousCount: int, flaglayerManager: boolean, flaglayerProperties: boolean, flaglineOptions: tuple[int, int], flaglineTool: boolean, flagpencilOptions: tuple[int, int, int, int], flagpencilTool: boolean, flagrectangleOptions: tuple[int, int], flagrectangleTool: boolean, flagrefreshLayerManager: boolean, flagrefreshTimelineDisplay: boolean, flagresetTool: boolean, flagtextFontFamily: string, flagtextOptions: tuple[int, int, string], flagtextTool: boolean, flagtimelineFrameDisplay: int, flagtransform: boolean) -> None:
    """Synopsis:
---
---
...
def boneLattice(flagafter: boolean, flagafterReference: boolean, flagbefore: boolean, flagbicep: float, flagcomponents: boolean, flagdeformerTools: boolean, flagexclusive: string, flagfrontOfChain: boolean, flaggeometry: string, flaggeometryIndices: boolean, flagignoreSelected: boolean, flagincludeHiddenSelections: boolean, flagjoint: string, flaglengthIn: float, flaglengthOut: float, flagname: string, flagparallel: boolean, flagprune: boolean, flagremove: boolean, flagselectedComponents: boolean, flagsplit: boolean, flagtransform: string, flagtricep: float, flaguseComponentTags: boolean, flagwidthLeft: float, flagwidthRight: float) -> string:
    """Synopsis:
---
---
 boneLattice(
...
def boundary(flagcaching: boolean, flagconstructionHistory: boolean, flagendPoint: boolean, flagendPointTolerance: linear, flagname: string, flagnodeState: int, flagobject: boolean, flagorder: boolean, flagpolygon: int, flagrange: boolean) -> list[string]:
    """Synopsis:
---
---
 boundary(
...
def boxDollyCtx(flagalternateContext: boolean, flagexists: boolean, flaghistory: boolean, flagimage1: string, flagimage2: string, flagimage3: string, flagname: string, flagtoolName: string) -> string:
    """Synopsis:
---
---
...
def boxZoomCtx(flagexists: boolean, flaghistory: boolean, flagimage1: string, flagimage2: string, flagimage3: string, flagname: string, flagzoomScale: float) -> string:
    """Synopsis:
---
---
 boxZoomCtx(
...
def bufferCurve(flaganimation: string, flagattribute: string, flagcontrolPoints: boolean, flagexists: boolean, flagfloat: floatrange, flaghierarchy: string, flagincludeUpperBound: boolean, flagindex: uint, flagoverwrite: boolean, flagshape: boolean, flagswap: boolean, flagtime: timerange, flaguseReferencedCurve: boolean) -> int:
    """Synopsis:
---
---
 bufferCurve(
...
def buildBookmarkMenu(flageditor: string, flagtype: string) -> None:
    """Synopsis:
---
---
 buildBookmarkMenu(
...
def buttonManip(flagicon: string) -> None:
    """Synopsis:
---
---
 buttonManip(
