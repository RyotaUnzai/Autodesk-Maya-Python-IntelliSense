...
def tangentConstraint(aimVector: tuple[float, float, float], layer: string, name: string, remove: boolean, targetList: boolean, upVector: tuple[float, float, float], weight: float, weightAliasList: boolean, worldUpObject: name, worldUpType: string, worldUpVector: tuple[float, float, float]) -> list[string]:
    """Synopsis:
---
---
 tangentConstraint(
...
def targetWeldCtx(exists: boolean, image1: string, image2: string, image3: string, mergeToCenter: boolean, preserveUV: boolean) -> None:
    """Synopsis:
---
---
...
def texCutContext(adjustSize: boolean, displayShellBorders: boolean, edgeSelectSensitive: float, exists: boolean, history: boolean, image1: string, image2: string, image3: string, mode: string, moveRatio: float, name: string, size: float, steadyStroke: boolean, steadyStrokeDistance: float, touchToSew: boolean) -> boolean | float | string:
    """Synopsis:
---
---
 texCutContext(
...
def texLatticeDeformContext(envelope: float, exists: boolean, history: boolean, image1: string, image2: string, image3: string, latticeColumns: uint, latticeRows: uint, name: string, showMoveManipulator: boolean, snapPixelMode: boolean, useBoundingRect: boolean) -> boolean | float | int:
    """Synopsis:
---
---
...
def texManipContext(exists: boolean, image1: string, image2: string, image3: string) -> string:
    """Synopsis:
---
---
...
def texMoveContext(editPivotMode: boolean, exists: boolean, image1: string, image2: string, image3: string, position: boolean, snap: boolean, snapComponentsRelative: boolean, snapPixelMode: int, snapValue: float, tweakMode: boolean) -> string:
    """Synopsis:
---
---
 texMoveContext(
...
def texMoveUVShellContext(exists: boolean, image1: string, image2: string, image3: string, iterations: int, mask: boolean, position: boolean, shellBorder: float) -> string:
    """Synopsis:
---
---
...
def texRotateContext(editPivotMode: boolean, exists: boolean, image1: string, image2: string, image3: string, position: boolean, snap: boolean, snapRelative: boolean, snapValue: float, tweakMode: boolean) -> string:
    """Synopsis:
---
---
...
def texScaleContext(editPivotMode: boolean, exists: boolean, image1: string, image2: string, image3: string, position: boolean, preventNegativeScale: boolean, snap: boolean, snapRelative: boolean, snapValue: float, tweakMode: boolean) -> string:
    """Synopsis:
---
---
...
def texSculptCacheContext(adjustSize: boolean, adjustStrength: boolean, direction: int, falloffType: int, floodPin: float, grabTwist: boolean, inverted: boolean, mode: string, sculptFalloffCurve: string, showBrushRingDuringStroke: boolean, size: float, strength: float) -> None:
    """Synopsis:
---
---
...
def texSelectContext(exists: boolean, image1: string, image2: string, image3: string) -> string:
    """Synopsis:
---
---
...
def texSelectShortestPathCtx(exists: boolean, image1: string, image2: string, image3: string) -> None:
    """Synopsis:
---
---
...
def texSmudgeUVContext(dragSlider: string, effectType: string, exists: boolean, functionType: string, history: boolean, image1: string, image2: string, image3: string, name: string, pressure: float, radius: float, smudgeIsMiddle: boolean) -> string:
    """Synopsis:
---
---
 texSmudgeUVContext(
...
def texTweakUVContext(exists: boolean, image1: string, image2: string, image3: string, position: boolean, tolerance: float) -> string:
    """Synopsis:
---
---
 texTweakUVContext(
...
def texWinToolCtx(alternateContext: boolean, boxzoom: boolean, dolly: boolean, exists: boolean, history: boolean, image1: string, image2: string, image3: string, name: string, toolName: string, track: boolean) -> string:
    """Synopsis:
---
---
...
def text(align: string, annotation: string, backgroundColor: tuple[float, float, float], defineTemplate: string, docTag: string, dragCallback: script, dropCallback: script, dropRectCallback: script, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, font: string, fullPathName: boolean, height: int, highlightColor: tuple[float, float, float], hyperlink: boolean, isObscured: boolean, label: string, manage: boolean, noBackground: boolean, numberOfPopupMenus: boolean, parent: string, popupMenuArray: boolean, preventOverride: boolean, recomputeSize: boolean, statusBarMessage: string, useTemplate: string, visible: boolean, visibleChangeCommand: script, width: int, wordWrap: boolean) -> string:
    """Synopsis:
---
---
 text(
...
def textCurves(font: string, name: string, object: boolean, text: string) -> list[string]:
    """Synopsis:
---
---
 textCurves(
...
def textFieldGrp(adjustableColumn: int, adjustableColumn2: int, adjustableColumn3: int, adjustableColumn4: int, adjustableColumn5: int, adjustableColumn6: int, annotation: string, backgroundColor: tuple[float, float, float], changeCommand: script, columnAlign: tuple[int, string], columnAlign2: tuple[string, string], columnAlign3: tuple[string, string, string], columnAlign4: tuple[string, string, string, string], columnAlign5: tuple[string, string, string, string, string], columnAlign6: tuple[string, string, string, string, string, string], columnAttach: tuple[int, string, int], columnAttach2: tuple[string, string], columnAttach3: tuple[string, string, string], columnAttach4: tuple[string, string, string, string], columnAttach5: tuple[string, string, string, string, string], columnAttach6: tuple[string, string, string, string, string, string], columnOffset2: tuple[int, int], columnOffset3: tuple[int, int, int], columnOffset4: tuple[int, int, int, int], columnOffset5: tuple[int, int, int, int, int], columnOffset6: tuple[int, int, int, int, int, int], columnWidth: tuple[int, int], columnWidth1: int, columnWidth2: tuple[int, int], columnWidth3: tuple[int, int, int], columnWidth4: tuple[int, int, int, int], columnWidth5: tuple[int, int, int, int, int], columnWidth6: tuple[int, int, int, int, int, int], defineTemplate: string, docTag: string, dragCallback: script, dropCallback: script, editable: boolean, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, fileName: string, forceChangeCommand: boolean, fullPathName: boolean, height: int, highlightColor: tuple[float, float, float], insertText: string, insertionPosition: int, isObscured: boolean, label: string, manage: boolean, noBackground: boolean, numberOfPopupMenus: boolean, parent: string, placeholderText: string, popupMenuArray: boolean, preventOverride: boolean, rowAttach: tuple[int, string, int], statusBarMessage: string, text: string, textChangedCommand: script, useTemplate: string, visible: boolean, visibleChangeCommand: script, width: int) -> string:
    """Synopsis:
---
---
 textFieldGrp(
...
def textManip(visible: boolean) -> None:
    """Synopsis:
---
---
...
def textureDeformer(after: boolean, afterReference: boolean, before: boolean, components: boolean, deformerTools: boolean, direction: string, envelope: float, exclusive: string, frontOfChain: boolean, geometry: string, geometryIndices: boolean, ignoreSelected: boolean, includeHiddenSelections: boolean, name: string, offset: float, parallel: boolean, pointSpace: string, prune: boolean, remove: boolean, selectedComponents: boolean, split: boolean, strength: float, useComponentTags: boolean, vectorOffset: tuple[float, float, float], vectorSpace: string, vectorStrength: tuple[float, float, float]) -> string:
    """Synopsis:
---
---
 textureDeformer(
...
def texturePlacementContext(exists: boolean, history: boolean, image1: string, image2: string, image3: string, labelMapping: boolean, name: string) -> string:
    """Synopsis:
---
---
...
def threePointArcCtx(degree: uint, exists: boolean, history: boolean, image1: string, image2: string, image3: string, name: string, spans: uint) -> string:
    """Synopsis:
---
---
...
def thumbnailCaptureComponent(capture: boolean, capturedFrameCount: boolean, closeCurrentSession: boolean, delete: boolean, endFrame: int, fileDialogCallback: string, isSessionOpened: boolean, launchedFromOptionsBox: boolean, previewPath: boolean, removeProjectThumbnail: string, save: string, startFrame: int) -> None:
    """Synopsis:
---
---
...
def timeEditor(allClips: string, clipId: int, commonParentTrack: boolean, composition: string, drivingClipsForAttr: string, drivingClipsForObj: tuple[string, int], includeParent: boolean, mute: boolean, selectedClips: string, topLevelClips: string) -> string:
    """Synopsis:
---
---
...
def timeEditorAnimSource(addObjects: string, addRelatedKG: boolean, addSelectedObjects: boolean, addSource: string, apply: boolean, attribute: string, bakeToAnimSource: string, calculateTiming: boolean, copyAnimation: boolean, drivenClips: boolean, exclusive: boolean, export: string, importAllFbxTakes: boolean, importFbx: string, importFbxTakes: string, importMayaFile: string, importOption: string, importPopulateOption: string, importedContainerNames: string, includeRoot: boolean, isUnique: boolean, populateImportedAnimSources: string, poseClip: boolean, recursively: boolean, removeSceneAnimation: boolean, removeSource: string, showAnimSourceRemapping: boolean, takeList: string, takesToImport: string, targetIndex: string, targets: boolean, type: string) -> string:
    """Synopsis:
---
---
...
def timeEditorBakeClips(bakeToAnimSource: string, bakeToClip: string, clipId: int, combineLayers: boolean, forceSampling: boolean, keepOriginalClip: boolean, path: string, sampleBy: time, targetTrackIndex: int, targetTracksNode: string) -> int:
    """Synopsis:
---
---
 timeEditorBakeClips(
...
def timeEditorClipLayer(addAttribute: string, addLayer: string, addObject: string, allLayers: boolean, attribute: string, attributeKeyable: string, clipId: int, index: int, keySiblings: boolean, layerId: int, layerName: string, mode: int, mute: boolean, name: boolean, path: string, removeAttribute: string, removeLayer: boolean, removeObject: string, resetSolo: boolean, setKeyframe: boolean, solo: boolean, zeroKeying: boolean) -> string:
    """Synopsis:
---
---
...
def timeEditorClipOffset(applyToAllRoots: boolean, clipId: int, matchClipId: int, matchDstTime: time, matchObj: name, matchOffsetRot: boolean, matchOffsetTrans: boolean, matchPath: string, matchRotOp: int, matchSrcTime: time, matchTransOp: int, offsetTransform: boolean, path: string, resetMatch: int, resetMatchPath: string, rootObj: string, upVectorX: float, upVectorY: float, upVectorZ: float) -> None:
    """Synopsis:
---
---
...
def timeEditorComposition(active: boolean, allCompositions: boolean, createTrack: boolean, delete: boolean, duplicateFrom: string, rename: tuple[string, string], tracksNode: boolean) -> string:
    """Synopsis:
---
---
...
def timeEditorTracks(activeClipWeight: time, activeClipWeightId: time, addTrack: int, allClips: boolean, allTracks: boolean, allTracksRecursive: boolean, composition: boolean, path: string, plugIndex: int, removeTrack: int, removeTrackByPath: string, reorderTrack: tuple[int, int], resetMute: boolean, resetSolo: boolean, selectedTracks: boolean, trackGhost: boolean, trackIndex: int, trackMuted: boolean, trackName: string, trackSolo: boolean, trackType: int) -> Int:
    """Synopsis:
---
---
...
def timePort(annotation: string, backgroundColor: tuple[float, float, float], defineTemplate: string, docTag: string, dragCallback: script, dropCallback: script, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, fullPathName: boolean, globalTime: boolean, height: int, highlightColor: tuple[float, float, float], isObscured: boolean, manage: boolean, noBackground: boolean, numberOfPopupMenus: boolean, parent: string, popupMenuArray: boolean, preventOverride: boolean, snap: boolean, statusBarMessage: string, useTemplate: string, visible: boolean, visibleChangeCommand: script, width: int) -> string:
    """Synopsis:
---
---
 timePort(
...
def timeWarp(deleteFrame: int, frame: float, g: boolean, interpType: tuple[int, string], moveFrame: tuple[int, float]) -> string:
    """Synopsis:
---
---
...
def timer(endTimer: boolean, lapTime: boolean, name: string, startTimer: boolean) -> None:
    """Synopsis:
---
---
...
def toggleAxis(origin: boolean, view: boolean) -> boolean:
    """Synopsis:
---
---
...
def tolerance(angular: angle, linear: linear) -> None:
    """Synopsis:
---
---
...
def toolButton(allowMultipleTools: boolean, annotation: string, backgroundColor: tuple[float, float, float], changeCommand: script, collection: string, defineTemplate: string, docTag: string, doubleClickCommand: script, dragCallback: script, dropCallback: script, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, fullPathName: boolean, height: int, highlightColor: tuple[float, float, float], image1: string, image2: string, image3: string, imageOverlayLabel: string, isObscured: boolean, manage: boolean, noBackground: boolean, numberOfPopupMenus: boolean, offCommand: script, onCommand: script, parent: string, popupIndicatorVisible: boolean, popupMenuArray: boolean, preventOverride: boolean, select: boolean, statusBarMessage: string, style: string, tool: string, toolArray: boolean, toolCount: boolean, toolImage1: tuple[string, string], toolImage2: tuple[string, string], toolImage3: tuple[string, string], useTemplate: string, version: string, visible: boolean, visibleChangeCommand: script, width: int) -> string:
    """Synopsis:
---
---
 toolButton(
...
def toolCollection(collectionItemArray: boolean, defineTemplate: string, exists: boolean, gl: boolean, numberOfCollectionItems: boolean, parent: string, select: string, useTemplate: string) -> string:
    """Synopsis:
---
---
 toolCollection(
...
def toolPropertyWindow(field: string, helpButton: string, icon: string, inMainWindow: boolean, location: string, noviceMode: boolean, resetButton: string, restore: boolean, selectCommand: string, showCommand: string) -> None:
    """Synopsis:
---
---
...
def track(down: linear, left: linear, right: linear, upDistance01: linear, upDistance02: linear) -> None:
    """Synopsis:
---
---
 track(
...
def trackCtx(alternateContext: boolean, exists: boolean, history: boolean, image1: string, image2: string, image3: string, name: string, toolName: string, trackGeometry: boolean, trackScale: float) -> string:
    """Synopsis:
---
---
...
def transferShadingSets(sampleSpace: uint, searchMethod: uint) -> None:
    """Synopsis:
---
---
...
def transformCompare(root: boolean) -> int:
    """Synopsis:
---
---
 transformCompare(
...
def transformLimits(enableRotationX: tuple[boolean, boolean], enableRotationY: tuple[boolean, boolean], enableRotationZ: tuple[boolean, boolean], enableScaleX: tuple[boolean, boolean], enableScaleY: tuple[boolean, boolean], enableScaleZ: tuple[boolean, boolean], enableTranslationX: tuple[boolean, boolean], enableTranslationY: tuple[boolean, boolean], enableTranslationZ: tuple[boolean, boolean], remove: boolean, rotationX: tuple[angle, angle], rotationY: tuple[angle, angle], rotationZ: tuple[angle, angle], scaleX: tuple[float, float], scaleY: tuple[float, float], scaleZ: tuple[float, float], translationX: tuple[linear, linear], translationY: tuple[linear, linear], translationZ: tuple[linear, linear]) -> None:
    """Synopsis:
---
---
 transformLimits(
...
def translator(defaultFileRule: boolean, defaultOptions: string, extension: boolean, fileCompression: string, filter: boolean, findTranslator: tuple[string, int], list: boolean, loaded: boolean, objectType: boolean, optionsScript: boolean, readSupport: boolean, writeSupport: boolean) -> boolean:
    """Synopsis:
---
---
 translator(
...
def treeView(addItem: tuple[string, string], allowDragAndDrop: boolean, allowHiddenParents: boolean, allowMultiSelection: boolean, allowReparenting: boolean, annotation: string, attachButtonRight: int, backgroundColor: tuple[float, float, float], borderHighlite: tuple[string, boolean], borderHighliteColor: tuple[string, float, float, float], buttonErase: tuple[string, boolean], buttonState: tuple[string, int, string], buttonStyle: tuple[string, int, string], buttonTextIcon: tuple[string, int, string], buttonTooltip: tuple[string, int, string], buttonTransparencyColor: tuple[string, int, float, float, float], buttonTransparencyOverride: tuple[string, int, boolean], buttonVisible: tuple[string, int, boolean], children: string, clearSelection: boolean, contextMenuCommand: script, defineTemplate: string, displayLabel: tuple[string, string], displayLabelSuffix: tuple[string, string], docTag: string, dragAndDropCommand: script, dragCallback: script, dropCallback: script, editLabelCommand: script, enable: boolean, enableBackground: boolean, enableButton: tuple[string, int, int], enableKeyboardFocus: boolean, enableKeys: boolean, enableLabel: tuple[string, int], exists: boolean, expandCollapseCommand: script, expandItem: tuple[string, boolean], flatButton: int, font: tuple[string, string], fontFace: tuple[string, int], fullPathName: boolean, height: int, hideButtons: boolean, highlightColor: tuple[float, float, float], highlite: tuple[string, boolean], highliteColor: tuple[string, float, float, float], ignoreButtonClick: tuple[string, int, int], image: tuple[string, int, string], insertItem: tuple[string, string, int], isItemExpanded: string, isLeaf: string, isObscured: boolean, item: string, itemAnnotation: tuple[string, string], itemDblClickCommand: script, itemDblClickCommand2: script, itemExists: string, itemIndex: string, itemParent: string, itemRenamedCommand: script, itemSelected: string, itemVisible: tuple[string, boolean], labelBackgroundColor: tuple[string, float, float, float], manage: boolean, noBackground: boolean, numberOfButtons: int, numberOfPopupMenus: boolean, ornament: tuple[string, int, int, int], ornamentColor: tuple[string, float, float, float], parent: string, popupMenuArray: boolean, pressCommand: tuple[int, script], preventOverride: boolean, removeAll: boolean, removeItem: string, reverseTreeOrder: boolean, rightPressCommand: tuple[int, script], select: tuple[string, int], selectCommand: script, selectItem: tuple[string, boolean], selectionChangedCommand: script, selectionColor: tuple[string, float, float, float], showItem: string, statusBarMessage: string, textColor: tuple[string, float, float, float], useTemplate: string, verticalScrollPosition: int, visible: boolean, visibleChangeCommand: script, width: int) -> string:
    """Synopsis:
---
---
 treeView(
...
def trim(caching: boolean, constructionHistory: boolean, locatorU: float, locatorV: float, name: string, nodeState: int, object: boolean, selected: int, shrink: boolean, tolerance: linear) -> list[string]:
    """Synopsis:
---
---
 trim(
...
def tumble(azimuthAngle: angle, elevationAngle: angle, localTumble: int, pivotPoint: tuple[linear, linear, linear], rotationAngles: tuple[angle, angle]) -> None:
    """Synopsis:
---
---
 tumble(
...
def tumbleCtx(alternateContext: boolean, autoOrthoConstrain: boolean, autoSetPivot: boolean, exists: boolean, history: boolean, image1: string, image2: string, image3: string, localTumble: int, name: string, objectTumble: boolean, orthoLock: boolean, orthoStep: angle, toolName: string, tumbleScale: float) -> string:
    """Synopsis:
---
---
...
def turbulence(attenuation: float, frequency: float, magnitude: float, maxDistance: linear, name: string, noiseLevel: int, noiseRatio: float, perVertex: boolean, phase: float, phaseX: float, phaseY: float, phaseZ: float, position: tuple[linear, linear, linear], torusSectionRadius: linear, volumeExclusion: boolean, volumeOffset: tuple[linear, linear, linear], volumeShape: string, volumeSweep: angle) -> string:
    """Synopsis:
---
---
 turbulence(
...
def twoPointArcCtx(degree: uint, exists: boolean, history: boolean, image1: string, image2: string, image3: string, name: string, spans: uint) -> string:
    """Synopsis:
---
---
