...
def nBase(clearCachedTextureMap: string, clearStart: boolean, stuffStart: boolean, textureToVertex: string) -> boolean:
    """Synopsis:
---
---
...
def nParticle(attribute: string, cache: boolean, conserve: float, count: boolean, deleteCache: boolean, dynamicAttrList: boolean, floatValue: float, gridSpacing: linear, inherit: float, jitterBasePoint: tuple[linear, linear, linear], jitterRadius: linear, lowerLeft: tuple[linear, linear, linear], name: string, numJitters: uint, order: int, particleId: int, perParticleDouble: boolean, perParticleVector: boolean, position: tuple[linear, linear, linear], shapeName: string, upperRight: tuple[linear, linear, linear], vectorValue: tuple[float, float, float]) -> string:
    """Synopsis:
---
---
 nParticle(
...
def nSoft(convert: boolean, duplicate: boolean, duplicateHistory: boolean, goal: float, hideOriginal: boolean) -> string:
    """Synopsis:
---
---
 nSoft(
...
def nameCommand(annotation: string, command: script, data1: string, data2: string, data3: string, default: boolean, sourceType: string) -> string:
    """Synopsis:
---
---
 nameCommand(
...
def nameField(annotation: string, backgroundColor: tuple[float, float, float], changeCommand: script, defineTemplate: string, docTag: string, dragCallback: script, drawInactiveFrame: boolean, dropCallback: script, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, fullPathName: boolean, height: int, highlightColor: tuple[float, float, float], isObscured: boolean, manage: boolean, nameChangeCommand: script, noBackground: boolean, numberOfPopupMenus: boolean, object: string, parent: string, popupMenuArray: boolean, preventOverride: boolean, receiveFocusCommand: script, statusBarMessage: string, useTemplate: string, visible: boolean, visibleChangeCommand: script, width: int) -> string:
    """Synopsis:
---
---
 nameField(
...
def namespace(absoluteName: boolean, addNamespace: string, collapseAncestors: string, deleteNamespaceContent: boolean, exists: string, force: boolean, isRootNamespace: string, mergeNamespaceWithOther: string, mergeNamespaceWithParent: boolean, mergeNamespaceWithRoot: boolean, moveNamespace: tuple[string, string], parent: string, recurse: boolean, relativeNames: boolean, removeNamespace: string, rename: tuple[string, string], setNamespace: string, validateName: string) -> string:
    """Synopsis:
---
---
 namespace(
...
def namespaceInfo(absoluteName: boolean, baseName: boolean, currentNamespace: boolean, dagPath: boolean, fullName: boolean, internal: boolean, isRootNamespace: boolean, listNamespace: boolean, listOnlyDependencyNodes: boolean, listOnlyNamespaces: boolean, parent: boolean, recurse: boolean, shortName: boolean) -> string:
    """Synopsis:
---
---
 namespaceInfo(
...
def newton(attenuation: float, magnitude: float, maxDistance: linear, minDistance: float, name: string, perVertex: boolean, position: tuple[linear, linear, linear], torusSectionRadius: linear, volumeExclusion: boolean, volumeOffset: tuple[linear, linear, linear], volumeShape: string, volumeSweep: angle) -> string:
    """Synopsis:
---
---
 newton(
...
def nodeCast(copyDynamicAttrs: boolean, disableAPICallbacks: boolean, disableScriptJobCallbacks: boolean, disconnectUnmatchedAttrs: boolean, force: boolean, swapNames: boolean, swapValues: boolean) -> int:
    """Synopsis:
---
---
...
def nodePreset(attributes: string, custom: string, delete: tuple[name, string], exists: tuple[name, string], isValidName: string, list: name, load: tuple[name, string], save: tuple[name, string]) -> boolean:
    """Synopsis:
---
---
...
def nodeType(apiType: boolean, derived: boolean, inherited: boolean, isTypeName: boolean, ufeRuntimeName: boolean) -> list[string] | string:
    """Synopsis:
---
---
 nodeType(
...
def nonLinear(after: boolean, afterReference: boolean, autoParent: boolean, before: boolean, commonParent: boolean, components: boolean, defaultScale: boolean, deformerTools: boolean, exclusive: string, frontOfChain: boolean, geometry: string, geometryIndices: boolean, ignoreSelected: boolean, includeHiddenSelections: boolean, name: string, parallel: boolean, prune: boolean, remove: boolean, selectedComponents: boolean, split: boolean, type: string, useComponentTags: boolean) -> list[string]:
    """Synopsis:
---
---
 nonLinear(
...
def normalConstraint(aimVector: tuple[float, float, float], layer: string, name: string, remove: boolean, targetList: boolean, upVector: tuple[float, float, float], weight: float, weightAliasList: boolean, worldUpObject: name, worldUpType: string, worldUpVector: tuple[float, float, float]) -> list[string]:
    """Synopsis:
---
---
 normalConstraint(
...
def nurbsBoolean(caching: boolean, constructionHistory: boolean, name: string, nodeState: int, nsrfsInFirstShell: int, object: boolean, operation: int, smartConnection: boolean, tolerance: linear) -> list[string]:
    """Synopsis:
---
---
 nurbsBoolean(
...
def nurbsCube(axis: tuple[linear, linear, linear], caching: boolean, constructionHistory: boolean, degree: int, heightRatio: float, lengthRatio: float, name: string, nodeState: int, object: boolean, patchesU: int, patchesV: int, pivot: tuple[linear, linear, linear], polygon: int, width: linear) -> list[string]:
    """Synopsis:
---
---
...
def nurbsEditUV(angle: float, pivotU: float, pivotV: float, relative: boolean, rotateRatio: float, rotation: boolean, scale: boolean, scaleU: float, scaleV: float, uValue: float, vValue: float) -> boolean:
    """Synopsis:
---
---
...
def nurbsPlane(axis: tuple[linear, linear, linear], caching: boolean, constructionHistory: boolean, degree: int, lengthRatio: float, name: string, nodeState: int, object: boolean, patchesU: int, patchesV: int, pivot: tuple[linear, linear, linear], polygon: int, width: linear) -> list[string]:
    """Synopsis:
---
---
...
def nurbsSelect(borderSelection: boolean, bottomBorder: boolean, growSelection: int, leftBorder: boolean, rightBorder: boolean, shrinkSelection: int, topBorder: boolean) -> None:
    """Synopsis:
---
---
...
def nurbsToPoly(caching: boolean, constructionHistory: boolean, curvatureTolerance: int, explicitTessellationAttributes: boolean, name: string, nodeState: int, object: boolean, smoothEdge: boolean, smoothEdgeRatio: float, uDivisionsFactor: float, vDivisionsFactor: float) -> list[string]:
    """Synopsis:
---
---
 nurbsToPoly(
...
def nurbsToSubdiv(addUnderTransform: boolean, caching: boolean, collapsePoles: boolean, constructionHistory: boolean, matchPeriodic: boolean, maxPolyCount: int, name: string, nodeState: int, object: boolean, reverseNormal: boolean) -> list[string]:
    """Synopsis:
---
---
 nurbsToSubdiv(
...
def nurbsUVSet(create: boolean, useExplicit: boolean) -> boolean:
    """Synopsis:
---
---
