...
def iconTextCheckBox(flagalign: string, flagannotation: string, flagbackgroundColor: tuple[float, float, float], flagchangeCommand: script, flagdefineTemplate: string, flagdisabledImage: string, flagdocTag: string, flagdragCallback: script, flagdropCallback: script, flagenable: boolean, flagenableBackground: boolean, flagenableKeyboardFocus: boolean, flagexists: boolean, flagflat: boolean, flagflipX: boolean, flagflipY: boolean, flagfont: string, flagfullPathName: boolean, flagheight: int, flaghighlightColor: tuple[float, float, float], flaghighlightImage: string, flagimage: string, flagimage1: string, flagimage2: string, flagimage3: string, flagimageOverlayLabel: string, flagisObscured: boolean, flaglabel: string, flaglabelOffset: int, flagmanage: boolean, flagmarginHeight: uint, flagmarginWidth: uint, flagnoBackground: boolean, flagnumberOfPopupMenus: boolean, flagoffCommand: script, flagonCommand: script, flagoverlayLabelBackColor: tuple[float, float, float, float], flagoverlayLabelColor: tuple[float, float, float], flagparent: string, flagpopupMenuArray: boolean, flagpreventOverride: boolean, flagrotation: float, flagselectionHighlightImage: string, flagselectionImage: string, flagstatusBarMessage: string, flagstyle: string, flaguseAlpha: boolean, flaguseTemplate: string, flagvalue: boolean, flagversion: string, flagvisible: boolean, flagvisibleChangeCommand: script, flagwidth: int) -> string:
    """Synopsis:
---
---
 iconTextCheckBox(
...
def iconTextRadioButton(flagalign: string, flagannotation: string, flagbackgroundColor: tuple[float, float, float], flagchangeCommand: script, flagcollection: string, flagdefineTemplate: string, flagdisabledImage: string, flagdocTag: string, flagdragCallback: script, flagdropCallback: script, flagenable: boolean, flagenableBackground: boolean, flagenableKeyboardFocus: boolean, flagexists: boolean, flagflat: boolean, flagflipX: boolean, flagflipY: boolean, flagfont: string, flagfullPathName: boolean, flagheight: int, flaghighlightColor: tuple[float, float, float], flaghighlightImage: string, flagimage: string, flagimage1: string, flagimage2: string, flagimage3: string, flagimageOverlayLabel: string, flagisObscured: boolean, flaglabel: string, flaglabelOffset: int, flagmanage: boolean, flagmarginHeight: uint, flagmarginWidth: uint, flagnoBackground: boolean, flagnumberOfPopupMenus: boolean, flagoffCommand: script, flagonCommand: script, flagoverlayLabelBackColor: tuple[float, float, float, float], flagoverlayLabelColor: tuple[float, float, float], flagparent: string, flagpopupMenuArray: boolean, flagpreventOverride: boolean, flagrotation: float, flagselect: boolean, flagselectionHighlightImage: string, flagselectionImage: string, flagstatusBarMessage: string, flagstyle: string, flaguseAlpha: boolean, flaguseTemplate: string, flagversion: string, flagvisible: boolean, flagvisibleChangeCommand: script, flagwidth: int) -> string:
    """Synopsis:
---
---
 iconTextRadioButton(
...
def iconTextRadioCollection(flagcollectionItemArray: boolean, flagdefineTemplate: string, flagdisableCommands: boolean, flagexists: boolean, flaggl: boolean, flagnumberOfCollectionItems: boolean, flagparent: string, flagselect: string, flaguseTemplate: string) -> string:
    """Synopsis:
---
---
...
def iconTextScrollList(flagallowMultiSelection: boolean, flagannotation: string, flagappend: string, flagbackgroundColor: tuple[float, float, float], flagchangeCommand: script, flagdefineTemplate: string, flagdeselectAll: boolean, flagdocTag: string, flagdoubleClickCommand: script, flagdragCallback: script, flagdragFeedbackVisible: boolean, flagdropCallback: script, flagdropRectCallback: script, flageditIndexed: uint, flageditable: boolean, flagenable: boolean, flagenableBackground: boolean, flagenableKeyboardFocus: boolean, flagexists: boolean, flagfullPathName: boolean, flagheight: int, flaghighlightColor: tuple[float, float, float], flagisObscured: boolean, flagitemAt: tuple[int, int], flagitemTextColor: tuple[int, float, float, float], flagmanage: boolean, flagnoBackground: boolean, flagnumberOfIcons: uint, flagnumberOfPopupMenus: boolean, flagnumberOfRows: boolean, flagparent: string, flagpopupMenuArray: boolean, flagpreventOverride: boolean, flagremoveAll: boolean, flagselectCommand: script, flagselectIndexedItem: int, flagselectItem: string, flagstatusBarMessage: string, flaguseTemplate: string, flagvisible: boolean, flagvisibleChangeCommand: script, flagvisualRectAt: tuple[int, int], flagwidth: int) -> string:
    """Synopsis:
---
---
 iconTextScrollList(
...
def ikHandle(flagautoPriority: boolean, flagconnectEffector: boolean, flagcreateCurve: boolean, flagcreateRootAxis: boolean, flagcurve: name, flagdisableHandles: boolean, flagenableHandles: boolean, flagendEffector: string, flagexists: string, flagforceSolver: boolean, flagfreezeJoints: boolean, flagjointList: boolean, flagname: string, flagnumSpans: int, flagparentCurve: boolean, flagpositionWeight: float, flagpriority: int, flagrootOnCurve: boolean, flagrootTwistMode: boolean, flagsetupForRPsolver: boolean, flagsimplifyCurve: boolean, flagsnapCurve: boolean, flagsnapHandleFlagToggle: boolean, flagsnapHandleToEffector: boolean, flagsolver: string, flagstartJoint: string, flagsticky: string, flagtwistType: string, flagweight: float) -> string:
    """Synopsis:
---
---
 ikHandle(
...
def ikHandleCtx(flagautoPriorityH: boolean, flagcreateCurve: boolean, flagcreateRootAxis: boolean, flagexists: boolean, flagforceSolverH: boolean, flaghistory: boolean, flagimage1: string, flagimage2: string, flagimage3: string, flagname: string, flagnumSpans: int, flagparentCurve: boolean, flagpoWeightH: float, flagpriorityH: int, flagrootOnCurve: boolean, flagrootTwistMode: boolean, flagsimplifyCurve: boolean, flagsnapCurve: boolean, flagsnapHandleH: boolean, flagsolverTypeH: string, flagstickyH: string, flagtwistType: string, flagweightH: float) -> string:
    """Synopsis:
---
---
 ikHandleCtx(
...
def ikSolver(flagepsilon: float, flagmaxIterations: int, flagname: string, flagsolverType: string) -> string:
    """Synopsis:
---
---
 ikSolver(
...
def ikSplineHandleCtx(flagautoPriorityH: boolean, flagcreateCurve: boolean, flagcreateRootAxis: boolean, flagexists: boolean, flagforceSolverH: boolean, flaghistory: boolean, flagimage1: string, flagimage2: string, flagimage3: string, flagname: string, flagnumSpans: int, flagparentCurve: boolean, flagpoWeightH: float, flagpriorityH: int, flagrootOnCurve: boolean, flagrootTwistMode: boolean, flagsimplifyCurve: boolean, flagsnapCurve: boolean, flagsnapHandleH: boolean, flagsolverTypeH: string, flagstickyH: string, flagtwistType: string, flagweightH: float) -> string:
    """Synopsis:
---
---
 ikSplineHandleCtx(
...
def ikSystem(flagallowRotation: boolean, flagautoPriority: boolean, flagautoPriorityMC: boolean, flagautoPrioritySC: boolean, flaglist: tuple[int, int], flagsnap: boolean, flagsolve: boolean, flagsolverTypes: boolean) -> string:
    """Synopsis:
---
---
 ikSystem(
...
def ikSystemInfo(flagglobalSnapHandle: boolean) -> None:
    """Synopsis:
---
---
 ikSystemInfo(
...
def ikfkDisplayMethod(flagdisplay: string) -> None:
    """Synopsis:
---
---
...
def illustratorCurves(flagcaching: boolean, flagconstructionHistory: boolean, flagillustratorFilename: string, flagnodeState: int, flagobject: boolean, flagtolerance: float) -> list[string]:
    """Synopsis:
---
---
 illustratorCurves(
...
def imagePlane(flagcamera: string, flagcounter: boolean, flagdetach: boolean, flagdropFrame: boolean, flagfileName: string, flagframeDuration: int, flagheight: float, flagimageSize: tuple[int, int], flaglookThrough: string, flagmaintainRatio: boolean, flagname: string, flagnegTimesOK: boolean, flagnumFrames: int, flagquickTime: boolean, flagshowInAllViews: boolean, flagtimeCode: int, flagtimeCodeTrack: boolean, flagtimeScale: int, flagtwentyFourHourMax: boolean, flagwidth: float) -> boolean:
    """Synopsis:
---
---
...
def imfPlugins(flagextension: string, flagkeyword: string, flagmultiFrameSupport: string, flagpluginName: string, flagreadSupport: string, flagwriteSupport: string) -> list[string]:
    """Synopsis:
---
---
...
def inViewEditor(flagvisible: boolean) -> None:
    """Synopsis:
---
---
...
def inViewMessage(flagalpha: float, flagassistMessage: string, flagbackColor: uint, flagclear: string, flagclickKill: boolean, flagdragKill: boolean, flagfade: boolean, flagfadeInTime: uint, flagfadeOutTime: uint, flagfadeStayTime: uint, flagfont: string, flagfontSize: uint, flagframeOffset: uint, flaghide: boolean, flagmessage: string, flagminimize: boolean, flagposition: string, flagrestore: boolean, flagshow: boolean, flagstatusMessage: string, flagtextAlpha: float, flagtextOffset: uint, flaguvEditor: boolean) -> None:
    """Synopsis:
---
---
...
def inheritTransform(flagoff: boolean, flagon: boolean, flagpreserve: boolean, flagtoggle: boolean) -> None:
    """Synopsis:
---
---
 inheritTransform(
...
def insertJointCtx(flagexists: boolean, flagimage1: string, flagimage2: string, flagimage3: string) -> string:
    """Synopsis:
---
---
...
def insertKeyCtx(flagbreakdown: boolean, flagexists: boolean, flaghistory: boolean, flagimage1: string, flagimage2: string, flagimage3: string, flagname: string, flagpreserveTangent: boolean) -> string:
    """Synopsis:
---
---
 insertKeyCtx(
...
def insertKnotCurve(flagaddKnots: boolean, flagcaching: boolean, flagconstructionHistory: boolean, flagcurveOnSurface: boolean, flaginsertBetween: boolean, flagname: string, flagnodeState: int, flagnumberOfKnots: int, flagobject: boolean, flagparameter: float, flagreplaceOriginal: boolean) -> list[string]:
    """Synopsis:
---
---
 insertKnotCurve(
...
def insertKnotSurface(flagaddKnots: boolean, flagcaching: boolean, flagconstructionHistory: boolean, flagdirection: int, flaginsertBetween: boolean, flagname: string, flagnodeState: int, flagnumberOfKnots: int, flagobject: boolean, flagparameter: float, flagreplaceOriginal: boolean) -> list[string]:
    """Synopsis:
---
---
 insertKnotSurface(
...
def instance(flagleaf: boolean, flagname: string, flagsmartTransform: boolean) -> string:
    """Synopsis:
---
---
 instance(
...
def instanceable(flagallow: boolean, flagrecursive: boolean, flagshape: boolean) -> boolean[]:
    """Synopsis:
---
---
...
def instancer(flagaddObject: boolean, flagcycle: string, flagcycleStep: float, flagcycleStepUnits: string, flagindex: int, flaglevelOfDetail: string, flagname: string, flagobject: string, flagobjectPosition: string, flagobjectRotation: string, flagobjectScale: string, flagpointDataSource: boolean, flagremoveObject: boolean, flagrotationOrder: string, flagrotationUnits: string, flagvalueName: string) -> string:
    """Synopsis:
---
---
...
def intField(flagannotation: string, flagbackgroundColor: tuple[float, float, float], flagchangeCommand: script, flagdefineTemplate: string, flagdocTag: string, flagdragCallback: script, flagdragCommand: script, flagdropCallback: script, flageditable: boolean, flagenable: boolean, flagenableBackground: boolean, flagenableKeyboardFocus: boolean, flagenterCommand: script, flagexists: boolean, flagfullPathName: boolean, flagheight: int, flaghighlightColor: tuple[float, float, float], flagisObscured: boolean, flagmanage: boolean, flagmaxValue: int, flagminValue: int, flagnoBackground: boolean, flagnumberOfPopupMenus: boolean, flagparent: string, flagpopupMenuArray: boolean, flagpreventOverride: boolean, flagreceiveFocusCommand: script, flagstatusBarMessage: string, flagstep: int, flaguseTemplate: string, flagvalue: int, flagvisible: boolean, flagvisibleChangeCommand: script, flagwidth: int) -> string:
    """Synopsis:
---
---
 intField(
...
def intScrollBar(flagannotation: string, flagbackgroundColor: tuple[float, float, float], flagchangeCommand: script, flagdefineTemplate: string, flagdocTag: string, flagdragCallback: script, flagdragCommand: script, flagdropCallback: script, flagenable: boolean, flagenableBackground: boolean, flagenableKeyboardFocus: boolean, flagexists: boolean, flagfullPathName: boolean, flagheight: int, flaghighlightColor: tuple[float, float, float], flaghorizontal: boolean, flagisObscured: boolean, flaglargeStep: int, flagmanage: boolean, flagmaxValue: int, flagminValue: int, flagnoBackground: boolean, flagnumberOfPopupMenus: boolean, flagparent: string, flagpopupMenuArray: boolean, flagpreventOverride: boolean, flagstatusBarMessage: string, flagstep: int, flaguseTemplate: string, flagvalue: int, flagvisible: boolean, flagvisibleChangeCommand: script, flagwidth: int) -> string:
    """Synopsis:
---
---
 intScrollBar(
...
def intSlider(flagannotation: string, flagbackgroundColor: tuple[float, float, float], flagchangeCommand: script, flagdefineTemplate: string, flagdocTag: string, flagdragCallback: script, flagdragCommand: script, flagdropCallback: script, flagenable: boolean, flagenableBackground: boolean, flagenableKeyboardFocus: boolean, flagexists: boolean, flagfullPathName: boolean, flagheight: int, flaghighlightColor: tuple[float, float, float], flaghorizontal: boolean, flagisObscured: boolean, flagmanage: boolean, flagmaxValue: int, flagminValue: int, flagnoBackground: boolean, flagnumberOfPopupMenus: boolean, flagparent: string, flagpopupMenuArray: boolean, flagpreventOverride: boolean, flagstatusBarMessage: string, flagstep: int, flaguseTemplate: string, flagvalue: int, flagvisible: boolean, flagvisibleChangeCommand: script, flagwidth: int) -> string:
    """Synopsis:
---
---
 intSlider(
...
def intSliderGrp(flagadjustableColumn: int, flagadjustableColumn2: int, flagadjustableColumn3: int, flagadjustableColumn4: int, flagadjustableColumn5: int, flagadjustableColumn6: int, flagannotation: string, flagbackgroundColor: tuple[float, float, float], flagchangeCommand: script, flagcolumnAlign: tuple[int, string], flagcolumnAlign2: tuple[string, string], flagcolumnAlign3: tuple[string, string, string], flagcolumnAlign4: tuple[string, string, string, string], flagcolumnAlign5: tuple[string, string, string, string, string], flagcolumnAlign6: tuple[string, string, string, string, string, string], flagcolumnAttach: tuple[int, string, int], flagcolumnAttach2: tuple[string, string], flagcolumnAttach3: tuple[string, string, string], flagcolumnAttach4: tuple[string, string, string, string], flagcolumnAttach5: tuple[string, string, string, string, string], flagcolumnAttach6: tuple[string, string, string, string, string, string], flagcolumnOffset2: tuple[int, int], flagcolumnOffset3: tuple[int, int, int], flagcolumnOffset4: tuple[int, int, int, int], flagcolumnOffset5: tuple[int, int, int, int, int], flagcolumnOffset6: tuple[int, int, int, int, int, int], flagcolumnWidth: tuple[int, int], flagcolumnWidth1: int, flagcolumnWidth2: tuple[int, int], flagcolumnWidth3: tuple[int, int, int], flagcolumnWidth4: tuple[int, int, int, int], flagcolumnWidth5: tuple[int, int, int, int, int], flagcolumnWidth6: tuple[int, int, int, int, int, int], flagdefineTemplate: string, flagdocTag: string, flagdragCallback: script, flagdragCommand: script, flagdropCallback: script, flagenable: boolean, flagenableBackground: boolean, flagenableKeyboardFocus: boolean, flagexists: boolean, flagextraLabel: string, flagfield: boolean, flagfieldMaxValue: int, flagfieldMinValue: int, flagfieldStep: int, flagfullPathName: boolean, flagheight: int, flaghighlightColor: tuple[float, float, float], flagisObscured: boolean, flaglabel: string, flagmanage: boolean, flagmaxValue: int, flagminValue: int, flagnoBackground: boolean, flagnumberOfPopupMenus: boolean, flagparent: string, flagpopupMenuArray: boolean, flagpreventOverride: boolean, flagrowAttach: tuple[int, string, int], flagsliderStep: int, flagstatusBarMessage: string, flagstep: int, flaguseTemplate: string, flagvalue: int, flagvisible: boolean, flagvisibleChangeCommand: script, flagwidth: int) -> string:
    """Synopsis:
---
---
 intSliderGrp(
...
def internalVar(flagmayaInstallDir: boolean, flaguserAppDir: boolean, flaguserBitmapsDir: boolean, flaguserHotkeyDir: boolean, flaguserMarkingMenuDir: boolean, flaguserPrefDir: boolean, flaguserPresetsDir: boolean, flaguserScriptDir: boolean, flaguserShelfDir: boolean, flaguserTmpDir: boolean, flaguserWorkspaceDir: boolean) -> string:
    """Synopsis:
---
---
...
def intersect(flagcaching: boolean, flagconstructionHistory: boolean, flagcurveOnSurface: boolean, flagfirstSurface: boolean, flagname: string, flagnodeState: int, flagobject: boolean, flagtolerance: linear) -> list[string]:
    """Synopsis:
---
---
 intersect(
...
def iprEngine(flagcopy: string, flagdefineTemplate: string, flagdiagnostics: boolean, flagestimatedMemory: boolean, flagexists: boolean, flagiprImage: string, flagmotionVectorFile: boolean, flagobject: name, flagregion: tuple[int, int, int, int], flagrelatedFiles: boolean, flagreleaseIprImage: boolean, flagresolution: boolean, flagscanlineIncrement: string, flagshowProgressBar: boolean, flagstartTuning: boolean, flagstopTuning: boolean, flagunderPixel: tuple[int, int], flagupdate: boolean, flagupdateDepthOfField: boolean, flagupdateLightGlow: boolean, flagupdateMotionBlur: boolean, flagupdatePort: string, flagupdateShaderGlow: boolean, flagupdateShading: boolean, flagupdateShadowMaps: boolean, flaguseTemplate: string) -> string:
    """Synopsis:
---
---
...
def isConnected(flagignoreUnitConversion: boolean) -> boolean:
    """Synopsis:
---
---
 isConnected(
...
def isDirty(flagconnection: boolean, flagdatablock: boolean) -> boolean:
    """Synopsis:
---
---
 isDirty(
...
def isolateSelect(flagaddDagObject: name, flagaddSelected: boolean, flagaddSelectedObjects: boolean, flagloadSelected: boolean, flagremoveDagObject: name, flagremoveSelected: boolean, flagstate: boolean, flagupdate: boolean, flagviewObjects: boolean) -> boolean:
    """Synopsis:
---
---
 isolateSelect(
...
def itemFilter(flagbyBin: string, flagbyName: string, flagbyScript: string, flagbyType: string, flagcategory: string, flagclassification: string, flagclearByBin: boolean, flagclearByType: boolean, flagdifference: tuple[string, string], flagexists: boolean, flagintersect: tuple[string, string], flaglistBuiltInFilters: boolean, flaglistOtherFilters: boolean, flaglistUserFilters: boolean, flagnegate: boolean, flagparent: string, flagpythonModule: string, flagsecondScript: string, flagtext: string, flagunion: tuple[string, string], flaguniqueNodeNames: boolean) -> list[string] | string:
    """Synopsis:
---
---
 itemFilter(
...
def itemFilterAttr(flagbyName: string, flagbyNameString: string, flagbyScript: string, flagclassification: string, flagdynamic: boolean, flagexists: boolean, flaghasCurve: boolean, flaghasDrivenKey: boolean, flaghasExpression: boolean, flaghidden: boolean, flagintersect: tuple[string, string], flagkeyable: boolean, flaglistBuiltInFilters: boolean, flaglistOtherFilters: boolean, flaglistUserFilters: boolean, flagnegate: boolean, flagparent: string, flagpublished: boolean, flagreadable: boolean, flagscaleRotateTranslate: boolean, flagsecondScript: string, flagtext: string, flagunion: tuple[string, string], flagwritable: boolean) -> list[string] | string:
    """Synopsis:
---
---
 itemFilterAttr(
...
def itemFilterType(flagtext: string, flagtype: boolean) -> list[string] | string:
    """Synopsis:
---
---
 itemFilterType(
