...
def uiTemplate(flagdefineTemplate: string, flagexists: boolean, flaguseTemplate: string) -> string:
    """Synopsis:
---
---
 uiTemplate(
...
def unassignInputDevice(flagclutch: string, flagdevice: string) -> None:
    """Synopsis:
---
---
...
def undoInfo(flagchunkName: string, flagcloseChunk: boolean, flaginfinity: boolean, flaglength: uint, flagopenChunk: boolean, flagprintQueue: boolean, flagprintRedoQueue: boolean, flagredoName: string, flagredoQueueEmpty: boolean, flagstate: boolean, flagstateWithoutFlush: boolean, flagundoName: string, flagundoQueueEmpty: boolean) -> int | string:
    """Synopsis:
---
---
...
def unfold(flagapplyToShell: boolean, flagareaWeight: float, flagglobalBlend: float, flagglobalMethodBlend: float, flagiterations: int, flagoptimizeAxis: int, flagpinSelected: boolean, flagpinUvBorder: boolean, flagscale: float, flagstoppingThreshold: float, flaguseScale: boolean) -> int:
    """Synopsis:
---
---
...
def ungroup(flagabsolute: boolean, flagparent: string, flagrelative: boolean, flagworld: boolean) -> None:
    """Synopsis:
---
---
 ungroup(
...
def unknownNode(flagplugin: boolean, flagrealClassName: boolean, flagrealClassTag: boolean) -> list[string]:
    """Synopsis:
---
---
...
def unknownPlugin(flagdataTypes: boolean, flaglist: boolean, flagnodeTypes: boolean, flagremove: boolean, flagversion: boolean) -> list[string]:
    """Synopsis:
---
---
...
def unloadPlugin(flagaddCallback: script, flagforce: boolean, flagremoveCallback: script) -> list[string]:
    """Synopsis:
---
---
 unloadPlugin(
...
def untangleUV(flagmapBorder: string, flagmaxRelaxIterations: int, flagpinBorder: boolean, flagpinSelected: boolean, flagpinUnselected: boolean, flagrelax: string, flagrelaxTolerance: float, flagshapeDetail: float) -> int:
    """Synopsis:
---
---
...
def untrim(flagcaching: boolean, flagconstructionHistory: boolean, flagcurveOnSurface: boolean, flagname: string, flagnoChanges: boolean, flagnodeState: int, flagobject: boolean, flagreplaceOriginal: boolean, flaguntrimAll: boolean) -> list[string]:
    """Synopsis:
---
---
 untrim(
...
def upAxis(flagaxis: string, flagrotateView: boolean) -> None:
    """Synopsis:
---
---
...
def uvLink(flagb: boolean, flagisValid: boolean, flagmake: boolean, flagqueryObject: name, flagtexture: name, flaguvSet: name) -> string:
    """Synopsis:
---
---
 uvLink(
...
def uvSnapshot(flagantiAliased: boolean, flagblueColor: int, flagentireUVRange: boolean, flagfileFormat: string, flaggreenColor: int, flagname: string, flagoverwrite: boolean, flagredColor: int, flaguMax: float, flaguMin: float, flaguvSetName: string, flagvMax: float, flagvMin: float, flagxResolution: int, flagyResolution: int) -> None:
    """Synopsis:
---
---
