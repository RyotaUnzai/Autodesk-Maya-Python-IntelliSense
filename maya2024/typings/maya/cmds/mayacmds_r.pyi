...
def radial(flagattenuation: float, flagmagnitude: float, flagmaxDistance: linear, flagname: string, flagperVertex: boolean, flagposition: tuple[linear, linear, linear], flagtorusSectionRadius: linear, flagtype: float, flagvolumeExclusion: boolean, flagvolumeOffset: tuple[linear, linear, linear], flagvolumeShape: string, flagvolumeSweep: angle) -> string:
    """Synopsis:
---
---
 radial(
...
def radioCollection(flagcollectionItemArray: boolean, flagdefineTemplate: string, flagexists: boolean, flaggl: boolean, flagnumberOfCollectionItems: boolean, flagparent: string, flagselect: string, flaguseTemplate: string) -> string:
    """Synopsis:
---
---
 radioCollection(
...
def radioMenuItemCollection(flagdefineTemplate: string, flagexists: boolean, flaggl: boolean, flagparent: string, flaguseTemplate: string) -> string:
    """Synopsis:
---
---
...
def rampColorPort(flagannotation: string, flagbackgroundColor: tuple[float, float, float], flagdefineTemplate: string, flagdocTag: string, flagdragCallback: script, flagdropCallback: script, flagenable: boolean, flagenableBackground: boolean, flagenableKeyboardFocus: boolean, flagexists: boolean, flagfullPathName: boolean, flagheight: int, flaghighlightColor: tuple[float, float, float], flagisObscured: boolean, flagmanage: boolean, flagnoBackground: boolean, flagnode: name, flagnumberOfPopupMenus: boolean, flagparent: string, flagpopupMenuArray: boolean, flagpreventOverride: boolean, flagselectedColorControl: string, flagselectedInterpControl: string, flagselectedPositionControl: string, flagstatusBarMessage: string, flaguseTemplate: string, flagverticalLayout: boolean, flagvisible: boolean, flagvisibleChangeCommand: script, flagwidth: int) -> string:
    """Synopsis:
---
---
 rampColorPort(
...
def rangeControl(flagannotation: string, flagbackgroundColor: tuple[float, float, float], flagchangedCommand: script, flagdefineTemplate: string, flagdocTag: string, flagdragCallback: script, flagdropCallback: script, flagenable: boolean, flagenableBackground: boolean, flagenableKeyboardFocus: boolean, flagexists: boolean, flagfullPathName: boolean, flagheight: int, flaghighlightColor: tuple[float, float, float], flagisObscured: boolean, flagmanage: boolean, flagmaxRange: time, flagminRange: time, flagnoBackground: boolean, flagnumberOfPopupMenus: boolean, flagparent: string, flagpopupMenuArray: boolean, flagpreventOverride: boolean, flagstatusBarMessage: string, flaguseTemplate: string, flagvisible: boolean, flagvisibleChangeCommand: script, flagwidth: int, flagwidthHeight: tuple[int, int]) -> string:
    """Synopsis:
---
---
 rangeControl(
...
def readTake(flagangle: string, flagdevice: string, flagfrequency: float, flaglinear: string, flagnoTime: boolean, flagtake: string) -> None:
    """Synopsis:
---
---
...
def rebuildCurve(flagcaching: boolean, flagconstructionHistory: boolean, flagdegree: int, flagendKnots: int, flagfitRebuild: boolean, flagkeepControlPoints: boolean, flagkeepEndPoints: boolean, flagkeepRange: int, flagkeepTangents: boolean, flagname: string, flagnodeState: int, flagobject: boolean, flagrange: boolean, flagrebuildType: int, flagreplaceOriginal: boolean, flagsmartSurfaceCurveRebuild: boolean, flagspans: int, flagtolerance: linear) -> list[string]:
    """Synopsis:
---
---
 rebuildCurve(
...
def rebuildSurface(flagcaching: boolean, flagconstructionHistory: boolean, flagdegreeU: int, flagdegreeV: int, flagdirection: int, flagendKnots: int, flagfitRebuild: int, flagkeepControlPoints: boolean, flagkeepCorners: boolean, flagkeepRange: int, flagname: string, flagnodeState: int, flagobject: boolean, flagpolygon: int, flagrebuildType: int, flagreplaceOriginal: boolean, flagspansU: int, flagspansV: int, flagtolerance: linear) -> list[string]:
    """Synopsis:
---
---
 rebuildSurface(
...
def recordAttr(flagattribute: string, flagdelete: boolean) -> None:
    """Synopsis:
---
---
...
def recordDevice(flagcleanup: boolean, flagdata: boolean, flagdevice: string, flagduration: int, flagplayback: boolean, flagstate: boolean, flagwait: boolean) -> None:
    """Synopsis:
---
---
...
def referenceEdit(flagapplyFailedEdits: boolean, flagchangeEditTarget: tuple[string, string], flageditCommand: string, flagfailedEdits: boolean, flagonReferenceNode: string, flagremoveEdits: boolean, flagsuccessfulEdits: boolean) -> None:
    """Synopsis:
---
---
...
def referenceQuery(flagchild: boolean, flagdagPath: boolean, flageditAttrs: boolean, flageditCommand: string, flageditNodes: boolean, flageditStrings: boolean, flagfailedEdits: boolean, flagfilename: boolean, flagisExportEdits: boolean, flagisLoaded: boolean, flagisNodeReferenced: boolean, flagisPreviewOnly: boolean, flagliveEdits: boolean, flagnamespace: boolean, flagnodes: boolean, flagonReferenceNode: string, flagparent: boolean, flagparentNamespace: boolean, flagreferenceNode: boolean, flagshortName: boolean, flagshowDagPath: boolean, flagshowFullPath: boolean, flagshowNamespace: boolean, flagsuccessfulEdits: boolean, flagtopReference: boolean, flagunresolvedName: boolean, flagwithoutCopyNumber: boolean) -> list[string]:
    """Synopsis:
---
---
...
def refresh(flagcurrentView: boolean, flagfileExtension: string, flagfilename: string, flagforce: boolean, flagsuspend: boolean) -> None:
    """Synopsis:
---
---
...
def regionSelectKeyCtx(flagbottomManip: float, flagexists: boolean, flaghistory: boolean, flagimage1: string, flagimage2: string, flagimage3: string, flagleftManip: float, flagname: string, flagrightManip: float, flagtopManip: float) -> float:
    """Synopsis:
---
---
 regionSelectKeyCtx(
...
def relationship(flagb: boolean, flagrelationshipData: string) -> None:
    """Synopsis:
---
---
...
def removeMultiInstance(flagallChildren: boolean, flagb: boolean) -> boolean:
    """Synopsis:
---
---
 removeMultiInstance(
...
def rename(flagignoreShape: boolean, flaguuid: boolean) -> string:
    """Synopsis:
---
---
 rename(
...
def render(flagabortMissingTexture: boolean, flagbatch: boolean, flagkeepPreImage: boolean, flaglayer: string, flagnglowpass: boolean, flagnshadows: boolean, flagreplace: boolean, flagxresolution: int, flagyresolution: int) -> string:
    """Synopsis:
---
---
 render(
...
def renderGlobalsNode(flagname: string, flagparent: string, flagrenderQuality: string, flagrenderResolution: string, flagshared: boolean, flagskipSelect: boolean) -> string:
    """Synopsis:
---
---
 renderGlobalsNode(
...
def renderInfo(flagcastShadows: boolean, flagchordHeight: float, flagchordHeightRatio: float, flagdoubleSided: boolean, flagedgeSwap: boolean, flagminScreen: float, flagname: string, flagopposite: boolean, flagsmoothShading: boolean, flagunum: int, flaguseChordHeight: boolean, flaguseChordHeightRatio: boolean, flaguseDefaultLights: boolean, flaguseMinScreen: boolean, flagutype: int, flagvnum: int, flagvtype: int) -> None:
    """Synopsis:
---
---
...
def renderLayerPostProcess(flagkeepImages: boolean, flagsceneName: string) -> None:
    """Synopsis:
---
---
...
def renderManip(flagcamera: tuple[boolean, boolean, boolean, boolean, boolean], flaglight: tuple[boolean, boolean, boolean], flagspotLight: tuple[boolean, boolean, boolean, boolean, boolean, boolean, boolean], flagstate: boolean) -> None:
    """Synopsis:
---
---
 renderManip(
...
def renderPassRegistry(flagchannels: int, flagisPassSupported: boolean, flagpassID: string, flagpassName: boolean, flagrenderer: string, flagsupportedChannelCounts: boolean, flagsupportedDataTypes: boolean, flagsupportedPassSemantics: boolean, flagsupportedRenderPassNames: boolean, flagsupportedRenderPasses: boolean) -> list[string]:
    """Synopsis:
---
---
...
def renderQualityNode(flagname: string, flagparent: string, flagshared: boolean, flagskipSelect: boolean) -> string:
    """Synopsis:
---
---
 renderQualityNode(
...
def renderSettings(flagcamera: string, flagcustomTokenString: string, flagfirstImageName: boolean, flagfullPath: boolean, flagfullPathTemp: boolean, flaggenericFrameImageName: string, flagimageGenericName: boolean, flaglastImageName: boolean, flaglayer: string, flagleaveUnmatchedTokens: boolean) -> list[string]:
    """Synopsis:
---
---
...
def renderThumbnailUpdate(flagforceUpdate: string) -> None:
    """Synopsis:
---
---
...
def renderWindowEditor(flagautoResize: boolean, flagblendMode: int, flagcaption: string, flagchangeCommand: tuple[string, string, string, string], flagclear: tuple[int, int, float, float, float], flagcmEnabled: boolean, flagcolorManage: boolean, flagcompDisplay: int, flagcompImageFile: string, flagcontrol: boolean, flagcurrentCamera: string, flagcurrentCameraRig: string, flagdefineTemplate: string, flagdisplayImage: int, flagdisplayImageViewCount: int, flagdisplayStyle: string, flagdocTag: string, flagdoubleBuffer: boolean, flagdrawAxis: boolean, flageditorName: boolean, flagexists: boolean, flagexposure: float, flagfilter: string, flagforceMainConnection: string, flagframeImage: boolean, flagframeRegion: boolean, flaggamma: float, flaghighlightConnection: string, flagloadImage: string, flaglockMainConnection: boolean, flagmainListConnection: string, flagmarquee: tuple[float, float, float, float], flagnbImages: boolean, flagnextViewImage: boolean, flagoutputColorManage: boolean, flagpanel: string, flagparent: string, flagpcaption: string, flagrealSize: boolean, flagrefresh: boolean, flagremoveAllImages: boolean, flagremoveImage: boolean, flagresetRegion: boolean, flagresetViewImage: boolean, flagsaveImage: boolean, flagscaleBlue: float, flagscaleGreen: float, flagscaleRed: float, flagselectionConnection: string, flagshowRegion: tuple[int, int], flagsingleBuffer: boolean, flagsnapshot: tuple[string, int, int], flagsnapshotMode: boolean, flagstateString: boolean, flagstereo: int, flagstereoImageOrientation: tuple[string, string], flagstereoMode: string, flagtoggle: boolean, flagunParent: boolean, flagunlockMainConnection: boolean, flagupdateMainConnection: boolean, flaguseTemplate: string, flagviewImageCount: int, flagviewTransformName: string, flagwriteImage: string) -> string:
    """Synopsis:
---
---
 renderWindowEditor(
...
def renderWindowSelectContext(flagexists: boolean, flagimage1: string, flagimage2: string, flagimage3: string) -> string:
    """Synopsis:
---
---
...
def renderer(flagaddGlobalsNode: string, flagaddGlobalsTab: tuple[string, string, string], flagbatchRenderOptionsProcedure: string, flagbatchRenderOptionsStringProcedure: string, flagbatchRenderProcedure: string, flagcancelBatchRenderProcedure: string, flagchangeIprRegionProcedure: string, flagcommandRenderProcedure: string, flagexists: boolean, flagglobalsNodes: boolean, flagglobalsTabCreateProcNames: boolean, flagglobalsTabLabels: boolean, flagglobalsTabUpdateProcNames: boolean, flagiprOptionsMenuLabel: string, flagiprOptionsProcedure: string, flagiprOptionsSubMenuProcedure: string, flagiprRenderProcedure: string, flagiprRenderSubMenuProcedure: string, flagisRunningIprProcedure: string, flaglogoCallbackProcedure: string, flaglogoImageName: string, flagmaterialViewRendererList: boolean, flagmaterialViewRendererPause: boolean, flagmaterialViewRendererSuspend: boolean, flagnamesOfAvailableRenderers: boolean, flagpauseIprRenderProcedure: string, flagpolyPrelightProcedure: string, flagrefreshIprRenderProcedure: string, flagrenderDiagnosticsProcedure: string, flagrenderGlobalsProcedure: string, flagrenderMenuProcedure: string, flagrenderOptionsProcedure: string, flagrenderProcedure: string, flagrenderRegionProcedure: string, flagrenderSequenceProcedure: string, flagrendererUIName: string, flagrenderingEditorsSubMenuProcedure: string, flagshowBatchRenderLogProcedure: string, flagshowBatchRenderProcedure: string, flagshowRenderLogProcedure: string, flagstartIprRenderProcedure: string, flagstopIprRenderProcedure: string, flagsupportColorManagement: boolean, flagtextureBakingProcedure: string, flagunregisterRenderer: boolean) -> None:
    """Synopsis:
---
---
...
def reorder(flagback: boolean, flagfront: boolean, flagrelative: int) -> None:
    """Synopsis:
---
---
 reorder(
...
def reorderContainer(flagback: boolean, flagfront: boolean, flagrelative: int) -> None:
    """Synopsis:
---
---
...
def reorderDeformers(flagname: string) -> None:
    """Synopsis:
---
---
 reorderDeformers(
...
def requires(flagdataType: string, flagnodeType: string) -> None:
    """Synopsis:
---
---
 requires(
...
def resampleFluid(flagresampleDepth: int, flagresampleHeight: int, flagresampleWidth: int) -> None:
    """Synopsis:
---
---
...
def resolutionNode(flagname: string, flagparent: string, flagshared: boolean, flagskipSelect: boolean) -> string:
    """Synopsis:
---
---
 resolutionNode(
...
def resourceManager(flagnameFilter: string, flagsaveAs: tuple[string, string]) -> None:
    """Synopsis:
---
---
...
def retimeKeyCtx(flagexists: boolean, flaghistory: boolean, flagimage1: string, flagimage2: string, flagimage3: string, flagmoveByFrame: int, flagname: string, flagsnapOnFrame: boolean) -> boolean:
    """Synopsis:
---
---
 retimeKeyCtx(
...
def reverseCurve(flagcaching: boolean, flagconstructionHistory: boolean, flagcurveOnSurface: boolean, flagname: string, flagnodeState: int, flagobject: boolean, flagrange: boolean, flagreplaceOriginal: boolean) -> list[string]:
    """Synopsis:
---
---
 reverseCurve(
...
def reverseSurface(flagcaching: boolean, flagconstructionHistory: boolean, flagdirection: int, flagname: string, flagnodeState: int, flagobject: boolean, flagreplaceOriginal: boolean) -> list[string]:
    """Synopsis:
---
---
 reverseSurface(
...
def revolve(flagautoCorrectNormal: boolean, flagaxis: tuple[linear, linear, linear], flagaxisChoice: int, flagaxisX: linear, flagaxisY: linear, flagaxisZ: linear, flagbridge: boolean, flagcaching: boolean, flagcomputePivotAndAxis: int, flagconstructionHistory: boolean, flagdegree: int, flagendSweep: angle, flagname: string, flagnodeState: int, flagobject: boolean, flagpivot: tuple[linear, linear, linear], flagpivotX: linear, flagpivotY: linear, flagpivotZ: linear, flagpolygon: int, flagradius: linear, flagradiusAnchor: float, flagrange: boolean, flagrebuild: boolean, flagsections: int, flagstartSweep: angle, flagtolerance: linear, flaguseLocalPivot: boolean, flaguseTolerance: boolean) -> list[string]:
    """Synopsis:
---
---
 revolve(
...
def rigidBody(flagactive: boolean, flagangularVelocity: boolean, flagapplyForceAt: string, flagbounciness: float, flagcache: boolean, flagcenterOfMass: tuple[float, float, float], flagcollisions: boolean, flagcontactCount: boolean, flagcontactName: boolean, flagcontactPosition: boolean, flagdamping: float, flagdeleteCache: boolean, flagdynamicFriction: float, flagforce: boolean, flagignore: boolean, flagimpulse: tuple[float, float, float], flagimpulsePosition: tuple[float, float, float], flaginitialAngularVelocity: tuple[float, float, float], flaginitialVelocity: tuple[float, float, float], flaglayer: int, flaglockCenterOfMass: boolean, flagmass: float, flagname: string, flagorientation: tuple[float, float, float], flagparticleCollision: boolean, flagpassive: boolean, flagposition: tuple[float, float, float], flagremoveShape: string, flagsolver: string, flagspinImpulse: tuple[float, float, float], flagstandInObject: string, flagstaticFriction: float, flagtesselationFactor: int, flagvelocity: boolean) -> string:
    """Synopsis:
---
---
...
def rigidSolver(flagautoTolerances: boolean, flagbounciness: boolean, flagcacheData: boolean, flagcollide: boolean, flagcollisionTolerance: float, flagcontactData: boolean, flagcreate: boolean, flagcurrent: boolean, flagdeleteCache: boolean, flagdisplayCenterOfMass: boolean, flagdisplayConstraint: boolean, flagdisplayVelocity: boolean, flagdynamics: boolean, flagfriction: boolean, flaginterpenetrate: boolean, flaginterpenetrationCheck: boolean, flagname: string, flagrigidBodies: boolean, flagrigidBodyCount: boolean, flagshowCollision: boolean, flagshowInterpenetration: boolean, flagsolverMethod: int, flagstartTime: float, flagstate: boolean, flagstatistics: boolean, flagstepSize: float, flagvelocityVectorScale: float) -> None:
    """Synopsis:
---
---
...
def roll(flagabsolute: boolean, flagdegree: angle, flagrelative: boolean) -> None:
    """Synopsis:
---
---
 roll(
...
def rollCtx(flagalternateContext: boolean, flagexists: boolean, flaghistory: boolean, flagimage1: string, flagimage2: string, flagimage3: string, flagname: string, flagrollScale: float, flagtoolName: string) -> string:
    """Synopsis:
---
---
 rollCtx(
...
def rotate(flagabsolute: boolean, flagcenterPivot: boolean, flagcomponentSpace: boolean, flagconstrainAlongNormal: boolean, flagdeletePriorHistory: boolean, flageuler: boolean, flagforceOrderXYZ: boolean, flagobjectCenterPivot: boolean, flagobjectSpace: boolean, flagorientAxes: tuple[angle, angle, angle], flagpivot: tuple[linear, linear, linear], flagpreserveChildPosition: boolean, flagpreserveGeometryPosition: boolean, flagpreserveUV: boolean, flagreflection: boolean, flagreflectionAboutBBox: boolean, flagreflectionAboutOrigin: boolean, flagreflectionAboutX: boolean, flagreflectionAboutY: boolean, flagreflectionAboutZ: boolean, flagreflectionTolerance: float, flagrelative: boolean, flagrotateX: boolean, flagrotateXY: boolean, flagrotateXYZ: boolean, flagrotateXZ: boolean, flagrotateY: boolean, flagrotateYZ: boolean, flagrotateZ: boolean, flagsymNegative: boolean, flagtranslate: boolean, flagworldSpace: boolean, flagxformConstraint: string) -> None:
    """Synopsis:
---
---
 rotate(
...
def rotationInterpolation(flagconvert: string) -> None:
    """Synopsis:
---
---
...
def roundConstantRadius(flagappend: boolean, flagconstructionHistory: boolean, flagname: string, flagobject: boolean, flagradiuss: linear, flagside: tuple[string, int], flagsidea: int, flagsideb: int) -> list[string]:
    """Synopsis:
---
---
 roundConstantRadius(
...
def rowColumnLayout(flagadjustableColumn: int, flagannotation: string, flagbackgroundColor: tuple[float, float, float], flagchildArray: boolean, flagcolumnAlign: tuple[int, string], flagcolumnAttach: tuple[int, string, int], flagcolumnOffset: tuple[int, string, int], flagcolumnSpacing: tuple[int, int], flagcolumnWidth: tuple[int, int], flagdefineTemplate: string, flagdocTag: string, flagdragCallback: script, flagdropCallback: script, flagenable: boolean, flagenableBackground: boolean, flagenableKeyboardFocus: boolean, flagexists: boolean, flagfullPathName: boolean, flaggeneralSpacing: int, flagheight: int, flaghighlightColor: tuple[float, float, float], flagisObscured: boolean, flagmanage: boolean, flagmargins: int, flagnoBackground: boolean, flagnumberOfChildren: boolean, flagnumberOfColumns: int, flagnumberOfPopupMenus: boolean, flagnumberOfRows: int, flagparent: string, flagpopupMenuArray: boolean, flagpreventOverride: boolean, flagrowAlign: tuple[int, string], flagrowAttach: tuple[int, string, int], flagrowHeight: tuple[int, int], flagrowOffset: tuple[int, string, int], flagrowSpacing: tuple[int, int], flagstatusBarMessage: string, flaguseTemplate: string, flagvisible: boolean, flagvisibleChangeCommand: script, flagwidth: int) -> string:
    """Synopsis:
---
---
 rowColumnLayout(
...
def rowLayout(flagadjustableColumn: int, flagadjustableColumn1: int, flagadjustableColumn2: int, flagadjustableColumn3: int, flagadjustableColumn4: int, flagadjustableColumn5: int, flagadjustableColumn6: int, flagannotation: string, flagbackgroundColor: tuple[float, float, float], flagchildArray: boolean, flagcolumnAlign: tuple[int, string], flagcolumnAlign1: string, flagcolumnAlign2: tuple[string, string], flagcolumnAlign3: tuple[string, string, string], flagcolumnAlign4: tuple[string, string, string, string], flagcolumnAlign5: tuple[string, string, string, string, string], flagcolumnAlign6: tuple[string, string, string, string, string, string], flagcolumnAttach: tuple[int, string, int], flagcolumnAttach1: string, flagcolumnAttach2: tuple[string, string], flagcolumnAttach3: tuple[string, string, string], flagcolumnAttach4: tuple[string, string, string, string], flagcolumnAttach5: tuple[string, string, string, string, string], flagcolumnAttach6: tuple[string, string, string, string, string, string], flagcolumnOffset1: int, flagcolumnOffset2: tuple[int, int], flagcolumnOffset3: tuple[int, int, int], flagcolumnOffset4: tuple[int, int, int, int], flagcolumnOffset5: tuple[int, int, int, int, int], flagcolumnOffset6: tuple[int, int, int, int, int, int], flagcolumnWidth: tuple[int, int], flagcolumnWidth1: int, flagcolumnWidth2: tuple[int, int], flagcolumnWidth3: tuple[int, int, int], flagcolumnWidth4: tuple[int, int, int, int], flagcolumnWidth5: tuple[int, int, int, int, int], flagcolumnWidth6: tuple[int, int, int, int, int, int], flagdefineTemplate: string, flagdocTag: string, flagdragCallback: script, flagdropCallback: script, flagenable: boolean, flagenableBackground: boolean, flagenableKeyboardFocus: boolean, flagexists: boolean, flagfullPathName: boolean, flaggeneralSpacing: int, flagheight: int, flaghighlightColor: tuple[float, float, float], flagisObscured: boolean, flagmanage: boolean, flagmargins: int, flagnoBackground: boolean, flagnumberOfChildren: boolean, flagnumberOfColumns: int, flagnumberOfPopupMenus: boolean, flagparent: string, flagpopupMenuArray: boolean, flagpreventOverride: boolean, flagrowAttach: tuple[int, string, int], flagstatusBarMessage: string, flaguseTemplate: string, flagvisible: boolean, flagvisibleChangeCommand: script, flagwidth: int) -> string:
    """Synopsis:
---
---
 rowLayout(
...
def runTimeCommand(flagaddKeyword: string, flagaddTag: string, flagannotation: string, flagcategory: string, flagcategoryArray: boolean, flagcommand: script, flagcommandArray: boolean, flagcommandLanguage: string, flagdefault: boolean, flagdefaultCommandArray: boolean, flagdelete: boolean, flagexists: boolean, flaghelpUrl: string, flaghotkeyCtx: string, flagimage: string, flagkeywords: string, flaglabel: string, flaglongAnnotation: string, flagnumberOfCommands: boolean, flagnumberOfDefaultCommands: boolean, flagnumberOfUserCommands: boolean, flagplugin: string, flagsave: boolean, flagshowInHotkeyEditor: boolean, flagtags: string, flaguserCommandArray: boolean) -> string:
    """Synopsis:
---
---
 runTimeCommand(
...
def runup(flagcache: boolean, flagfromPreviousFrame: boolean, flagfromStartFrame: boolean, flagmaxFrame: time, flagstate: boolean) -> string:
    """Synopsis:
---
---
