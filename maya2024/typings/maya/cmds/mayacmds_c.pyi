...
def cacheFileCombine(cacheIndex: boolean, channelName: string, connectCache: string, keepWeights: boolean, layerNode: boolean, nextAvailable: boolean, object: string, objectIndex: int) -> string:
    """Synopsis:
---
---
...
def cacheFileMerge(endTime: time, geometry: boolean, startTime: time) -> float[] | list[string]:
    """Synopsis:
---
---
...
def cacheFileTrack(insertTrack: uint, lock: boolean, mute: boolean, removeEmptyTracks: boolean, removeTrack: uint, solo: boolean, track: uint) -> None:
    """Synopsis:
---
---
...
def callbacks(addCallback: script, clearAllCallbacks: boolean, clearCallbacks: boolean, describeHooks: boolean, dumpCallbacks: boolean, executeCallbacks: boolean, hook: string, listCallbacks: boolean, owner: string, removeCallback: script) -> list[string]:
    """Synopsis:
---
---
...
def cameraSet(active: boolean, appendTo: boolean, camera: string, clearDepth: boolean, deleteAll: boolean, deleteLayer: boolean, insertAt: boolean, layer: int, name: string, numLayers: boolean, objectSet: string, order: int) -> string:
    """Synopsis:
---
---
...
def cameraView(addBookmark: boolean, animate: boolean, bookmarkType: int, camera: name, name: string, removeBookmark: boolean, setCamera: boolean, setView: boolean) -> string:
    """Synopsis:
---
---
 cameraView(
...
def changeSubdivComponentDisplayLevel(level: int, relative: boolean) -> int:
    """Synopsis:
---
---
...
def changeSubdivRegion(action: int, level: int) -> boolean:
    """Synopsis:
---
---
...
def characterMap(mapAttr: tuple[string, string], mapMethod: string, mapNode: tuple[string, string], mapping: string, proposedMapping: boolean, unmapAttr: tuple[string, string], unmapNode: tuple[string, string]) -> string:
    """Synopsis:
---
---
...
def characterize(activatePivot: boolean, addAuxEffector: boolean, addFloorContactPlane: boolean, addMissingEffectors: boolean, attributeFromHIKProperty: string, attributeFromHIKPropertyMode: string, autoActivateBodyPart: boolean, changePivotPlacement: boolean, effectors: string, fkSkeleton: string, name: string, pinHandFeet: boolean, placeNewPivot: boolean, posture: string, sourceSkeleton: string, stancePose: string, type: string) -> string:
    """Synopsis:
---
---
...
def checkBox(align: string, annotation: string, backgroundColor: tuple[float, float, float], changeCommand: script, defineTemplate: string, docTag: string, dragCallback: script, dropCallback: script, editable: boolean, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, fullPathName: boolean, height: int, highlightColor: tuple[float, float, float], isObscured: boolean, label: string, manage: boolean, noBackground: boolean, numberOfPopupMenus: boolean, offCommand: script, onCommand: script, parent: string, popupMenuArray: boolean, preventOverride: boolean, recomputeSize: boolean, statusBarMessage: string, useTemplate: string, value: boolean, visible: boolean, visibleChangeCommand: script, width: int) -> string:
    """Synopsis:
---
---
 checkBox(
...
def checkBoxGrp(adjustableColumn: int, adjustableColumn2: int, adjustableColumn3: int, adjustableColumn4: int, adjustableColumn5: int, adjustableColumn6: int, annotation: string, backgroundColor: tuple[float, float, float], changeCommand: script, changeCommand1: script, changeCommand2: script, changeCommand3: script, changeCommand4: script, columnAlign: tuple[int, string], columnAlign2: tuple[string, string], columnAlign3: tuple[string, string, string], columnAlign4: tuple[string, string, string, string], columnAlign5: tuple[string, string, string, string, string], columnAlign6: tuple[string, string, string, string, string, string], columnAttach: tuple[int, string, int], columnAttach2: tuple[string, string], columnAttach3: tuple[string, string, string], columnAttach4: tuple[string, string, string, string], columnAttach5: tuple[string, string, string, string, string], columnAttach6: tuple[string, string, string, string, string, string], columnOffset2: tuple[int, int], columnOffset3: tuple[int, int, int], columnOffset4: tuple[int, int, int, int], columnOffset5: tuple[int, int, int, int, int], columnOffset6: tuple[int, int, int, int, int, int], columnWidth: tuple[int, int], columnWidth1: int, columnWidth2: tuple[int, int], columnWidth3: tuple[int, int, int], columnWidth4: tuple[int, int, int, int], columnWidth5: tuple[int, int, int, int, int], columnWidth6: tuple[int, int, int, int, int, int], defineTemplate: string, docTag: string, dragCallback: script, dropCallback: script, editable: boolean, enable: boolean, enable1: boolean, enable2: boolean, enable3: boolean, enable4: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, fullPathName: boolean, height: int, highlightColor: tuple[float, float, float], isObscured: boolean, label: string, label1: string, label2: string, label3: string, label4: string, labelArray2: tuple[string, string], labelArray3: tuple[string, string, string], labelArray4: tuple[string, string, string, string], manage: boolean, noBackground: boolean, numberOfCheckBoxes: int, numberOfPopupMenus: boolean, offCommand: script, offCommand1: script, offCommand2: script, offCommand3: script, offCommand4: script, onCommand: script, onCommand1: script, onCommand2: script, onCommand3: script, onCommand4: script, parent: string, popupMenuArray: boolean, preventOverride: boolean, rowAttach: tuple[int, string, int], statusBarMessage: string, useTemplate: string, value1: boolean, value2: boolean, value3: boolean, value4: boolean, valueArray2: tuple[boolean, boolean], valueArray3: tuple[boolean, boolean, boolean], valueArray4: tuple[boolean, boolean, boolean, boolean], vertical: boolean, visible: boolean, visibleChangeCommand: script, width: int) -> string:
    """Synopsis:
---
---
 checkBoxGrp(
...
def choice(attribute: string, controlPoints: boolean, index: uint, name: string, selector: name, shape: boolean, sourceAttribute: name, time: time) -> list[string]:
    """Synopsis:
---
---
 choice(
...
def circle(caching: boolean, center: tuple[linear, linear, linear], centerX: linear, centerY: linear, centerZ: linear, constructionHistory: boolean, degree: int, first: tuple[linear, linear, linear], firstPointX: linear, firstPointY: linear, firstPointZ: linear, fixCenter: boolean, name: string, nodeState: int, normal: tuple[linear, linear, linear], normalX: linear, normalY: linear, normalZ: linear, object: boolean, radius: linear, sections: int, sweep: angle, tolerance: linear, useTolerance: boolean) -> list[string]:
    """Synopsis:
---
---
...
def circularFillet(caching: boolean, constructionHistory: boolean, curveOnSurface: boolean, name: string, nodeState: int, object: boolean, positionTolerance: float, primaryRadius: linear, secondaryRadius: linear, tangentTolerance: float) -> list[string]:
    """Synopsis:
---
---
 circularFillet(
...
def clearCache(allNodes: boolean, computed: boolean, dirty: boolean) -> int:
    """Synopsis:
---
---
...
def clipEditor(allTrackHeights: int, autoFit: string, autoFitTime: string, clipDropCmd: string, clipStyle: int, control: boolean, defineTemplate: string, deleteCmd: string, deselectAll: boolean, displayActiveKeyTangents: string, displayActiveKeys: string, displayInfinities: string, displayKeys: string, displayTangents: string, displayValues: string, docTag: string, exists: boolean, filter: string, forceMainConnection: string, frameAll: boolean, frameRange: tuple[float, float], highlightConnection: string, highlightedBlend: tuple[string, string], highlightedClip: tuple[string, string], initialized: boolean, listAllCharacters: boolean, listCurrentCharacters: boolean, lockMainConnection: boolean, lookAt: string, mainListConnection: string, manageSequencer: boolean, menuContext: string, panel: string, parent: string, selectBlend: tuple[string, string, string], selectClip: tuple[string, string], selectionConnection: string, snapTime: string, snapValue: string, stateString: boolean, unParent: boolean, unlockMainConnection: boolean, updateMainConnection: boolean, useTemplate: string) -> string:
    """Synopsis:
---
---
 clipEditor(
...
def clipEditorCurrentTimeCtx(exists: boolean, history: boolean, image1: string, image2: string, image3: string, name: string) -> string:
    """Synopsis:
---
---
...
def clipMatching(clipDst: tuple[string, float], clipSrc: tuple[string, float], matchRotation: uint, matchTranslation: uint) -> None:
    """Synopsis:
---
---
...
def clipSchedule(allAbsolute: boolean, allRelative: boolean, blend: tuple[uint, uint], blendNode: tuple[uint, uint], blendUsingNode: string, character: boolean, clipIndex: uint, cycle: float, defaultAbsolute: boolean, enable: boolean, group: boolean, groupIndex: uint, groupName: string, hold: time, insertTrack: uint, instance: string, listCurves: boolean, listPairs: boolean, lock: boolean, mute: boolean, name: string, postCycle: float, preCycle: float, remove: boolean, removeBlend: tuple[uint, uint], removeEmptyTracks: boolean, removeTrack: uint, rotationsAbsolute: boolean, scale: float, shift: int, shiftIndex: uint, solo: boolean, sourceClipName: boolean, sourceEnd: time, sourceStart: time, start: time, track: uint, weight: float, weightStyle: uint) -> string:
    """Synopsis:
---
---
...
def closeCurve(blendBias: float, blendKnotInsertion: boolean, caching: boolean, constructionHistory: boolean, curveOnSurface: boolean, name: string, nodeState: int, object: boolean, parameter: float, preserveShape: int, replaceOriginal: boolean) -> list[string]:
    """Synopsis:
---
---
 closeCurve(
...
def closeSurface(blendBias: float, blendKnotInsertion: boolean, caching: boolean, constructionHistory: boolean, direction: int, name: string, nodeState: int, object: boolean, parameter: float, preserveShape: int, replaceOriginal: boolean) -> list[string]:
    """Synopsis:
---
---
 closeSurface(
...
def cmdFileOutput(close: uint, closeAll: boolean, open: string, status: uint) -> int:
    """Synopsis:
---
---
...
def cmdScrollFieldReporter(annotation: string, backgroundColor: tuple[float, float, float], clear: boolean, copySelection: boolean, cutSelection: boolean, defineTemplate: string, docTag: string, dragCallback: script, dropCallback: script, echoAllCommands: boolean, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, filterSourceType: string, fullPathName: boolean, hasFocus: boolean, height: int, highlightColor: tuple[float, float, float], isObscured: boolean, lineNumbers: boolean, manage: boolean, noBackground: boolean, numberOfPopupMenus: boolean, parent: string, pasteSelection: boolean, popupMenuArray: boolean, preventOverride: boolean, receiveFocusCommand: script, saveSelection: string, saveSelectionToShelf: boolean, select: tuple[uint, uint], selectAll: boolean, stackTrace: boolean, statusBarMessage: string, suppressErrors: boolean, suppressInfo: boolean, suppressResults: boolean, suppressStackTrace: boolean, suppressWarnings: boolean, text: string, textLength: boolean, useTemplate: string, visible: boolean, visibleChangeCommand: script, width: int) -> string:
    """Synopsis:
---
---
...
def collision(friction: float, name: string, offset: float, resilience: float) -> list[string]:
    """Synopsis:
---
---
 collision(
...
def color(rgbColor: tuple[float, float, float], userDefined: int) -> None:
    """Synopsis:
---
---
 color(
...
def colorAtPoint(coordU: float, coordV: float, maxU: float, maxV: float, minU: float, minV: float, output: string, samplesU: uint, samplesV: uint) -> None:
    """Synopsis:
---
---
...
def colorEditor(alpha: float, hsvValue: tuple[float, float, float], mini: boolean, parent: string, position: tuple[int, int], result: boolean, rgbValue: tuple[float, float, float]) -> string:
    """Synopsis:
---
---
...
def colorIndex(active: boolean, dormant: boolean, hueSaturationValue: boolean, resetToFactory: boolean, resetToSaved: boolean, userColor: boolean) -> int:
    """Synopsis:
---
---
 colorIndex(
...
def colorIndexSliderGrp(adjustableColumn: int, adjustableColumn2: int, adjustableColumn3: int, adjustableColumn4: int, adjustableColumn5: int, adjustableColumn6: int, annotation: string, backgroundColor: tuple[float, float, float], changeCommand: script, columnAlign: tuple[int, string], columnAlign2: tuple[string, string], columnAlign3: tuple[string, string, string], columnAlign4: tuple[string, string, string, string], columnAlign5: tuple[string, string, string, string, string], columnAlign6: tuple[string, string, string, string, string, string], columnAttach: tuple[int, string, int], columnAttach2: tuple[string, string], columnAttach3: tuple[string, string, string], columnAttach4: tuple[string, string, string, string], columnAttach5: tuple[string, string, string, string, string], columnAttach6: tuple[string, string, string, string, string, string], columnOffset2: tuple[int, int], columnOffset3: tuple[int, int, int], columnOffset4: tuple[int, int, int, int], columnOffset5: tuple[int, int, int, int, int], columnOffset6: tuple[int, int, int, int, int, int], columnWidth: tuple[int, int], columnWidth1: int, columnWidth2: tuple[int, int], columnWidth3: tuple[int, int, int], columnWidth4: tuple[int, int, int, int], columnWidth5: tuple[int, int, int, int, int], columnWidth6: tuple[int, int, int, int, int, int], defineTemplate: string, docTag: string, dragCallback: script, dragCommand: script, dropCallback: script, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, extraLabel: string, forceDragRefresh: boolean, fullPathName: boolean, height: int, highlightColor: tuple[float, float, float], invisible: int, isObscured: boolean, label: string, manage: boolean, maxValue: int, minValue: int, noBackground: boolean, numberOfPopupMenus: boolean, parent: string, popupMenuArray: boolean, preventOverride: boolean, rowAttach: tuple[int, string, int], statusBarMessage: string, useTemplate: string, value: int, visible: boolean, visibleChangeCommand: script, width: int) -> string:
    """Synopsis:
---
---
 colorIndexSliderGrp(
...
def colorInputWidgetGrp(adjustableColumn: int, adjustableColumn2: int, adjustableColumn3: int, adjustableColumn4: int, adjustableColumn5: int, adjustableColumn6: int, alphaValue: float, annotation: string, backgroundColor: tuple[float, float, float], changeCommand: script, columnAlign: tuple[int, string], columnAlign2: tuple[string, string], columnAlign3: tuple[string, string, string], columnAlign4: tuple[string, string, string, string], columnAlign5: tuple[string, string, string, string, string], columnAlign6: tuple[string, string, string, string, string, string], columnAttach: tuple[int, string, int], columnAttach2: tuple[string, string], columnAttach3: tuple[string, string, string], columnAttach4: tuple[string, string, string, string], columnAttach5: tuple[string, string, string, string, string], columnAttach6: tuple[string, string, string, string, string, string], columnOffset2: tuple[int, int], columnOffset3: tuple[int, int, int], columnOffset4: tuple[int, int, int, int], columnOffset5: tuple[int, int, int, int, int], columnOffset6: tuple[int, int, int, int, int, int], columnWidth: tuple[int, int], columnWidth1: int, columnWidth2: tuple[int, int], columnWidth3: tuple[int, int, int], columnWidth4: tuple[int, int, int, int], columnWidth5: tuple[int, int, int, int, int], columnWidth6: tuple[int, int, int, int, int, int], defineTemplate: string, docTag: string, dragCallback: script, dropCallback: script, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, forceDragRefresh: boolean, fullPathName: boolean, height: int, highlightColor: tuple[float, float, float], hsvValue: tuple[float, float, float], isObscured: boolean, label: string, manage: boolean, noBackground: boolean, numberOfPopupMenus: boolean, parent: string, popupMenuArray: boolean, preventOverride: boolean, rgbValue: tuple[float, float, float], rowAttach: tuple[int, string, int], statusBarMessage: string, useTemplate: string, visible: boolean, visibleChangeCommand: script, width: int) -> string:
    """Synopsis:
---
---
 colorInputWidgetGrp(
...
def colorManagementCatalog(addTransform: string, editUserTransformPath: string, listSupportedExtensions: boolean, listTransformConnections: boolean, path: string, queryUserTransformPath: boolean, removeTransform: string, transformConnection: string, type: string) -> None:
    """Synopsis:
---
---
...
def colorManagementConvert(toDisplaySpace: tuple[float, float, float]) -> None:
    """Synopsis:
---
---
...
def colorManagementFileRules(addRule: string, colorSpace: string, colorSpaceDescription: string, colorSpaceFamilies: string, colorSpaceNames: boolean, down: string, enabled: boolean, evaluate: string, extension: string, listRules: boolean, load: boolean, moveUp: string, pattern: string, remove: string, restoreDefaults: boolean, save: boolean) -> None:
    """Synopsis:
---
---
...
def colorSliderButtonGrp(adjustableColumn: int, adjustableColumn2: int, adjustableColumn3: int, adjustableColumn4: int, adjustableColumn5: int, adjustableColumn6: int, alphaValue: float, annotation: string, backgroundColor: tuple[float, float, float], buttonCommand: script, buttonLabel: string, changeCommand: script, columnAlign: tuple[int, string], columnAlign2: tuple[string, string], columnAlign3: tuple[string, string, string], columnAlign4: tuple[string, string, string, string], columnAlign5: tuple[string, string, string, string, string], columnAlign6: tuple[string, string, string, string, string, string], columnAttach: tuple[int, string, int], columnAttach2: tuple[string, string], columnAttach3: tuple[string, string, string], columnAttach4: tuple[string, string, string, string], columnAttach5: tuple[string, string, string, string, string], columnAttach6: tuple[string, string, string, string, string, string], columnOffset2: tuple[int, int], columnOffset3: tuple[int, int, int], columnOffset4: tuple[int, int, int, int], columnOffset5: tuple[int, int, int, int, int], columnOffset6: tuple[int, int, int, int, int, int], columnWidth: tuple[int, int], columnWidth1: int, columnWidth2: tuple[int, int], columnWidth3: tuple[int, int, int], columnWidth4: tuple[int, int, int, int], columnWidth5: tuple[int, int, int, int, int], columnWidth6: tuple[int, int, int, int, int, int], defineTemplate: string, docTag: string, dragCallback: script, dragCommand: script, dropCallback: script, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, forceDragRefresh: boolean, fullPathName: boolean, height: int, highlightColor: tuple[float, float, float], hsvValue: tuple[float, float, float], image: string, isObscured: boolean, label: string, manage: boolean, noBackground: boolean, numberOfPopupMenus: boolean, parent: string, popupMenuArray: boolean, preventOverride: boolean, rgbValue: tuple[float, float, float], rowAttach: tuple[int, string, int], statusBarMessage: string, symbolButtonCommand: script, symbolButtonDisplay: boolean, useDisplaySpace: boolean, useTemplate: string, useVpColorPicker: boolean, visible: boolean, visibleChangeCommand: script, width: int) -> string:
    """Synopsis:
---
---
...
def colorSliderGrp(adjustableColumn: int, adjustableColumn2: int, adjustableColumn3: int, adjustableColumn4: int, adjustableColumn5: int, adjustableColumn6: int, alphaValue: float, annotation: string, backgroundColor: tuple[float, float, float], changeCommand: script, columnAlign: tuple[int, string], columnAlign2: tuple[string, string], columnAlign3: tuple[string, string, string], columnAlign4: tuple[string, string, string, string], columnAlign5: tuple[string, string, string, string, string], columnAlign6: tuple[string, string, string, string, string, string], columnAttach: tuple[int, string, int], columnAttach2: tuple[string, string], columnAttach3: tuple[string, string, string], columnAttach4: tuple[string, string, string, string], columnAttach5: tuple[string, string, string, string, string], columnAttach6: tuple[string, string, string, string, string, string], columnOffset2: tuple[int, int], columnOffset3: tuple[int, int, int], columnOffset4: tuple[int, int, int, int], columnOffset5: tuple[int, int, int, int, int], columnOffset6: tuple[int, int, int, int, int, int], columnWidth: tuple[int, int], columnWidth1: int, columnWidth2: tuple[int, int], columnWidth3: tuple[int, int, int], columnWidth4: tuple[int, int, int, int], columnWidth5: tuple[int, int, int, int, int], columnWidth6: tuple[int, int, int, int, int, int], defineTemplate: string, docTag: string, dragCallback: script, dragCommand: script, dropCallback: script, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, forceDragRefresh: boolean, fullPathName: boolean, height: int, highlightColor: tuple[float, float, float], hsvValue: tuple[float, float, float], isObscured: boolean, label: string, manage: boolean, noBackground: boolean, numberOfPopupMenus: boolean, parent: string, popupMenuArray: boolean, preventOverride: boolean, rgbValue: tuple[float, float, float], rowAttach: tuple[int, string, int], statusBarMessage: string, useDisplaySpace: boolean, useTemplate: string, useVpColorPicker: boolean, visible: boolean, visibleChangeCommand: script, width: int) -> string:
    """Synopsis:
---
---
 colorSliderGrp(
...
def columnLayout(adjustableColumn: boolean, annotation: string, backgroundColor: tuple[float, float, float], childArray: boolean, columnAlign: string, columnAttach: tuple[string, int], columnOffset: tuple[string, int], columnWidth: int, defineTemplate: string, docTag: string, dragCallback: script, dropCallback: script, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, fullPathName: boolean, generalSpacing: int, height: int, highlightColor: tuple[float, float, float], isObscured: boolean, manage: boolean, margins: int, noBackground: boolean, numberOfChildren: boolean, numberOfPopupMenus: boolean, parent: string, popupMenuArray: boolean, preventOverride: boolean, rowSpacing: int, statusBarMessage: string, useTemplate: string, visible: boolean, visibleChangeCommand: script, width: int) -> string:
    """Synopsis:
---
---
 columnLayout(
...
def combinationShape(addDriver: boolean, allDrivers: boolean, blendShape: string, combinationTargetIndex: int, combinationTargetName: string, combineMethod: int, driverTargetIndex: int, driverTargetName: string, exist: boolean, removeDriver: boolean) -> Int:
    """Synopsis:
---
---
...
def commandEcho(addFilter: list[string], filter: list[string], lineNumbers: boolean, state: boolean) -> None:
    """Synopsis:
---
---
...
def commandLogging(historySize: uint, logCommands: boolean, logFile: string, recordCommands: boolean, resetLogFile: boolean) -> None:
    """Synopsis:
---
---
...
def commandPort(bufferSize: int, close: boolean, echoOutput: boolean, listPorts: boolean, name: string, noreturn: boolean, pickleOutput: boolean, prefix: string, returnNumCommands: boolean, securityWarning: boolean, sourceType: string) -> boolean:
    """Synopsis:
---
---
...
def componentBox(annotation: string, backgroundColor: tuple[float, float, float], defineTemplate: string, docTag: string, dragCallback: script, dropCallback: script, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, execute: tuple[string, boolean], exists: boolean, fullPathName: boolean, height: int, highlightColor: tuple[float, float, float], isObscured: boolean, labelWidth: int, manage: boolean, maxHeight: int, maxWidth: int, noBackground: boolean, numberOfPopupMenus: boolean, parent: string, popupMenuArray: boolean, precision: int, preventOverride: boolean, rowHeight: int, selectedAttr: boolean, statusBarMessage: string, useTemplate: string, visible: boolean, visibleChangeCommand: script, width: int) -> string:
    """Synopsis:
---
---
 componentBox(
...
def componentEditor(control: boolean, defineTemplate: string, docTag: string, exists: boolean, filter: string, floatField: string, floatSlider: string, forceMainConnection: string, hidePathName: boolean, hideZeroColumns: boolean, highlightConnection: string, justifyHeaders: int, lockInput: boolean, lockMainConnection: boolean, mainListConnection: string, newTab: tuple[string, string, string], normalizeWeights: int, operationCount: boolean, operationLabels: boolean, operationType: int, panel: string, parent: string, precision: int, removeTab: string, selected: boolean, selectionConnection: string, setOperationLabel: tuple[int, string], showNamespaces: boolean, showObjects: boolean, showSelected: boolean, sortAlpha: boolean, stateString: boolean, unParent: boolean, unlockMainConnection: boolean, updateMainConnection: boolean, useTemplate: string) -> string:
    """Synopsis:
---
---
 componentEditor(
...
def componentTag(create: boolean, delete: boolean, injectionLocation: string, modify: string, newTagName: string, queryEdit: boolean, rename: boolean, tagName: string, uniqueTagName: boolean) -> Any:
    """Synopsis:
---
---
 componentTag(
...
def condition(delete: boolean, dependency: string, initialize: boolean, script: string, state: boolean) -> None:
    """Synopsis:
---
---
 condition(
...
def confirmDialog(annotation: string, backgroundColor: tuple[float, float, float], button: string, cancelButton: string, defaultButton: string, dismissString: string, icon: string, message: string, messageAlign: string, parent: string, title: string) -> string:
    """Synopsis:
---
---
...
def connectAttr(force: boolean, lock: boolean, nextAvailable: boolean, referenceDest: string) -> string:
    """Synopsis:
---
---
 connectAttr(
...
def connectControl(fileName: boolean, index: uint, preventContextualMenu: boolean, preventOverride: boolean) -> None:
    """Synopsis:
---
---
 connectControl(
...
def connectDynamic(addScriptHandler: script, collisions: string, delete: boolean, emitters: string, fields: string, removeScriptHandler: int) -> string:
    """Synopsis:
---
---
 connectDynamic(
...
def connectJoint(connectMode: boolean, parentMode: boolean) -> None:
    """Synopsis:
---
---
 connectJoint(
...
def connectionInfo(destinationFromSource: boolean, getExactDestination: boolean, getExactSource: boolean, getLockedAncestor: boolean, isDestination: boolean, isExactDestination: boolean, isExactSource: boolean, isLocked: boolean, isSource: boolean, sourceFromDestination: boolean) -> boolean | list[string] | string:
    """Synopsis:
---
---
 connectionInfo(
...
def constrain(barrier: boolean, damping: float, directionalHinge: boolean, hinge: boolean, interpenetrate: boolean, nail: boolean, name: string, orientation: tuple[float, float, float], pinConstraint: boolean, position: tuple[float, float, float], restLength: float, spring: boolean, stiffness: float) -> None:
    """Synopsis:
---
---
...
def constructionHistory(toggle: boolean) -> None:
    """Synopsis:
---
---
...
def container(addNode: list[string], asset: list[string], assetMember: string, bindAttr: tuple[string, string], connectionList: boolean, current: boolean, fileName: list[string], findContainer: list[string], force: boolean, includeHierarchyAbove: boolean, includeHierarchyBelow: boolean, includeNetwork: boolean, includeNetworkDetails: string, includeShaders: boolean, includeShapes: boolean, includeTransform: boolean, isContainer: boolean, name: string, nodeList: boolean, nodeNamePrefix: boolean, parentContainer: boolean, preview: boolean, publishAndBind: tuple[string, string], publishAsChild: tuple[string, string], publishAsParent: tuple[string, string], publishAsRoot: tuple[string, boolean], publishAttr: string, publishConnections: boolean, publishName: string, removeContainer: boolean, removeNode: list[string], type: string, unbindAndUnpublish: string, unbindAttr: tuple[string, string], unbindChild: string, unbindParent: string, unpublishChild: string, unpublishName: string, unpublishParent: string, unsortedOrder: boolean) -> string:
    """Synopsis:
---
---
 container(
...
def containerBind(allNames: boolean, bindingSet: string, bindingSetConditions: boolean, bindingSetList: boolean, force: boolean, preview: boolean) -> None:
    """Synopsis:
---
---
...
def containerProxy(fromTemplate: string, type: string) -> None:
    """Synopsis:
---
---
...
def containerPublish(bindNode: tuple[string, string], bindTemplateStandins: boolean, inConnections: boolean, mergeShared: boolean, outConnections: boolean, publishNode: tuple[string, string], unbindNode: string, unpublishNode: string) -> None:
    """Synopsis:
---
---
...
def containerView(itemInfo: string, itemList: boolean, viewDescription: boolean, viewLabel: boolean, viewList: boolean, viewName: string) -> None:
    """Synopsis:
---
---
...
def contextInfo(c: boolean, escapeContext: boolean, exists: boolean, image1: boolean, image2: boolean, image3: boolean, title: boolean) -> string:
    """Synopsis:
---
---
 contextInfo(
...
def control(annotation: string, backgroundColor: tuple[float, float, float], defineTemplate: string, docTag: string, dragCallback: script, dropCallback: script, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, fullPathName: boolean, height: int, highlightColor: tuple[float, float, float], isObscured: boolean, manage: boolean, noBackground: boolean, numberOfPopupMenus: boolean, parent: string, popupMenuArray: boolean, preventOverride: boolean, statusBarMessage: string, useTemplate: string, visible: boolean, visibleChangeCommand: script, width: int) -> None:
    """Synopsis:
---
---
 control(
...
def controller(allControllers: boolean, children: boolean, group: boolean, index: int, isController: string, parent: boolean, pickWalkDown: boolean, pickWalkLeft: boolean, pickWalkRight: boolean, pickWalkUp: boolean, unparent: boolean) -> string:
    """Synopsis:
---
---
...
def convertIffToPsd(iffFileName: string, psdFileName: string, xResolution: int, yResolution: int) -> None:
    """Synopsis:
---
---
...
def convertSolidTx(alpha: boolean, antiAlias: boolean, backgroundColor: tuple[int, int, int], backgroundMode: string, camera: name, componentRange: boolean, doubleSided: boolean, fileFormat: string, fileImageName: string, fillTextureSeams: boolean, force: boolean, fullUvRange: boolean, name: string, pixelFormat: string, resolutionX: int, resolutionY: int, reuseDepthMap: boolean, samplePlane: boolean, samplePlaneRange: tuple[float, float, float, float], shadows: boolean, uvBBoxIntersect: boolean, uvRange: tuple[float, float, float, float], uvSetName: string) -> list[string]:
    """Synopsis:
---
---
 convertSolidTx(
...
def convertTessellation(allCameras: boolean, camera: name) -> boolean:
    """Synopsis:
---
---
...
def convertUnit(fromUnit: string, toUnit: string) -> float:
    """Synopsis:
---
---
 convertUnit(
...
def copyAttr(attribute: string, containerParentChild: boolean, inConnections: boolean, keepSourceConnections: boolean, outConnections: boolean, renameTargetContainer: boolean, values: boolean) -> None:
    """Synopsis:
---
---
...
def copyDeformerWeights(destinationDeformer: string, destinationShape: string, mirrorInverse: boolean, mirrorMode: string, noMirror: boolean, smooth: boolean, sourceDeformer: string, sourceShape: string, surfaceAssociation: string, uvSpace: tuple[string, string]) -> None:
    """Synopsis:
---
---
...
def copyKey(animLayer: string, animation: string, attribute: string, clipboard: string, controlPoints: boolean, float: floatrange, forceIndependentEulerAngles: boolean, hierarchy: string, includeUpperBound: boolean, index: uint, option: string, shape: boolean, time: timerange) -> int:
    """Synopsis:
---
---
 copyKey(
...
def copySkinWeights(destinationSkin: string, influenceAssociation: string, mirrorInverse: boolean, mirrorMode: string, noBlendWeight: boolean, noMirror: boolean, normalize: boolean, sampleSpace: uint, selectedComponents: boolean, smooth: boolean, sourceSkin: string, surfaceAssociation: string, uvSpace: tuple[string, string]) -> None:
    """Synopsis:
---
---
...
def crashInfo(crashFile: boolean, crashLog: boolean, savedBeforeCrash: boolean) -> None:
    """Synopsis:
---
---
...
def createAttrPatterns(patternDefinition: string, patternFile: string, patternType: string) -> string:
    """Synopsis:
---
---
...
def createDisplayLayer(empty: boolean, makeCurrent: boolean, name: string, noRecurse: boolean, number: int) -> string:
    """Synopsis:
---
---
...
def createEditor(noCloseOnDelete: boolean, queueForDelete: boolean) -> None:
    """Synopsis:
---
---
 createEditor(
...
def createLayeredPsdFile(imageFileName: tuple[string, string, string], psdFileName: string, xResolution: uint, yResolution: uint) -> None:
    """Synopsis:
---
---
...
def createNode(name: string, parent: string, shared: boolean, skipSelect: boolean) -> string:
    """Synopsis:
---
---
 createNode(
...
def createRenderLayer(empty: boolean, g: boolean, makeCurrent: boolean, name: string, noRecurse: boolean, number: int) -> string:
    """Synopsis:
---
---
...
def ctxEditMode(buttonDown: boolean, buttonUp: boolean) -> None:
    """Synopsis:
---
---
...
def ctxTraverse(down: boolean, left: boolean, right: boolean, up: boolean) -> None:
    """Synopsis:
---
---
...
def currentTime(update: boolean) -> time:
    """Synopsis:
---
---
 currentTime(
...
def currentTimeCtx(exists: boolean, history: boolean, image1: string, image2: string, image3: string, name: string) -> string:
    """Synopsis:
---
---
 currentTimeCtx(
...
def currentUnit(angle: string, fullName: boolean, linear: string, time: string, updateAnimation: boolean) -> string:
    """Synopsis:
---
---
...
def curve(append: boolean, bezier: boolean, degree: float, editPoint: tuple[linear, linear, linear], knot: float, name: string, objectSpace: boolean, periodic: boolean, point: tuple[linear, linear, linear], pointWeight: tuple[linear, linear, linear, float], replace: boolean, worldSpace: boolean) -> string:
    """Synopsis:
---
---
 curve(
...
def curveAddPtCtx(exists: boolean, image1: string, image2: string, image3: string) -> string:
    """Synopsis:
---
---
...
def curveCVCtx(bezier: boolean, degree: uint, exists: boolean, history: boolean, image1: string, image2: string, image3: string, multEndKnots: boolean, name: string, preserveShape: boolean, rational: boolean, refit: boolean, symmetry: boolean, uniform: boolean) -> string:
    """Synopsis:
---
---
...
def curveEPCtx(bezier: boolean, degree: uint, exists: boolean, history: boolean, image1: string, image2: string, image3: string, name: string, preserveShape: boolean, preserveShapeFraction: float, refit: boolean, uniform: boolean) -> string:
    """Synopsis:
---
---
...
def curveEditorCtx(direction: int, exists: boolean, history: boolean, image1: string, image2: string, image3: string, name: string, relativeTangentSize: float, title: string) -> string:
    """Synopsis:
---
---
...
def curveIntersect(caching: boolean, constructionHistory: boolean, direction: tuple[linear, linear, linear], directionX: linear, directionY: linear, directionZ: linear, nodeState: int, tolerance: linear, useDirection: boolean) -> string:
    """Synopsis:
---
---
 curveIntersect(
...
def curveMoveEPCtx(exists: boolean, image1: string, image2: string, image3: string) -> string:
    """Synopsis:
---
---
...
def curveOnSurface(append: boolean, degree: float, knot: float, name: string, periodic: boolean, positionUV: tuple[float, float], replace: boolean) -> string:
    """Synopsis:
---
---
 curveOnSurface(
...
def curveRGBColor(hueSaturationValue: boolean, list: boolean, listNames: boolean, remove: boolean, resetToFactory: boolean, resetToSaved: boolean) -> float[]:
    """Synopsis:
---
---
...
def curveSketchCtx(degree: uint, exists: boolean, history: boolean, image1: string, image2: string, image3: string, name: string) -> string:
    """Synopsis:
---
---
 curveSketchCtx(
...
def cutKey(animation: string, attribute: string, clear: boolean, controlPoints: boolean, float: floatrange, hierarchy: string, includeUpperBound: boolean, index: uint, option: string, selectKey: boolean, shape: boolean, time: timerange) -> int:
    """Synopsis:
---
---
 cutKey(
...
def cycleCheck(all: boolean, children: boolean, dag: boolean, evaluation: boolean, firstCycleOnly: boolean, firstPlugPerNode: boolean, lastPlugPerNode: boolean, list: boolean, listSeparator: string, parents: boolean, secondary: boolean, timeLimit: time) -> boolean | list[string]:
    """Synopsis:
---
---
 cycleCheck(
...
def cylinder(axis: tuple[linear, linear, linear], caching: boolean, constructionHistory: boolean, degree: int, endSweep: angle, heightRatio: float, name: string, nodeState: int, object: boolean, pivot: tuple[linear, linear, linear], polygon: int, radius: linear, sections: int, spans: int, startSweep: angle, tolerance: linear, useTolerance: boolean) -> list[string]:
    """Synopsis:
---
---
