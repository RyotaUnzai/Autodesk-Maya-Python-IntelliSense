...
def waitCursor(state: boolean) -> boolean:
    """Synopsis:
---
---
...
def walkCtx(alternateContext: boolean, crouchCount: float, exists: boolean, history: boolean, image1: string, image2: string, image3: string, name: string, toolName: string, walkHeight: float, walkSensitivity: float, walkSpeed: float, walkToolHud: boolean) -> string:
    """Synopsis:
---
---
...
def warning(noContext: boolean, showLineNumber: boolean) -> None:
    """Synopsis:
---
---
...
def weightsColor(colorRamp: string, deformer: string, falseColor: boolean, outOfRangeColor: tuple[float, float, float], rampMaxColor: tuple[float, float, float], rampMinColor: tuple[float, float, float], useColorRamp: boolean, useMaxMinColor: boolean) -> list[string]:
    """Synopsis:
---
---
 weightsColor(
...
def whatsNewHighlight(highlightColor: tuple[float, float, float], highlightOn: boolean, showStartupDialog: boolean) -> None:
    """Synopsis:
---
---
...
def windowPref(enableAll: boolean, exists: boolean, height: int, leftEdge: int, loadAll: boolean, maximized: boolean, parentMain: boolean, remove: boolean, removeAll: boolean, restoreMainWindowState: string, saveAll: boolean, saveMainWindowState: string, topEdge: int, topLeftCorner: tuple[int, int], width: int, widthHeight: tuple[int, int]) -> None:
    """Synopsis:
---
---
 windowPref(
...
def wire(after: boolean, afterReference: boolean, before: boolean, components: boolean, crossingEffect: float, deformerTools: boolean, dropoffDistance: tuple[uint, linear], envelope: float, exclusive: string, frontOfChain: boolean, geometry: string, geometryIndices: boolean, groupWithBase: boolean, holder: tuple[uint, string], ignoreSelected: boolean, includeHiddenSelections: boolean, localInfluence: float, name: string, parallel: boolean, prune: boolean, remove: boolean, selectedComponents: boolean, split: boolean, useComponentTags: boolean, wire: string, wireCount: uint) -> list[string]:
    """Synopsis:
---
---
 wire(
...
def wireContext(crossingEffect: linear, deformationOrder: string, dropoffDistance: linear, envelope: linear, exclusive: boolean, exclusivePartition: string, exists: boolean, groupWithBase: boolean, history: boolean, holder: boolean, image1: string, image2: string, image3: string, localInfluence: linear, name: string) -> string:
    """Synopsis:
---
---
 wireContext(
...
def workspace(active: boolean, baseWorkspace: string, create: string, directory: string, expandName: string, fileRule: tuple[string, string], fileRuleEntry: string, fileRuleList: boolean, filter: boolean, fullName: boolean, list: boolean, listFullWorkspaces: boolean, listWorkspaces: boolean, newWorkspace: boolean, objectType: tuple[string, string], objectTypeEntry: string, objectTypeList: boolean, openWorkspace: boolean, projectPath: string, removeFileRuleEntry: string, removeVariableEntry: string, renderType: tuple[string, string], renderTypeEntry: string, renderTypeList: boolean, rootDirectory: boolean, saveWorkspace: boolean, shortName: boolean, update: boolean, updateAll: boolean, variable: tuple[string, string], variableEntry: string, variableList: boolean) -> list[string] | string:
    """Synopsis:
---
---
 workspace(
...
def workspaceControl(actLikeMayaUIElement: boolean, checksPlugins: boolean, close: boolean, closeCommand: script, collapse: boolean, defineTemplate: string, dockToControl: tuple[string, string], dockToMainWindow: tuple[string, boolean], dockToPanel: tuple[string, string, boolean], duplicatable: boolean, exists: boolean, floating: boolean, height: boolean, heightProperty: string, horizontal: boolean, initCallback: string, initialHeight: int, initialWidth: int, label: string, layoutDirectionCallback: string, loadImmediately: boolean, minimumHeight: int, minimumWidth: int, r: boolean, requiredControl: string, requiredPlugin: string, resizeHeight: int, resizeWidth: int, restore: boolean, retain: boolean, stateString: string, tabPosition: tuple[string, boolean], tabToControl: tuple[string, int], uiScript: script, useTemplate: string, visible: boolean, visibleChangeCommand: script, width: boolean, widthProperty: string) -> string:
    """Synopsis:
---
---
 workspaceControl(
...
def workspaceControlState(defaultTopLeftCorner: tuple[int, int], defaultWidthHeight: tuple[int, int], exists: boolean, height: int, leftEdge: int, maximized: boolean, remove: boolean, topEdge: int, topLeftCorner: tuple[int, int], width: int, widthHeight: tuple[int, int]) -> None:
    """Synopsis:
---
---
...
def workspaceLayoutManager(collapseMainWindowControls: tuple[string, boolean], current: boolean, delete: string, i: string, listLayouts: boolean, listModuleLayouts: boolean, listUserLayouts: boolean, modified: string, parentWorkspaceControl: string, reset: boolean, restoreMainWindowControls: boolean, save: boolean, saveAs: string, setCurrent: string, setCurrentCallback: string, setModifiedCallback: string, type: string) -> list[string]:
    """Synopsis:
---
---
...
def workspacePanel(defineTemplate: string, exists: boolean, mainWindow: boolean, useTemplate: string) -> string:
    """Synopsis:
---
---
...
def wrinkle(axis: tuple[linear, linear, linear], branchCount: uint, branchDepth: uint, center: tuple[linear, linear, linear], crease: string, dropoffDistance: linear, envelope: linear, randomness: linear, style: string, thickness: linear, uvSpace: tuple[linear, linear, linear, linear, linear], wrinkleCount: uint, wrinkleIntensity: linear) -> list[string]:
    """Synopsis:
---
---
 wrinkle(
...
def wrinkleContext(branchCount: uint, branchDepth: uint, exists: boolean, history: boolean, image1: string, image2: string, image3: string, name: string, randomness: linear, style: string, thickness: linear, wrinkleCount: uint, wrinkleIntensity: linear) -> string:
    """Synopsis:
---
---
 wrinkleContext(
...
def writeTake(angle: string, device: string, linear: string, noTime: boolean, precision: int, take: string, virtualDevice: string) -> None:
    """Synopsis:
---
---
