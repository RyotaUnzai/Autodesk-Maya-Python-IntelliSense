...
def objectCenter(flaggl: boolean, flaglocal: boolean, flagx: boolean, flagy: boolean, flagz: boolean) -> float | float[]:
    """Synopsis:
---
---
 objectCenter(
...
def objectType(flagisAType: string, flagisType: string, flagtagFromType: string, flagtypeFromTag: int, flagtypeTag: boolean) -> boolean | string:
    """Synopsis:
---
---
 objectType(
...
def objectTypeUI(flagisType: string, flaglistAll: boolean, flagsuperClasses: boolean) -> string:
    """Synopsis:
---
---
 objectTypeUI(
...
def offsetCurve(flagcaching: boolean, flagconnectBreaks: int, flagconstructionHistory: boolean, flagcutLoop: boolean, flagcutRadius: linear, flagdistance: linear, flagname: string, flagnodeState: int, flagnormal: tuple[linear, linear, linear], flagobject: boolean, flagrange: boolean, flagreparameterize: boolean, flagstitch: boolean, flagsubdivisionDensity: int, flagtolerance: linear, flaguseGivenNormal: boolean) -> list[string]:
    """Synopsis:
---
---
 offsetCurve(
...
def offsetCurveOnSurface(flagcaching: boolean, flagcheckPoints: int, flagconnectBreaks: int, flagconstructionHistory: boolean, flagcutLoop: boolean, flagdistance: linear, flagname: string, flagnodeState: int, flagobject: boolean, flagrange: boolean, flagstitch: boolean, flagsubdivisionDensity: int, flagtolerance: linear) -> list[string]:
    """Synopsis:
---
---
...
def offsetSurface(flagcaching: boolean, flagconstructionHistory: boolean, flagdistance: linear, flagmethod: int, flagname: string, flagnodeState: int, flagobject: boolean) -> list[string]:
    """Synopsis:
---
---
 offsetSurface(
...
def ogs(flagdeviceInformation: boolean, flagdisposeReleasableTextures: boolean, flagdumpTexture: string, flagenableHardwareInstancing: boolean, flagfragmentEditor: string, flagfragmentXML: string, flaggpuMemoryTotal: int, flaggpuMemoryUsed: boolean, flagisLegacyViewportEnabled: boolean, flagisRemoteGLSessionEnabled: boolean, flagisWinRemoteSession: boolean, flagpause: boolean, flagrebakeTextures: boolean, flagregenerateUVTilePreview: string, flagreloadTextures: boolean, flagreset: boolean, flagshaderSource: string, flagtoggleTexturePaging: boolean, flagtraceRenderPipeline: boolean) -> string:
    """Synopsis:
---
---
...
def ogsRender(flagactiveMultisampleType: string, flagactiveRenderOverride: string, flagactiveRenderTargetFormat: string, flagavailableFloatingPointTargetFormat: boolean, flagavailableMultisampleType: boolean, flagavailableRenderOverrides: boolean, flagcamera: string, flagcurrentFrame: boolean, flagcurrentView: boolean, flagenableFloatingPointRenderTarget: boolean, flagenableMultisample: boolean, flagframe: float, flagheight: uint, flaglayer: name, flagnoRenderView: boolean, flagwidth: uint) -> boolean:
    """Synopsis:
---
---
...
def openCLInfo(flaglimitMinimumVerts: boolean, flagminVertexBuffer: int, flagsupportsDoublePrecision: boolean, flagvalid: boolean) -> boolean:
    """Synopsis:
---
---
...
def openGLExtension(flagextension: string, flagrenderer: boolean, flagvendor: boolean, flagversion: boolean) -> string:
    """Synopsis:
---
---
...
def openMayaPref(flagerrlog: boolean, flaglazyLoad: boolean, flagoldPluginWarning: boolean) -> int:
    """Synopsis:
---
---
...
def optionMenu(flagalwaysCallChangeCommand: boolean, flagannotation: string, flagbackgroundColor: tuple[float, float, float], flagbeforeShowPopup: script, flagchangeCommand: script, flagdefineTemplate: string, flagdeleteAllItems: boolean, flagdocTag: string, flagdragCallback: script, flagdropCallback: script, flagenable: boolean, flagenableBackground: boolean, flagenableKeyboardFocus: boolean, flagexists: boolean, flagfullPathName: boolean, flagheight: int, flaghighlightColor: tuple[float, float, float], flagisObscured: boolean, flagitemListLong: boolean, flagitemListShort: boolean, flaglabel: string, flagmanage: boolean, flagmaxVisibleItems: int, flagnoBackground: boolean, flagnumberOfItems: boolean, flagnumberOfPopupMenus: boolean, flagparent: string, flagpopupMenuArray: boolean, flagpostMenuCommand: script, flagpostMenuCommandOnce: boolean, flagpreventOverride: boolean, flagselect: int, flagstatusBarMessage: string, flaguseTemplate: string, flagvalue: string, flagvisible: boolean, flagvisibleChangeCommand: script, flagwidth: int) -> string:
    """Synopsis:
---
---
 optionMenu(
...
def optionVar(flagarraySize: string, flagcategory: string, flagclearArray: string, flagclearStash: string, flagdefault: boolean, flagexists: string, flagfloatArray: string, flagfloatValue: tuple[string, float], flagfloatValue2: tuple[string, float, float], flagfloatValue3: tuple[string, float, float, float], flagfloatValue4: tuple[string, float, float, float, float], flagfloatValueAppend: tuple[string, float], flaginit: boolean, flagintArray: string, flagintValue: tuple[string, int], flagintValue2: tuple[string, int, int], flagintValue3: tuple[string, int, int, int], flagintValue4: tuple[string, int, int, int, int], flagintValueAppend: tuple[string, int], flaglist: boolean, flaglistCategories: boolean, flaglistModified: boolean, flagprefFile: string, flagremove: string, flagremoveFromArray: tuple[string, int], flagstash: string, flagstringArray: string, flagstringValue: tuple[string, string], flagstringValueAppend: tuple[string, string], flagtransient: boolean, flagunstash: string, flagversion: int) -> int | list[string]:
    """Synopsis:
---
---
...
def orbit(flaghorizontalAngle: angle, flagpivotPoint: tuple[linear, linear, linear], flagrotationAngles: tuple[angle, angle], flagverticalAngle: angle) -> None:
    """Synopsis:
---
---
 orbit(
...
def orbitCtx(flagalternateContext: boolean, flagexists: boolean, flaghistory: boolean, flagimage1: string, flagimage2: string, flagimage3: string, flaglocalOrbit: boolean, flagname: string, flagorbitScale: float, flagtoolName: string) -> string:
    """Synopsis:
---
---
...
def orientConstraint(flagcreateCache: tuple[float, float], flagdeleteCache: boolean, flaglayer: string, flagmaintainOffset: boolean, flagname: string, flagoffset: tuple[float, float, float], flagremove: boolean, flagskip: string, flagtargetList: boolean, flagweight: float, flagweightAliasList: boolean) -> string:
    """Synopsis:
---
---
 orientConstraint(
...
def outlinerEditor(flagallowMultiSelection: boolean, flagalwaysToggleSelect: boolean, flaganimLayerFilterOptions: string, flagattrAlphaOrder: string, flagattrFilter: string, flagautoExpand: boolean, flagautoExpandAllAnimatedShapes: boolean, flagautoExpandAnimatedShapes: boolean, flagautoExpandLayers: boolean, flagautoSelectNewObjects: boolean, flagcontainersIgnoreFilters: boolean, flagcontrol: boolean, flagdefineTemplate: string, flagdirectSelect: boolean, flagdisplayMode: string, flagdoNotSelectNewObjects: boolean, flagdocTag: string, flagdropIsParent: boolean, flageditAttrName: boolean, flagexists: boolean, flagexpandAllItems: boolean, flagexpandAllSelectedItems: boolean, flagexpandAttribute: boolean, flagexpandConnections: boolean, flagexpandObjects: boolean, flagfeedbackItemName: boolean, flagfeedbackRowNumber: boolean, flagfilter: string, flagforceMainConnection: string, flaggetCurrentSetOfItem: int, flaghighlightActive: boolean, flaghighlightConnection: string, flaghighlightSecondary: boolean, flagignoreDagHierarchy: boolean, flagignoreHiddenAttribute: boolean, flagignoreOutlinerColor: boolean, flagisChildSelected: name, flagisSet: int, flagisSetMember: int, flagisUfeItem: int, flaglockMainConnection: boolean, flaglongNames: boolean, flagmainListConnection: string, flagmapMotionTrails: boolean, flagmasterOutliner: string, flagniceNames: boolean, flagobject: name, flagorganizeByClip: boolean, flagorganizeByLayer: boolean, flagpanel: string, flagparent: string, flagparentObject: boolean, flagpinPlug: name, flagrefresh: boolean, flagremoveFromCurrentSet: int, flagrenameItem: int, flagrenameSelectedItem: boolean, flagrenderFilterActive: boolean, flagrenderFilterIndex: int, flagrenderFilterVisible: boolean, flagselectCommand: script, flagselectionConnection: string, flagselectionOrder: string, flagsetFilter: string, flagsetsIgnoreFilters: boolean, flagshowAnimCurvesOnly: boolean, flagshowAnimLayerWeight: boolean, flagshowAssets: boolean, flagshowAssignedMaterials: boolean, flagshowAttrValues: boolean, flagshowAttributes: boolean, flagshowCompounds: boolean, flagshowConnected: boolean, flagshowContainedOnly: boolean, flagshowContainerContents: boolean, flagshowDagOnly: boolean, flagshowLeafs: boolean, flagshowMuteInfo: boolean, flagshowNamespace: boolean, flagshowNumericAttrsOnly: boolean, flagshowParentContainers: boolean, flagshowPinIcons: boolean, flagshowPublishedAsConnected: boolean, flagshowReferenceMembers: boolean, flagshowReferenceNodes: boolean, flagshowSelected: boolean, flagshowSetMembers: boolean, flagshowShapes: boolean, flagshowTextureNodesOnly: boolean, flagshowTimeEditor: boolean, flagshowUVAttrsOnly: boolean, flagshowUfeItems: boolean, flagshowUnitlessCurves: boolean, flagshowUpstreamCurves: boolean, flagsortOrder: string, flagstateString: boolean, flagtransmitFilters: boolean, flagufeFilter: tuple[string, string], flagufeFilterValue: boolean, flagunParent: boolean, flagunlockMainConnection: boolean, flagunpinPlug: name, flagupdateMainConnection: boolean, flaguseTemplate: string) -> string:
    """Synopsis:
---
---
 outlinerEditor(
...
def outlinerPanel(flagcontrol: boolean, flagcopy: string, flagcreateString: boolean, flagdefineTemplate: string, flagdivider: int, flagdocTag: string, flageditString: boolean, flagexists: boolean, flaginit: boolean, flagisUnique: boolean, flaglabel: string, flagmenuBarRepeatLast: boolean, flagmenuBarVisible: boolean, flagneedsInit: boolean, flagoutlinerEditor: boolean, flagparent: string, flagpopupMenuProcedure: script, flagreplacePanel: string, flagtearOff: boolean, flagtearOffCopy: string, flagtearOffRestore: boolean, flagunParent: boolean, flaguseTemplate: string) -> string:
    """Synopsis:
---
---
 outlinerPanel(
...
def outputWindow(flagshow: boolean) -> None:
    """Synopsis:
---
---
...
def overrideModifier(flagclear: boolean, flagpress: string, flagrelease: string) -> None:
    """Synopsis:
---
---
