...
def hardenPointCurve(caching: boolean, constructionHistory: boolean, multiplicity: int, name: string, nodeState: int, object: boolean, replaceOriginal: boolean) -> list[string]:
    """Synopsis:
---
---
 hardenPointCurve(
...
def hardware(brdType: boolean, cpuType: boolean, graphicsType: boolean, megaHertz: boolean, numProcessors: boolean) -> string:
    """Synopsis:
---
---
...
def hardwareRenderPanel(camera: string, control: boolean, copy: string, createString: boolean, defineTemplate: string, docTag: string, editString: boolean, exists: boolean, glRenderEditor: boolean, init: boolean, isUnique: boolean, label: string, menuBarRepeatLast: boolean, menuBarVisible: boolean, needsInit: boolean, parent: string, popupMenuProcedure: script, replacePanel: string, tearOff: boolean, tearOffCopy: string, tearOffRestore: boolean, unParent: boolean, useTemplate: string) -> string:
    """Synopsis:
---
---
 hardwareRenderPanel(
...
def hasMetadata(asList: boolean, channelName: string, channelType: string, endIndex: string, ignoreDefault: boolean, index: string, indexType: string, memberName: string, scene: boolean, startIndex: string, streamName: string) -> boolean[] | list[string]:
    """Synopsis:
---
---
...
def headsUpMessage(horizontalOffset: int, object: string, selection: boolean, time: float, uvTextureEditor: boolean, verticalOffset: int, viewport: boolean) -> None:
    """Synopsis:
---
---
 headsUpMessage(
...
def help(documentation: boolean, language: string, list: boolean, popupDisplayTime: uint, popupMode: boolean, popupPauseTime: uint, popupSimpleMode: boolean, rolloverMode: boolean, syntaxOnly: boolean) -> None:
    """Synopsis:
---
---
 help(
...
def hide(allObjects: boolean, clearLastHidden: boolean, clearSelection: boolean, invertComponents: boolean, returnHidden: boolean, testVisibility: boolean) -> None:
    """Synopsis:
---
---
 hide(
...
def hikGlobals(releaseAllPinning: boolean) -> boolean:
    """Synopsis:
---
---
...
def hilite(replace: boolean, toggle: boolean, unHilite: boolean) -> None:
    """Synopsis:
---
---
 hilite(
...
def hotBox(PaneOnlyMenus: boolean, PaneToggleMenus: boolean, animationOnlyMenus: boolean, animationToggleMenus: boolean, clothOnlyMenus: boolean, clothToggleMenus: boolean, commonOnlyMenus: boolean, commonToggleMenus: boolean, customMenuSetsToggleMenus: boolean, displayCenterOnly: boolean, displayHotbox: boolean, displayStyle: boolean, displayZonesOnly: boolean, dynamicsOnlyMenus: boolean, dynamicsToggleMenus: boolean, liveOnlyMenus: boolean, liveToggleMenus: boolean, menuSetOnly: string, menuSetToggle: tuple[string, boolean], modelingOnlyMenus: boolean, modelingToggleMenus: boolean, noClickCommand: script, noClickDelay: float, noClickPosition: boolean, noKeyPress: boolean, polygonsOnlyMenus: boolean, polygonsToggleMenus: boolean, position: tuple[uint, uint], release: boolean, renderingOnlyMenus: boolean, renderingToggleMenus: boolean, riggingOnlyMenus: boolean, riggingToggleMenus: boolean, rmbPopups: boolean, showAllToggleMenus: boolean, surfacesOnlyMenus: boolean, surfacesToggleMenus: boolean, transparenyLevel: int, updateMenus: boolean) -> None:
    """Synopsis:
---
---
...
def hotkeyCheck(altModifier: boolean, commandModifier: boolean, ctrlModifier: boolean, isRepeatable: boolean, keyString: string, keyUp: boolean, optionModifier: boolean) -> string:
    """Synopsis:
---
---
...
def hotkeyCtx(addClient: string, clientArray: boolean, currentClient: string, insertTypeAt: tuple[string, string], removeAllClients: boolean, removeClient: string, removeType: string, type: string, typeArray: boolean, typeExists: string) -> None:
    """Synopsis:
---
---
...
def hotkeyEditorPanel(annotation: string, backgroundColor: tuple[float, float, float], defineTemplate: string, docTag: string, dragCallback: script, dropCallback: script, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, fullPathName: boolean, height: int, highlightColor: tuple[float, float, float], isObscured: boolean, manage: boolean, noBackground: boolean, numberOfPopupMenus: boolean, parent: string, popupMenuArray: boolean, preventOverride: boolean, statusBarMessage: string, useTemplate: string, visible: boolean, visibleChangeCommand: script, width: int) -> string:
    """Synopsis:
---
---
 hotkeyEditorPanel(
...
def hotkeySet(current: boolean, delete: boolean, exists: boolean, export: string, hotkeySetArray: boolean, ip: string, rename: string, source: string) -> string:
    """Synopsis:
---
---
 hotkeySet(
...
def hudButton(allowOverlap: boolean, block: int, blockAlignment: string, blockSize: string, buttonShape: string, buttonWidth: int, label: string, labelFontSize: string, padding: int, pressCommand: script, releaseCommand: script, section: int, visible: boolean) -> int | string | int | int[2]:
    """Synopsis:
---
---
...
def hudSlider(allowOverlap: boolean, block: int, blockAlignment: string, blockSize: string, decimalPrecision: int, dragCommand: script, internalPadding: int, label: string, labelFontSize: string, labelWidth: int, maxValue: float, minValue: float, padding: int, pressCommand: script, releaseCommand: script, section: int, sliderIncrement: float, sliderLength: int, type: string, value: float, valueAlignment: string, valueFontSize: string, valueWidth: int, visible: boolean) -> int | string | int | int[2]:
    """Synopsis:
---
---
...
def hudSliderButton(allowOverlap: boolean, block: int, blockAlignment: string, blockSize: string, buttonLabel: string, buttonLabelFontSize: string, buttonPressCommand: script, buttonReleaseCommand: script, buttonShape: string, buttonWidth: int, decimalPrecision: int, internalPadding: int, maxValue: float, minValue: float, padding: int, section: int, sliderDragCommand: script, sliderIncrement: float, sliderLabel: string, sliderLabelFontSize: string, sliderLabelWidth: int, sliderLength: int, sliderPressCommand: script, sliderReleaseCommand: script, type: string, value: float, valueAlignment: string, valueFontSize: string, valueWidth: int, visible: boolean) -> int | string | int | int[2]:
    """Synopsis:
---
---
...
def hwReflectionMap(backTextureName: string, bottomTextureName: string, cubeMap: boolean, decalMode: boolean, enable: boolean, frontTextureName: string, leftTextureName: string, rightTextureName: string, sphereMapTextureName: string, topTextureName: string) -> string:
    """Synopsis:
---
---
...
def hwRender(acceleratedMultiSampleSupport: boolean, activeTextureCount: boolean, camera: string, currentFrame: boolean, currentView: boolean, edgeAntiAliasing: tuple[uint, uint], fixFileNameNumberPattern: boolean, frame: float, fullRenderSupport: boolean, height: uint, imageFileName: boolean, layer: name, limitedRenderSupport: boolean, lowQualityLighting: boolean, noRenderView: boolean, notWriteToFile: boolean, printGeometry: boolean, renderHardwareName: boolean, renderRegion: tuple[uint, uint, uint, uint], renderSelected: boolean, textureResolution: uint, width: uint, writeAlpha: boolean, writeDepth: boolean) -> boolean:
    """Synopsis:
---
---
...
def hyperPanel(control: boolean, copy: string, createString: boolean, defineTemplate: string, docTag: string, editString: boolean, exists: boolean, hyperEditor: boolean, init: boolean, isUnique: boolean, label: string, menuBarRepeatLast: boolean, menuBarVisible: boolean, needsInit: boolean, parent: string, popupMenuProcedure: script, replacePanel: string, tearOff: boolean, tearOffCopy: string, tearOffRestore: boolean, unParent: boolean, useTemplate: string) -> string:
    """Synopsis:
---
---
 hyperPanel(
...
def hyperShade(assign: string, clearWorkArea: boolean, collapse: string, createNode: string, dependGraphArea: boolean, downStream: boolean, duplicate: boolean, fixRenderSize: boolean, geometries: string, incremental: boolean, listDownstreamNodes: name, listDownstreamShaderNodes: name, listGeometries: string, listMaterialNodes: boolean, listUpstreamNodes: name, name: string, networks: boolean, noSGShapes: boolean, noShapes: boolean, noTransforms: boolean, objects: string, renderCreateAndDrop: string, reset: boolean, resetGraph: boolean, resetSwatch: boolean, setAllowsRegraphing: boolean, setWorkArea: string, shaderNetwork: string, shaderNetworks: boolean, shaderNetworksSelectMaterialNodes: boolean, snapShot: boolean, uncollapse: string, upStream: boolean, useMaterialTemplate: boolean, userDefinedLayout: boolean, workAreaAddCmd: string, workAreaDeleteCmd: string, workAreaSelectCmd: string) -> string:
    """Synopsis:
---
---
