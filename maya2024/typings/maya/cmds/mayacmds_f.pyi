...
def falloffCurve(addControlVertex: string, annotation: string, asString: string, backgroundColor: tuple[float, float, float], changeCommand: script, currentKey: int, currentKeyValue: tuple[float, float], customCurveWidget: boolean, defineTemplate: string, deleteControlVertex: int, docTag: string, dragCallback: script, dropCallback: script, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, fullPathName: boolean, height: int, highlightColor: tuple[float, float, float], isObscured: boolean, manage: boolean, noBackground: boolean, numberOfPopupMenus: boolean, optionVar: string, parent: string, popupMenuArray: boolean, preventOverride: boolean, readOnly: boolean, snapToGrid: boolean, statusBarMessage: string, useTemplate: string, visible: boolean, visibleChangeCommand: script, width: int) -> string:
    """Synopsis:
---
---
 falloffCurve(
...
def falloffCurveAttr(addControlVertex: string, annotation: string, asString: string, attribute: name, backgroundColor: tuple[float, float, float], changeCommand: script, currentKey: int, currentKeyValue: tuple[float, float], customCurveWidget: int, defineTemplate: string, deleteControlVertex: int, docTag: string, dragCallback: script, dropCallback: script, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, fullPathName: boolean, height: int, highlightColor: tuple[float, float, float], isObscured: boolean, manage: boolean, noBackground: boolean, numberOfPopupMenus: boolean, parent: string, popupMenuArray: boolean, preventOverride: boolean, readOnly: int, selectedPositionControl: string, selectedValueControl: string, snapToGrid: int, statusBarMessage: string, useTemplate: string, visible: boolean, visibleChangeCommand: script, width: int) -> string:
    """Synopsis:
---
---
 falloffCurveAttr(
...
def file(absoluteName: boolean, activate: boolean, activeProxy: boolean, add: boolean, anyModified: boolean, applyTo: string, buildLoadSettings: boolean, channels: boolean, cleanReference: string, command: tuple[string, string], compress: boolean, constraints: boolean, constructionHistory: boolean, copyNumberList: boolean, defaultExtensions: boolean, defaultNamespace: boolean, deferReference: boolean, editCommand: string, errorStatus: boolean, executeScriptNodes: boolean, exists: boolean, expandName: boolean, exportAll: boolean, exportAnim: boolean, exportAnimFromReference: boolean, exportAsReference: boolean, exportAsSegment: boolean, exportSelected: boolean, exportSelectedAnim: boolean, exportSelectedAnimFromReference: boolean, exportSelectedNoReference: boolean, exportSelectedStrict: boolean, exportSnapshotCallback: tuple[script, string], exportUnloadedReferences: boolean, expressions: boolean, fileMetaData: boolean, flushReference: string, force: boolean, groupLocator: boolean, groupName: string, groupReference: boolean, i: boolean, ignoreVersion: boolean, importFrameRate: boolean, importReference: boolean, importTimeRange: string, lastFileOption: boolean, lastTempFile: boolean, list: boolean, loadAllDeferred: boolean, loadAllReferences: boolean, loadNoReferences: boolean, loadReference: string, loadReferenceDepth: string, loadReferencePreview: string, loadSettings: string, location: boolean, lockContainerUnpublished: boolean, lockFile: boolean, lockReference: boolean, mapPlaceHolderNamespace: tuple[string, string], mergeBaseAnimLayer: boolean, mergeNamespaceWithParent: boolean, mergeNamespaceWithRoot: boolean, mergeNamespacesOnClash: boolean, modified: boolean, moveSelected: boolean, namespace: string, newFile: boolean, open: boolean, options: string, parentNamespace: boolean, postSaveScript: string, preSaveScript: string, preserveName: boolean, preserveReferences: boolean, preview: boolean, prompt: boolean, proxyManager: string, proxyTag: string, reference: boolean, referenceDepthInfo: uint, referenceNode: string, relativeNamespace: string, removeDuplicateNetworks: boolean, removeReference: boolean, rename: string, renameAll: boolean, renameToSave: boolean, renamingPrefix: string, renamingPrefixList: boolean, replaceName: tuple[string, string], reserveNamespaces: boolean, resetError: boolean, returnNewNodes: boolean, save: boolean, saveDiskCache: string, saveReference: boolean, saveReferencesUnloaded: boolean, saveTextures: string, sceneName: boolean, segment: string, selectAll: boolean, shader: boolean, sharedNodes: string, sharedReferenceFile: boolean, shortName: boolean, strict: boolean, swapNamespace: tuple[string, string], type: string, uiConfiguration: boolean, uiLoadConfiguration: boolean, unloadReference: string, unresolvedName: boolean, usingNamespaces: boolean, withoutCopyNumber: boolean, writable: boolean) -> string:
    """Synopsis:
---
---
 file(
...
def fileBrowserDialog(actionName: string, dialogStyle: int, fileCommand: script, fileType: string, filterList: string, includeName: string, mode: int, operationMode: string, tipMessage: string, windowTitle: string) -> string:
    """Synopsis:
---
---
...
def fileDialog(application: boolean, defaultFileName: string, directoryMask: string, mode: int, title: string) -> string:
    """Synopsis:
---
---
...
def fileInfo(referenceNode: string, remove: string) -> list[string]:
    """Synopsis:
---
---
...
def filePathEditor(attributeOnly: boolean, attributeType: string, byType: string, copyAndRepath: tuple[string, string], deregisterType: string, force: boolean, listDirectories: string, listFiles: string, listRegisteredTypes: boolean, preview: boolean, recursive: boolean, refresh: boolean, registerType: string, relativeNames: boolean, repath: string, replaceAll: boolean, replaceField: string, replaceString: tuple[string, string], status: boolean, temporary: boolean, typeLabel: string, unresolved: boolean, withAttribute: boolean) -> None:
    """Synopsis:
---
---
...
def filter(name: string, type: string) -> string:
    """Synopsis:
---
---
...
def filterButterworthCtx(apply: boolean, cutoffFrequency: float, endTime: time, exists: boolean, history: boolean, image1: string, image2: string, image3: string, keepKeysOnFrame: boolean, name: string, samplingRate: float, selectedKeys: boolean, startTime: time) -> string:
    """Synopsis:
---
---
...
def filterCurve(cutoffFrequency: float, endTime: time, filter: string, keepKeysOnFrame: boolean, kernel: string, keySync: boolean, maxTimeStep: float, minTimeStep: float, period: float, precision: float, precisionMode: int, preserveKeyTangent: string, sampleCount: int, samplingRate: float, selectedKeys: boolean, startTime: time, timeTolerance: float, tolerance: float, useQuaternion: boolean, width: time) -> int:
    """Synopsis:
---
---
...
def filterExpand(expand: boolean, fullPath: boolean, selectionMask: int, symActive: boolean, symNegative: boolean, symPositive: boolean, symSeam: boolean) -> list[string]:
    """Synopsis:
---
---
...
def filterGaussianCtx(apply: boolean, endTime: time, exists: boolean, history: boolean, image1: string, image2: string, image3: string, name: string, sampleCount: int, selectedKeys: boolean, startTime: time, useQuaternion: boolean, width: time) -> string:
    """Synopsis:
---
---
 filterGaussianCtx(
...
def filterInstances(shapes: boolean) -> list[string]:
    """Synopsis:
---
---
...
def filterKeyReducerCtx(apply: boolean, endTime: time, exists: boolean, history: boolean, image1: string, image2: string, image3: string, keySync: boolean, name: string, precision: float, precisionMode: int, preserveKeyTangent: string, selectedKeys: boolean, startTime: time) -> string:
    """Synopsis:
---
---
 filterKeyReducerCtx(
...
def filterStudioImport(convertShellToPoly: boolean, includeCameras: boolean, includeLights: boolean, transferDirectoryName: string) -> None:
    """Synopsis:
---
---
...
def findKeyframe(animation: string, attribute: string, controlPoints: boolean, curve: boolean, float: floatrange, hierarchy: string, includeUpperBound: boolean, index: uint, shape: boolean, time: timerange, timeSlider: boolean, which: string) -> time:
    """Synopsis:
---
---
 findKeyframe(
...
def findType(deep: boolean, exact: boolean, forward: boolean, type: string) -> list[string]:
    """Synopsis:
---
---
...
def fitBspline(caching: boolean, constructionHistory: boolean, name: string, nodeState: int, object: boolean, tolerance: linear) -> list[string]:
    """Synopsis:
---
---
...
def flexor(atBones: boolean, atJoints: boolean, deformerCommand: string, list: boolean, name: string, noScale: boolean, toSkeleton: boolean, type: string) -> list[string]:
    """Synopsis:
---
---
 flexor(
...
def floatSliderButtonGrp(adjustableColumn: int, adjustableColumn2: int, adjustableColumn3: int, adjustableColumn4: int, adjustableColumn5: int, adjustableColumn6: int, annotation: string, backgroundColor: tuple[float, float, float], buttonCommand: script, buttonLabel: string, changeCommand: script, columnAlign: tuple[int, string], columnAlign2: tuple[string, string], columnAlign3: tuple[string, string, string], columnAlign4: tuple[string, string, string, string], columnAlign5: tuple[string, string, string, string, string], columnAlign6: tuple[string, string, string, string, string, string], columnAttach: tuple[int, string, int], columnAttach2: tuple[string, string], columnAttach3: tuple[string, string, string], columnAttach4: tuple[string, string, string, string], columnAttach5: tuple[string, string, string, string, string], columnAttach6: tuple[string, string, string, string, string, string], columnOffset2: tuple[int, int], columnOffset3: tuple[int, int, int], columnOffset4: tuple[int, int, int, int], columnOffset5: tuple[int, int, int, int, int], columnOffset6: tuple[int, int, int, int, int, int], columnWidth: tuple[int, int], columnWidth1: int, columnWidth2: tuple[int, int], columnWidth3: tuple[int, int, int], columnWidth4: tuple[int, int, int, int], columnWidth5: tuple[int, int, int, int, int], columnWidth6: tuple[int, int, int, int, int, int], defineTemplate: string, docTag: string, dragCallback: script, dragCommand: script, dropCallback: script, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, extraLabel: string, field: boolean, fieldMaxValue: float, fieldMinValue: float, fieldStep: float, fullPathName: boolean, height: int, highlightColor: tuple[float, float, float], image: string, isObscured: boolean, label: string, manage: boolean, maxValue: float, minValue: float, noBackground: boolean, numberOfPopupMenus: boolean, parent: string, popupMenuArray: boolean, precision: int, preventOverride: boolean, rowAttach: tuple[int, string, int], sliderStep: float, statusBarMessage: string, step: float, symbolButtonCommand: script, symbolButtonDisplay: boolean, useTemplate: string, value: float, visible: boolean, visibleChangeCommand: script, width: int) -> string:
    """Synopsis:
---
---
...
def floatSliderGrp(adjustableColumn: int, adjustableColumn2: int, adjustableColumn3: int, adjustableColumn4: int, adjustableColumn5: int, adjustableColumn6: int, annotation: string, backgroundColor: tuple[float, float, float], changeCommand: script, columnAlign: tuple[int, string], columnAlign2: tuple[string, string], columnAlign3: tuple[string, string, string], columnAlign4: tuple[string, string, string, string], columnAlign5: tuple[string, string, string, string, string], columnAlign6: tuple[string, string, string, string, string, string], columnAttach: tuple[int, string, int], columnAttach2: tuple[string, string], columnAttach3: tuple[string, string, string], columnAttach4: tuple[string, string, string, string], columnAttach5: tuple[string, string, string, string, string], columnAttach6: tuple[string, string, string, string, string, string], columnOffset2: tuple[int, int], columnOffset3: tuple[int, int, int], columnOffset4: tuple[int, int, int, int], columnOffset5: tuple[int, int, int, int, int], columnOffset6: tuple[int, int, int, int, int, int], columnWidth: tuple[int, int], columnWidth1: int, columnWidth2: tuple[int, int], columnWidth3: tuple[int, int, int], columnWidth4: tuple[int, int, int, int], columnWidth5: tuple[int, int, int, int, int], columnWidth6: tuple[int, int, int, int, int, int], defineTemplate: string, docTag: string, dragCallback: script, dragCommand: script, dropCallback: script, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, extraLabel: string, field: boolean, fieldMaxValue: float, fieldMinValue: float, fieldStep: float, fullPathName: boolean, height: int, highlightColor: tuple[float, float, float], isObscured: boolean, label: string, manage: boolean, maxValue: float, minValue: float, noBackground: boolean, numberOfPopupMenus: boolean, parent: string, popupMenuArray: boolean, precision: int, preventOverride: boolean, rowAttach: tuple[int, string, int], sliderStep: float, statusBarMessage: string, step: float, useTemplate: string, value: float, visible: boolean, visibleChangeCommand: script, width: int) -> string:
    """Synopsis:
---
---
 floatSliderGrp(
...
def flow(divisions: tuple[uint, uint, uint], localCompute: boolean, localDivisions: tuple[uint, uint, uint], objectCentered: boolean) -> list[string]:
    """Synopsis:
---
---
 flow(
...
def flowLayout(annotation: string, backgroundColor: tuple[float, float, float], childArray: boolean, columnSpacing: int, defineTemplate: string, docTag: string, dragCallback: script, dropCallback: script, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, fullPathName: boolean, generalSpacing: int, height: int, highlightColor: tuple[float, float, float], horizontal: boolean, isObscured: boolean, manage: boolean, margins: int, noBackground: boolean, numberOfChildren: boolean, numberOfPopupMenus: boolean, parent: string, popupMenuArray: boolean, preventOverride: boolean, statusBarMessage: string, useTemplate: string, vertical: boolean, visible: boolean, visibleChangeCommand: script, width: int, wrap: boolean) -> string:
    """Synopsis:
---
---
 flowLayout(
...
def fluidCacheInfo(attribute: string, cacheTime: time, endFrame: boolean, hasCache: boolean, hasData: boolean, initialConditions: boolean, playback: boolean, resolution: boolean, startFrame: boolean) -> None:
    """Synopsis:
---
---
...
def fluidEmitter(cycleEmission: string, cycleInterval: int, densityEmissionRate: float, fluidDropoff: float, fuelEmissionRate: float, heatEmissionRate: float, maxDistance: linear, minDistance: linear, name: string, position: tuple[linear, linear, linear], rate: float, torusSectionRadius: linear, type: string, volumeOffset: tuple[linear, linear, linear], volumeShape: string, volumeSweep: angle) -> string:
    """Synopsis:
---
---
 fluidEmitter(
...
def fluidVoxelInfo(checkBounds: boolean, inBounds: tuple[int, int, int], objectSpace: boolean, radius: float, voxel: tuple[float, float, float], voxelCenter: boolean, xIndex: int, yIndex: int, zIndex: int) -> None:
    """Synopsis:
---
---
...
def fontDialog(FontList: boolean, scalable: boolean) -> string:
    """Synopsis:
---
---
...
def formLayout(annotation: string, attachControl: tuple[string, string, int, string], attachForm: tuple[string, string, int], attachNone: tuple[string, string], attachOppositeControl: tuple[string, string, int, string], attachOppositeForm: tuple[string, string, int], attachPosition: tuple[string, string, int, int], backgroundColor: tuple[float, float, float], childArray: boolean, defineTemplate: string, docTag: string, dragCallback: script, dropCallback: script, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, fullPathName: boolean, generalSpacing: int, height: int, highlightColor: tuple[float, float, float], isObscured: boolean, manage: boolean, margins: int, noBackground: boolean, numberOfChildren: boolean, numberOfDivisions: int, numberOfPopupMenus: boolean, parent: string, popupMenuArray: boolean, preventOverride: boolean, statusBarMessage: string, useTemplate: string, visible: boolean, visibleChangeCommand: script, width: int) -> string:
    """Synopsis:
---
---
 formLayout(
...
def format(stringArg: string) -> string:
    """Synopsis:
---
---
...
def frameBufferName(autoTruncate: boolean, camera: string, renderLayer: string, renderPass: string) -> string:
    """Synopsis:
---
---
...
def frameLayout(annotation: string, backgroundColor: tuple[float, float, float], backgroundShade: boolean, borderStyle: string, borderVisible: boolean, childArray: boolean, collapsable: boolean, collapse: boolean, collapseCommand: script, defineTemplate: string, docTag: string, dragCallback: script, dropCallback: script, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, expandCommand: script, font: string, fullPathName: boolean, generalSpacing: int, height: int, highlightColor: tuple[float, float, float], isObscured: boolean, label: string, labelAlign: string, labelIndent: int, labelVisible: boolean, labelWidth: int, manage: boolean, marginHeight: int, marginWidth: int, margins: int, noBackground: boolean, numberOfChildren: boolean, numberOfPopupMenus: boolean, parent: string, popupMenuArray: boolean, preCollapseCommand: script, preExpandCommand: script, preventOverride: boolean, statusBarMessage: string, useTemplate: string, visible: boolean, visibleChangeCommand: script, width: int) -> string:
    """Synopsis:
---
---
 frameLayout(
...
def framelessDialog(button: string, message: string, parent: string, path: string, primary: string, title: string) -> string:
    """Synopsis:
---
---
...
def freeFormFillet(bias: float, caching: boolean, constructionHistory: boolean, depth: float, name: string, nodeState: int, object: boolean, polygon: int, positionTolerance: float, range: boolean, tangentTolerance: float) -> list[string]:
    """Synopsis:
---
---
 freeFormFillet(
...
def freeze(allNodes: boolean, displayLayers: boolean, downstream: boolean, forceDownstream: boolean, frozen: boolean, invisible: boolean, noFreeze: boolean, unfreeze: boolean, upstream: boolean) -> list[string]:
    """Synopsis:
---
---
...
def freezeOptions(displayLayers: boolean, downstream: string, explicitPropagation: boolean, invisible: boolean, referencedNodes: boolean, runtimePropagation: boolean, upstream: string) -> boolean | string:
    """Synopsis:
---
---
