...
def keyTangent(flagabsolute: boolean, flaganimation: string, flagattribute: string, flagcontrolPoints: boolean, flagfloat: floatrange, flagg: boolean, flaghierarchy: string, flaginAngle: angle, flaginTangentType: string, flaginWeight: float, flagincludeUpperBound: boolean, flagindex: uint, flagix: float, flagiy: float, flaglock: boolean, flagoutAngle: angle, flagoutTangentType: string, flagoutWeight: float, flagox: float, flagoy: float, flagpluginTangentTypes: string, flagrelative: boolean, flagshape: boolean, flagstepAttributes: boolean, flagtime: timerange, flagunify: boolean, flagweightLock: boolean, flagweightedTangents: boolean) -> int:
    """Synopsis:
---
---
 keyTangent(
...
def keyframe(flagabsolute: boolean, flagadjustBreakdown: boolean, flaganimation: string, flagattribute: string, flagbreakdown: boolean, flagclipTime: tuple[time, time, float], flagcontrolPoints: boolean, flageval: boolean, flagfloat: floatrange, flagfloatChange: float, flaghierarchy: string, flagincludeUpperBound: boolean, flagindex: uint, flagindexValue: boolean, flagkeyframeCount: boolean, flaglastSelected: boolean, flagname: boolean, flagoption: string, flagrelative: boolean, flagselected: boolean, flagshape: boolean, flagtickDrawSpecial: boolean, flagtime: timerange, flagtimeChange: time, flagvalueChange: float) -> int:
    """Synopsis:
---
---
 keyframe(
...
def keyframeRegionCurrentTimeCtx(flagexists: boolean, flaghistory: boolean, flagimage1: string, flagimage2: string, flagimage3: string, flagname: string) -> string:
    """Synopsis:
---
---
...
def keyframeRegionDirectKeyCtx(flagexists: boolean, flaghistory: boolean, flagimage1: string, flagimage2: string, flagimage3: string, flagname: string, flagoption: string) -> string:
    """Synopsis:
---
---
...
def keyframeRegionDollyCtx(flagexists: boolean, flaghistory: boolean, flagimage1: string, flagimage2: string, flagimage3: string, flagname: string) -> string:
    """Synopsis:
---
---
...
def keyframeRegionInsertKeyCtx(flagbreakdown: boolean, flagexists: boolean, flaghistory: boolean, flagimage1: string, flagimage2: string, flagimage3: string, flagname: string) -> string:
    """Synopsis:
---
---
...
def keyframeRegionMoveKeyCtx(flagexists: boolean, flaghistory: boolean, flagimage1: string, flagimage2: string, flagimage3: string, flagname: string, flagoption: string) -> string:
    """Synopsis:
---
---
...
def keyframeRegionScaleKeyCtx(flagexists: boolean, flaghistory: boolean, flagimage1: string, flagimage2: string, flagimage3: string, flagname: string, flagscaleSpecifiedKeys: boolean, flagtype: string) -> string:
    """Synopsis:
---
---
...
def keyframeRegionSelectKeyCtx(flagexists: boolean, flaghistory: boolean, flagimage1: string, flagimage2: string, flagimage3: string, flagname: string) -> string:
    """Synopsis:
---
---
...
def keyframeRegionSetKeyCtx(flagbreakdown: boolean, flagexists: boolean, flaghistory: boolean, flagimage1: string, flagimage2: string, flagimage3: string, flagname: string) -> string:
    """Synopsis:
---
---
...
def keyframeRegionTrackCtx(flagexists: boolean, flaghistory: boolean, flagimage1: string, flagimage2: string, flagimage3: string, flagname: string) -> string:
    """Synopsis:
---
---
...
def keyingGroup(flagactivator: name, flagaddElement: name, flagafterFilters: boolean, flaganyMember: name, flagcategory: string, flagclear: name, flagcolor: int, flagcopy: name, flagedges: boolean, flageditPoints: boolean, flagempty: boolean, flagexcludeDynamic: boolean, flagexcludeRotate: boolean, flagexcludeScale: boolean, flagexcludeTranslate: boolean, flagexcludeVisibility: boolean, flagfacets: boolean, flagflatten: name, flagforceElement: name, flaginclude: name, flagintersection: name, flagisIntersecting: name, flagisMember: name, flaglayer: boolean, flagminimizeRotation: boolean, flagname: string, flagnoIntermediate: boolean, flagnoSurfaceShader: boolean, flagnoWarnings: boolean, flagnodesOnly: boolean, flagremove: name, flagremoveActivator: name, flagrenderable: boolean, flagsetActiveFilter: string, flagsize: boolean, flagsplit: name, flagsubtract: name, flagtext: string, flagunion: name, flagvertices: boolean) -> boolean | list[string] | string:
    """Synopsis:
---
---
 keyingGroup(
