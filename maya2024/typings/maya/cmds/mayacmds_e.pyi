...
def editDisplayLayerGlobals(baseId: int, currentDisplayLayer: name, mergeType: int, useCurrent: boolean) -> boolean | int | string:
    """Synopsis:
---
---
...
def editDisplayLayerMembers(clear: boolean, fullNames: boolean, noRecurse: boolean, ufeObjects: boolean) -> int | list[string]:
    """Synopsis:
---
---
...
def editMetadata(channelName: string, channelType: string, endIndex: string, index: string, indexType: string, memberName: string, remove: boolean, scene: boolean, startIndex: string, streamName: string, stringValue: string, value: float) -> string:
    """Synopsis:
---
---
...
def editRenderLayerAdjustment(attributeLog: boolean, layer: name, nodeLog: boolean, remove: boolean) -> int | list[string]:
    """Synopsis:
---
---
...
def editRenderLayerGlobals(baseId: int, currentRenderLayer: name, enableAutoAdjustments: boolean, mergeType: int, useCurrent: boolean) -> boolean | int | string:
    """Synopsis:
---
---
...
def editRenderLayerMembers(fullNames: boolean, noRecurse: boolean, remove: boolean) -> int | list[string]:
    """Synopsis:
---
---
...
def editorTemplate(addAdskAssetControls: boolean, addComponents: boolean, addControl: tuple[string, script], addDynamicControl: tuple[string, script], addExtraControls: boolean, addSeparator: boolean, annotateFieldOnly: boolean, annotation: string, beginLayout: string, beginNoOptimize: boolean, beginScrollLayout: boolean, callCustom: tuple[script, script], collapse: boolean, debugMode: boolean, dimControl: tuple[string, string, boolean], endLayout: boolean, endNoOptimize: boolean, endScrollLayout: boolean, extraControlsLabel: string, forceRebuild: boolean, interruptOptimize: boolean, label: string, listExtraAttributes: string, preventOverride: boolean, queryControl: tuple[string, string], queryLabel: tuple[string, string], queryName: tuple[string, string], suppress: string) -> string:
    """Synopsis:
---
---
...
def effector(hide: boolean, name: string) -> string:
    """Synopsis:
---
---
 effector(
...
def emit(attribute: string, floatValue: float, object: string, position: tuple[float, float, float], vectorValue: tuple[float, float, float]) -> list[int]:
    """Synopsis:
---
---
...
def emitter(alongAxis: float, aroundAxis: float, awayFromAxis: float, awayFromCenter: float, cycleEmission: string, cycleInterval: int, directionX: linear, directionY: linear, directionZ: linear, directionalSpeed: float, maxDistance: linear, minDistance: linear, name: string, needParentUV: boolean, normalSpeed: float, position: tuple[linear, linear, linear], randomDirection: float, rate: float, scaleRateByObjectSize: boolean, scaleSpeedBySize: boolean, speed: float, speedRandom: float, spread: float, tangentSpeed: float, torusSectionRadius: linear, type: string, volumeOffset: tuple[linear, linear, linear], volumeShape: string, volumeSweep: angle) -> string:
    """Synopsis:
---
---
 emitter(
...
def enableDevice(apply: boolean, device: string, enable: boolean, monitor: boolean, record: boolean) -> None:
    """Synopsis:
---
---
...
def error(noContext: boolean, showLineNumber: boolean) -> None:
    """Synopsis:
---
---
...
def evalDeferred(evaluateNext: boolean, list: boolean, lowPriority: boolean, lowestPriority: boolean) -> list[string]:
    """Synopsis:
---
---
 evalDeferred(
...
def evaluator(clusters: boolean, configuration: string, enable: boolean, info: boolean, name: string, nodeType: string, nodeTypeChildren: boolean, priority: int, valueName: string) -> boolean | int | list[string] | string:
    """Synopsis:
---
---
...
def event(count: uint, delete: boolean, dieAtCollision: boolean, emit: uint, list: boolean, name: string, proc: script, random: boolean, rename: string, select: boolean, split: uint, spread: float, target: string) -> string:
    """Synopsis:
---
---
 event(
...
def exactWorldBoundingBox(calculateExactly: boolean, ignoreInvisible: boolean) -> float[]:
    """Synopsis:
---
---
...
def expandedSelection(depth: uint, expansionType: string) -> list[string] | string:
    """Synopsis:
---
---
...
def expression(alwaysEvaluate: uint, animated: uint, attribute: string, name: string, object: string, safe: boolean, shortNames: boolean, string: string, timeDependent: boolean, unitConversion: string) -> string:
    """Synopsis:
---
---
...
def expressionEditorListen(listenFile: string, listenForAttr: string, listenForExpression: string, listenForName: string, stopListenForAttr: string, stopListenForExpression: string, stopListenForName: string) -> None:
    """Synopsis:
---
---
...
def extendCurve(caching: boolean, constructionHistory: boolean, curveOnSurface: boolean, distance: linear, extendMethod: int, extensionType: int, inputPoint: tuple[linear, linear, linear], join: boolean, name: string, noChanges: boolean, nodeState: int, object: boolean, pointX: linear, pointY: linear, pointZ: linear, range: boolean, removeMultipleKnots: boolean, replaceOriginal: boolean, start: int) -> list[string]:
    """Synopsis:
---
---
 extendCurve(
...
def extendSurface(caching: boolean, constructionHistory: boolean, distance: linear, extendDirection: int, extendMethod: int, extendSide: int, extensionType: int, join: boolean, name: string, nodeState: int, object: boolean, replaceOriginal: boolean) -> list[string]:
    """Synopsis:
---
---
 extendSurface(
...
def extrude(caching: boolean, constructionHistory: boolean, degreeAlongLength: int, direction: tuple[linear, linear, linear], directionX: linear, directionY: linear, directionZ: linear, extrudeType: int, fixedPath: boolean, length: linear, mergeItems: boolean, name: string, nodeState: int, object: boolean, pivot: tuple[linear, linear, linear], polygon: int, range: boolean, rebuild: boolean, reverseSurfaceIfPathReversed: boolean, rotation: angle, scale: float, subCurveSubSurface: boolean, useComponentPivot: int, useProfileNormal: boolean) -> list[string]:
    """Synopsis:
---
---
 extrude(
