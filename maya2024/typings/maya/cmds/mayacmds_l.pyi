...
def lassoContext(drawClosed: boolean, exists: boolean, history: boolean, image1: string, image2: string, image3: string, name: string) -> string:
    """Synopsis:
---
---
 lassoContext(
...
def lattice(after: boolean, afterReference: boolean, before: boolean, commonParent: boolean, components: boolean, deformerTools: boolean, divisions: tuple[uint, uint, uint], dualBase: boolean, exclusive: string, freezeMapping: boolean, frontOfChain: boolean, geometry: string, geometryIndices: boolean, ignoreSelected: boolean, includeHiddenSelections: boolean, latticeReset: boolean, ldivisions: tuple[uint, uint, uint], minimumSize: float, name: string, objectCentered: boolean, outsideFalloffDistance: float, outsideLattice: uint, parallel: boolean, position: tuple[linear, linear, linear], prune: boolean, remove: boolean, removeTweaks: boolean, rotation: tuple[angle, angle, angle], scale: tuple[linear, linear, linear], selectedComponents: boolean, split: boolean, useComponentTags: boolean) -> list[string]:
    """Synopsis:
---
---
 lattice(
...
def latticeDeformKeyCtx(envelope: float, exists: boolean, history: boolean, image1: string, image2: string, image3: string, latticeColumns: uint, latticeRows: uint, name: string, scaleLatticePts: boolean) -> string:
    """Synopsis:
---
---
 latticeDeformKeyCtx(
...
def launch(directory: string, movie: string, pdfFile: string, webPage: string) -> None:
    """Synopsis:
---
---
...
def launchImageEditor(editImageFile: string, viewImageFile: string) -> None:
    """Synopsis:
---
---
 launchImageEditor(
...
def layerButton(annotation: string, backgroundColor: tuple[float, float, float], changeCommand: script, color: tuple[float, float, float], command: script, current: boolean, defineTemplate: string, docTag: string, doubleClickCommand: script, dragCallback: script, dropCallback: script, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, fullPathName: boolean, height: int, hideOnPlaybackCommand: script, highlightColor: tuple[float, float, float], identification: int, isObscured: boolean, label: string, labelWidth: boolean, layerHideOnPlayback: boolean, layerState: string, layerVisible: boolean, manage: boolean, name: string, noBackground: boolean, numberOfPopupMenus: boolean, parent: string, popupMenuArray: boolean, preventOverride: boolean, renameCommand: string, select: boolean, statusBarMessage: string, transparent: boolean, typeCommand: script, useTemplate: string, visible: boolean, visibleChangeCommand: script, visibleCommand: script, width: int) -> string:
    """Synopsis:
---
---
...
def layoutDialog(backgroundColor: tuple[float, float, float], dismiss: string, parent: string, title: string, uiScript: script) -> string:
    """Synopsis:
---
---
...
def license(borrow: boolean, info: boolean, isBorrowed: boolean, isExported: boolean, isTrial: boolean, licenseMethod: boolean, productChoice: boolean, r: boolean, showBorrowInfo: boolean, showProductInfoDialog: boolean, status: boolean, usage: boolean) -> string:
    """Synopsis:
---
---
...
def lightList(add: name, remove: name) -> None:
    """Synopsis:
---
---
...
def lightlink(b: boolean, hierarchy: boolean, light: name, make: boolean, object: name, sets: boolean, shadow: boolean, shapes: boolean, transforms: boolean, useActiveLights: boolean, useActiveObjects: boolean) -> list[string] | string:
    """Synopsis:
---
---
 lightlink(
...
def listAnimatable(active: boolean, manip: boolean, manipHandle: boolean, shape: boolean, type: boolean) -> list[string]:
    """Synopsis:
---
---
...
def listAttrPatterns(patternType: boolean, verbose: boolean) -> list[string]:
    """Synopsis:
---
---
...
def listCameras(orthographic: boolean, perspective: boolean) -> list[string]:
    """Synopsis:
---
---
...
def listConnections(connections: boolean, destination: boolean, exactType: boolean, fullNodeName: boolean, plugs: boolean, shapes: boolean, skipConversionNodes: boolean, source: boolean, type: string) -> list[string]:
    """Synopsis:
---
---
...
def listDeviceAttachments(attribute: string, axis: string, clutch: string, device: string, file: string, selection: boolean, write: boolean) -> string:
    """Synopsis:
---
---
...
def listHistory(allConnections: boolean, allFuture: boolean, allGraphs: boolean, breadthFirst: boolean, fastIteration: boolean, fullNodeName: boolean, future: boolean, futureLocalAttr: boolean, futureWorldAttr: boolean, groupLevels: boolean, historyAttr: boolean, interestLevel: int, leaf: boolean, levels: uint, pruneDagObjects: boolean) -> list[string]:
    """Synopsis:
---
---
 listHistory(
...
def listInputDevices(free: boolean, primary: boolean, secondary: boolean) -> list[string]:
    """Synopsis:
---
---
...
def listNodeTypes(exclude: string) -> list[string]:
    """Synopsis:
---
---
 listNodeTypes(
...
def listRelatives(allDescendents: boolean, allParents: boolean, children: boolean, fullPath: boolean, noIntermediate: boolean, parent: boolean, path: boolean, shapes: boolean, type: string) -> list[string]:
    """Synopsis:
---
---
 listRelatives(
...
def listSets(allSets: boolean, extendToShape: boolean, object: name, type: uint) -> list[string]:
    """Synopsis:
---
---
 listSets(
...
def loadFluid(currentTime: boolean, frame: float, initialConditions: boolean) -> None:
    """Synopsis:
---
---
...
def loadModule(allModules: boolean, load: string, scan: boolean) -> list[string]:
    """Synopsis:
---
---
...
def loadPlugin(addCallback: script, allPlugins: boolean, name: string, quiet: boolean, removeCallback: script) -> list[string]:
    """Synopsis:
---
---
 loadPlugin(
...
def loadUI(listTypes: boolean, uiFile: string, uiString: string, verbose: boolean, workingDirectory: string) -> string:
    """Synopsis:
---
---
...
def lockNode(ignoreComponents: boolean, lock: boolean, lockName: boolean, lockUnpublished: boolean) -> boolean[]:
    """Synopsis:
---
---
...
def loft(autoReverse: boolean, caching: boolean, close: boolean, constructionHistory: boolean, createCusp: boolean, degree: int, name: string, nodeState: int, object: boolean, polygon: int, range: boolean, rebuild: boolean, reverse: boolean, reverseSurfaceNormals: boolean, sectionSpans: int, uniform: boolean) -> list[string]:
    """Synopsis:
---
---
 loft(
...
def lookThru(farClip: float, nearClip: float) -> None:
    """Synopsis:
---
---
 lookThru(
...
def lsThroughFilter(item: string, nodeArray: boolean, reverse: boolean, selection: boolean, sort: string) -> list[string]:
    """Synopsis:
---
---
 lsThroughFilter(
