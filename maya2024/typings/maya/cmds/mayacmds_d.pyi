...
def dagObjectCompare(attribute: boolean, bail: string, connection: boolean, namespace: string, relative: boolean, short: boolean, type: boolean) -> None:
    """Synopsis:
---
---
...
def dagPose(addToPose: boolean, atPose: boolean, bindPose: boolean, g: boolean, members: boolean, name: string, remove: boolean, reset: boolean, restore: boolean, save: boolean, selection: boolean, worldParent: boolean) -> string:
    """Synopsis:
---
---
 dagPose(
...
def dataStructure(asFile: string, asString: string, dataType: boolean, format: string, listMemberNames: string, name: string, remove: boolean, removeAll: boolean) -> list[string] | string:
    """Synopsis:
---
---
...
def date(date: boolean, format: string, shortDate: boolean, shortTime: boolean, time: boolean) -> string:
    """Synopsis:
---
---
...
def dbcount(enabled: boolean, file: string, keyword: string, list: boolean, maxdepth: uint, quick: boolean, reset: boolean, spreadsheet: boolean) -> None:
    """Synopsis:
---
---
...
def dbfootprint(allObjects: boolean, outputFile: string, type: string) -> list[string] | string:
    """Synopsis:
---
---
...
def dbmessage(file: string, list: boolean, monitor: boolean, type: string) -> None:
    """Synopsis:
---
---
...
def dbpeek(allObjects: boolean, argument: string, count: uint, evaluationGraph: boolean, operation: string, outputFile: string) -> int | list[string] | string:
    """Synopsis:
---
---
...
def dbtrace(filter: string, info: boolean, keyword: string, mark: boolean, off: boolean, output: string, timed: boolean, title: string, verbose: boolean) -> None:
    """Synopsis:
---
---
...
def defineDataServer(device: string, server: string, undefine: boolean) -> None:
    """Synopsis:
---
---
...
def defineVirtualDevice(axis: int, channel: string, clear: boolean, create: boolean, device: string, parent: string, undefine: boolean, usage: string) -> None:
    """Synopsis:
---
---
...
def deformerEvaluator(active: boolean, allowDownloadRejections: boolean, allowDownloads: boolean, asNodeName: boolean, asText: boolean, deformerChain: boolean, deformers: boolean, dumpInfo: boolean, dumpOutliner: boolean, gpuBlockPolicy: string, isOpenCLValid: boolean, limitMinimumVerts: boolean, list: boolean, members: boolean, meshes: boolean, message: boolean, minimumVerts: int, nodeInfo: boolean, nodeStatus: boolean, omitPassthroughs: boolean, outlinerHash: boolean, partition: boolean, purge: boolean, reuseMode: tuple[string, string], verbose: boolean) -> list[string]:
    """Synopsis:
---
---
...
def delete(all: boolean, attribute: string, channels: boolean, constraints: boolean, constructionHistory: boolean, controlPoints: boolean, expressions: boolean, hierarchy: string, inputConnectionsAndNodes: boolean, motionPaths: boolean, shape: boolean, staticChannels: boolean, timeAnimationCurves: boolean, unitlessAnimationCurves: boolean) -> None:
    """Synopsis:
---
---
 delete(
...
def deleteAttr(attribute: string) -> None:
    """Synopsis:
---
---
 deleteAttr(
...
def deleteAttrPattern(allPatterns: boolean, patternName: string, patternType: string) -> string:
    """Synopsis:
---
---
...
def deleteExtension(attribute: string, forceDelete: boolean, nodeType: string) -> int:
    """Synopsis:
---
---
...
def deleteUI(collection: boolean, control: boolean, editor: boolean, layout: boolean, menu: boolean, menuItem: boolean, panel: boolean, panelConfig: boolean, radioMenuItemCollection: boolean, toolContext: boolean, uiTemplate: boolean, window: boolean) -> None:
    """Synopsis:
---
---
 deleteUI(
...
def detachCurve(caching: boolean, constructionHistory: boolean, curveOnSurface: boolean, keep: boolean, name: string, nodeState: int, object: boolean, parameter: float, replaceOriginal: boolean) -> list[string]:
    """Synopsis:
---
---
 detachCurve(
...
def detachDeviceAttr(all: boolean, attribute: string, axis: string, device: string, selection: boolean) -> None:
    """Synopsis:
---
---
...
def detachSurface(caching: boolean, constructionHistory: boolean, direction: int, keep: boolean, name: string, nodeState: int, object: boolean, parameter: float, replaceOriginal: boolean) -> list[string]:
    """Synopsis:
---
---
 detachSurface(
...
def deviceManager(attachment: boolean, axisCoordChanges: boolean, axisIndex: int, axisName: boolean, axisOffset: boolean, axisScale: boolean, deviceIndex: int, deviceNameFromIndex: int, numAxis: boolean, numDevices: boolean) -> None:
    """Synopsis:
---
---
...
def dgInfo(allNodes: boolean, connections: boolean, dirty: boolean, nodes: boolean, nonDeletable: boolean, outputFile: string, propagation: boolean, short: boolean, size: boolean, subgraph: boolean, type: string) -> None:
    """Synopsis:
---
---
...
def dgValidateCurve(allCurves: boolean, verbose: boolean) -> int:
    """Synopsis:
---
---
...
def dgdirty(allPlugs: boolean, clean: boolean, implicit: boolean, list: string, propagation: boolean, showTiming: boolean, verbose: boolean) -> int | list[string]:
    """Synopsis:
---
---
...
def dgeval(src: boolean, verbose: boolean) -> None:
    """Synopsis:
---
---
 dgeval(
...
def dgfilter(attribute: string, list: boolean, logicalAnd: tuple[string, string], logicalNot: string, logicalOr: tuple[string, string], name: string, node: string, nodeType: string, plug: string) -> boolean | list[string] | string:
    """Synopsis:
---
---
...
def dimWhen(clear: boolean, false: boolean, true: boolean) -> None:
    """Synopsis:
---
---
 dimWhen(
...
def directKeyCtx(exists: boolean, history: boolean, image1: string, image2: string, image3: string, name: string, option: string, selectedOnly: boolean) -> string:
    """Synopsis:
---
---
 directKeyCtx(
...
def directionalLight(decayRate: int, discRadius: linear, exclusive: boolean, intensity: float, name: string, position: tuple[linear, linear, linear], rgb: tuple[float, float, float], rotation: tuple[angle, angle, angle], shadowColor: tuple[float, float, float], shadowDither: float, shadowSamples: int, softShadow: boolean, useRayTraceShadows: boolean) -> double[] | int | string:
    """Synopsis:
---
---
...
def dirmap(convertDirectory: string, enable: boolean, getAllMappings: boolean, getMappedDirectory: string, mapDirectory: tuple[string, string], unmapDirectory: string) -> string:
    """Synopsis:
---
---
 dirmap(
...
def disable(value: boolean) -> None:
    """Synopsis:
---
---
 disable(
...
def disconnectAttr(nextAvailable: boolean) -> string:
    """Synopsis:
---
---
 disconnectAttr(
...
def disconnectJoint(attachHandleMode: boolean, deleteHandleMode: boolean) -> string:
    """Synopsis:
---
---
...
def diskCache(append: boolean, cacheType: string, close: string, closeAll: boolean, delete: string, deleteAll: boolean, empty: string, emptyAll: boolean, enabledCachesOnly: boolean, endTime: time, frameRangeType: string, overSample: boolean, samplingRate: int, startTime: time, tempDir: boolean) -> None:
    """Synopsis:
---
---
...
def displacementToPoly(findBboxOnly: boolean) -> boolean:
    """Synopsis:
---
---
...
def displayColor(active: boolean, create: boolean, dormant: boolean, list: boolean, queryIndex: int, resetToFactory: boolean, resetToSaved: boolean) -> None:
    """Synopsis:
---
---
 displayColor(
...
def displayCull(backFaceCulling: boolean) -> None:
    """Synopsis:
---
---
 displayCull(
...
def displayLevelOfDetail(levelOfDetail: boolean) -> None:
    """Synopsis:
---
---
...
def displayPref(activeObjectPivots: boolean, displayAffected: boolean, displayGradient: boolean, ghostFrames: tuple[int, int, int], materialLoadingMode: string, maxHardwareTextureResolution: boolean, maxTextureResolution: int, purgeExistingTextures: boolean, regionOfEffect: boolean, shadeTemplates: boolean, textureDrawPixel: boolean, wireframeOnShadedActive: string) -> None:
    """Synopsis:
---
---
...
def displayRGBColor(alpha: boolean, create: boolean, hueSaturationValue: boolean, list: boolean, resetToFactory: boolean, resetToSaved: boolean) -> string:
    """Synopsis:
---
---
 displayRGBColor(
...
def displaySmoothness(all: boolean, boundary: boolean, defaultCreation: boolean, divisionsU: int, divisionsV: int, full: boolean, hull: boolean, pointsShaded: int, pointsWire: int, polygonObject: int, renderTessellation: boolean, simplifyU: int, simplifyV: int) -> None:
    """Synopsis:
---
---
 displaySmoothness(
...
def displayString(delete: boolean, exists: boolean, keys: boolean, replace: boolean, value: string) -> None:
    """Synopsis:
---
---
...
def displaySurface(flipNormals: boolean, twoSidedLighting: boolean, xRay: boolean) -> boolean:
    """Synopsis:
---
---
 displaySurface(
...
def distanceDimContext(exists: boolean, history: boolean, image1: string, image2: string, image3: string, name: string) -> string:
    """Synopsis:
---
---
...
def distanceDimension(endPoint: tuple[linear, linear, linear], startPoint: tuple[linear, linear, linear]) -> string:
    """Synopsis:
---
---
...
def doBlur(colorFile: string, length: float, memCapSize: float, sharpness: float, smooth: float, smoothColor: boolean, vectorFile: string) -> string:
    """Synopsis:
---
---
...
def dolly(absolute: boolean, distance: linear, dollyTowardsCenter: boolean, orthoScale: float, relative: boolean) -> None:
    """Synopsis:
---
---
 dolly(
...
def dollyCtx(alternateContext: boolean, boxDollyType: string, centerOfInterestDolly: boolean, dollyTowardsCenter: boolean, exists: boolean, history: boolean, image1: string, image2: string, image3: string, localDolly: boolean, name: string, orthoZoom: boolean, scale: float, toolName: string) -> string:
    """Synopsis:
---
---
 dollyCtx(
...
def doubleProfileBirailSurface(blendFactor: float, caching: boolean, constructionHistory: boolean, name: string, nodeState: int, object: boolean, polygon: int, tangentContinuityProfile1: boolean, tangentContinuityProfile2: boolean, transformMode: int) -> list[string]:
    """Synopsis:
---
---
...
def drag(attenuation: float, directionX: float, directionY: float, directionZ: float, magnitude: float, maxDistance: linear, name: string, perVertex: boolean, position: tuple[linear, linear, linear], torusSectionRadius: linear, useDirection: boolean, volumeExclusion: boolean, volumeOffset: tuple[linear, linear, linear], volumeShape: string, volumeSweep: angle) -> string:
    """Synopsis:
---
---
 drag(
...
def dragAttrContext(connectTo: name, exists: boolean, history: boolean, image1: string, image2: string, image3: string, name: string, reset: boolean) -> string:
    """Synopsis:
---
---
 dragAttrContext(
...
def draggerContext(anchorPoint: tuple[float, float, float], button: int, currentStep: int, cursor: string, dragCommand: script, dragPoint: tuple[float, float, float], drawString: string, exists: boolean, finalize: script, helpString: string, history: boolean, holdCommand: script, image1: string, image2: string, image3: string, initialize: script, modifier: string, name: string, plane: tuple[float, float, float], prePressCommand: script, pressCommand: script, projection: string, releaseCommand: script, snapping: boolean, space: string, stepsCount: int, undoMode: string) -> string:
    """Synopsis:
---
---
 draggerContext(
...
def duplicate(fullPath: boolean, inputConnections: boolean, instanceLeaf: boolean, name: string, parentOnly: boolean, renameChildren: boolean, returnRootsOnly: boolean, smartTransform: boolean, transformsOnly: boolean, upstreamNodes: boolean) -> list[string]:
    """Synopsis:
---
---
 duplicate(
...
def duplicateCurve(caching: boolean, constructionHistory: boolean, local: boolean, maxValue: float, mergeItems: boolean, minValue: float, name: string, nodeState: int, range: boolean, relative: boolean) -> list[string]:
    """Synopsis:
---
---
...
def duplicateSurface(caching: boolean, constructionHistory: boolean, faceCountU: int, faceCountV: int, firstFaceU: int, firstFaceV: int, local: boolean, mergeItems: boolean, name: string, nodeState: int) -> list[string]:
    """Synopsis:
---
---
...
def dynExport(allObjects: boolean, attribute: string, format: string, maxFrame: time, minFrame: time, onlyUpdateParticles: boolean, overSampling: int, path: string) -> string:
    """Synopsis:
---
---
 dynExport(
...
def dynExpression(creation: boolean, runtime: boolean, runtimeAfterDynamics: boolean, runtimeBeforeDynamics: boolean, string: string) -> string:
    """Synopsis:
---
---
 dynExpression(
...
def dynGlobals(active: boolean, listAll: boolean, overSampling: int) -> int | string:
    """Synopsis:
---
---
...
def dynParticleCtx(conserve: float, cursorPlacement: boolean, exists: boolean, grid: boolean, gridSpacing: float, history: boolean, image1: string, image2: string, image3: string, jitterRadius: float, lowerLeftX: float, lowerLeftY: float, lowerLeftZ: float, name: string, nucleus: boolean, numJitters: int, particleName: string, sketch: boolean, sketchInterval: int, textPlacement: boolean, upperRightX: float, upperRightY: float, upperZ: float) -> None:
    """Synopsis:
---
---
 dynParticleCtx(
...
def dynPref(autoCreate: boolean, echoCollision: boolean, runupFrom: int, runupToCurrentTime: boolean, saveOnQuit: boolean, saveRuntimeState: boolean) -> None:
    """Synopsis:
---
---
