...
def makeIdentity(apply: boolean, jointOrient: boolean, normal: uint, preserveNormals: boolean, rotate: boolean, scale: boolean, translate: boolean) -> None:
    """Synopsis:
---
---
 makeIdentity(
...
def makeLive(addObjects: boolean, none: boolean, registry: int, registryCount: boolean, registryReset: boolean, registrySize: int, removeObjects: boolean) -> None:
    """Synopsis:
---
---
 makeLive(
...
def makePaintable(activate: boolean, activateAll: boolean, altAttribute: string, attrType: string, clearAll: boolean, remove: boolean, shapeMode: string, uiName: string) -> None:
    """Synopsis:
---
---
...
def makeSingleSurface(caching: boolean, constructionHistory: boolean, name: string, nodeState: int, object: boolean, stitchTolerance: float) -> list[string]:
    """Synopsis:
---
---
 makeSingleSurface(
...
def makebot(checkdepends: boolean, checkres: uint, input: string, nooverwrite: boolean, output: string, verbose: boolean) -> None:
    """Synopsis:
---
---
...
def manipMoveContext(activeHandle: int, activeHandleNormal: int, alignAlong: tuple[float, float, float], bakePivotOri: boolean, constrainAlongNormal: boolean, currentActiveHandle: int, editPivotMode: boolean, editPivotPosition: boolean, exists: boolean, image1: string, image2: string, image3: string, interactiveUpdate: boolean, lastMode: int, manipVisible: boolean, mode: int, orientAxes: tuple[float, float, float], orientJoint: string, orientJointEnabled: boolean, orientObject: string, orientTowards: tuple[float, float, float], pinPivot: boolean, pivotOriHandle: boolean, position: boolean, postCommand: script, postDragCommand: tuple[script, string], preCommand: script, preDragCommand: tuple[script, string], preserveChildPosition: boolean, preserveUV: boolean, reflection: boolean, reflectionAbout: int, reflectionAxis: int, reflectionTolerance: float, resetPivotMode: int, secondaryAxisOrient: string, snap: boolean, snapComponentsRelative: boolean, snapLiveFaceCenter: boolean, snapLivePoint: boolean, snapPivotOri: boolean, snapPivotPos: boolean, snapRelative: boolean, snapValue: float, translate: tuple[float, float, float], tweakMode: boolean, xformConstraint: string) -> string:
    """Synopsis:
---
---
 manipMoveContext(
...
def manipMoveLimitsCtx(exists: boolean, history: boolean, image1: string, image2: string, image3: string, name: string) -> string:
    """Synopsis:
---
---
...
def manipPivot(bakeOri: boolean, moveToolOri: int, ori: tuple[float, float, float], oriValid: boolean, pinPivot: boolean, pos: tuple[float, float, float], posValid: boolean, reset: boolean, resetMode: int, resetOri: boolean, resetPos: boolean, rotateToolOri: int, scaleToolOri: int, snapOri: boolean, snapPos: boolean, valid: boolean) -> None:
    """Synopsis:
---
---
...
def manipRotateContext(activeHandle: int, alignAlong: tuple[float, float, float], bakePivotOri: boolean, centerTrackball: boolean, constrainAlongNormal: boolean, currentActiveHandle: int, editPivotMode: boolean, editPivotPosition: boolean, exists: boolean, image1: string, image2: string, image3: string, lastMode: int, manipVisible: boolean, mode: int, modifyTranslation: boolean, orientAxes: tuple[float, float, float], orientObject: string, orientTowards: tuple[float, float, float], pinPivot: boolean, pivotOriHandle: boolean, position: boolean, postCommand: script, postDragCommand: tuple[script, string], preCommand: script, preDragCommand: tuple[script, string], preserveChildPosition: boolean, preserveUV: boolean, reflection: boolean, reflectionAbout: int, reflectionAxis: int, reflectionTolerance: float, resetPivotMode: int, rotate: tuple[float, float, float], snap: boolean, snapPivotOri: boolean, snapPivotPos: boolean, snapRelative: boolean, snapValue: float, tweakMode: boolean, useCenterPivot: boolean, useManipPivot: boolean, useObjectPivot: boolean, xformConstraint: string) -> string:
    """Synopsis:
---
---
 manipRotateContext(
...
def manipRotateLimitsCtx(exists: boolean, history: boolean, image1: string, image2: string, image3: string, name: string) -> string:
    """Synopsis:
---
---
...
def manipScaleContext(activeHandle: int, alignAlong: tuple[float, float, float], bakePivotOri: boolean, constrainAlongNormal: boolean, currentActiveHandle: int, editPivotMode: boolean, editPivotPosition: boolean, exists: boolean, image1: string, image2: string, image3: string, lastMode: int, manipVisible: boolean, mode: int, orientAxes: tuple[float, float, float], orientObject: string, orientTowards: tuple[float, float, float], pinPivot: boolean, pivotOriHandle: boolean, position: boolean, postCommand: script, postDragCommand: tuple[script, string], preCommand: script, preDragCommand: tuple[script, string], preserveChildPosition: boolean, preserveUV: boolean, preventNegativeScale: boolean, reflection: boolean, reflectionAbout: int, reflectionAxis: int, reflectionTolerance: float, resetPivotMode: int, scale: tuple[float, float, float], snap: boolean, snapPivotOri: boolean, snapPivotPos: boolean, snapRelative: boolean, snapValue: float, tweakMode: boolean, useManipPivot: boolean, useObjectPivot: boolean, xformConstraint: string) -> string:
    """Synopsis:
---
---
 manipScaleContext(
...
def manipScaleLimitsCtx(exists: boolean, history: boolean, image1: string, image2: string, image3: string, name: string) -> string:
    """Synopsis:
---
---
...
def marker(attach: boolean, detach: boolean, frontTwist: angle, orientationMarker: boolean, positionMarker: boolean, sideTwist: angle, time: time, upTwist: angle, valueU: float) -> list[string]:
    """Synopsis:
---
---
 marker(
...
def matchTransform(pivots: boolean, position: boolean, positionX: boolean, positionY: boolean, positionZ: boolean, rotatePivot: boolean, rotation: boolean, rotationX: boolean, rotationY: boolean, rotationZ: boolean, scale: boolean, scaleBox: boolean, scalePivot: boolean, scaleX: boolean, scaleY: boolean, scaleZ: boolean) -> None:
    """Synopsis:
---
---
 matchTransform(
...
def matrixUtil(inverse: boolean, quaternion: tuple[float, float, float, float], relative: boolean, rotation: tuple[float, float, float], scale: tuple[float, float, float], shear: tuple[float, float, float], translation: tuple[float, float, float], transpose: boolean) -> string:
    """Synopsis:
---
---
...
def mayaDpiSetting(mode: uint, realScaleValue: boolean, scaleValue: float, systemDpi: boolean) -> float | int:
    """Synopsis:
---
---
...
def mayaHasRenderSetup(enableCurrentSession: boolean, enableDuringTests: boolean) -> None:
    """Synopsis:
---
---
...
def melOptions(duplicateVariableWarnings: boolean) -> None:
    """Synopsis:
---
---
...
def memory(adjustedVirtualMemory: boolean, asFloat: boolean, debug: boolean, freeMemory: boolean, gigaByte: boolean, heapMemory: boolean, kiloByte: boolean, megaByte: boolean, pageFaults: boolean, pageReclaims: boolean, physicalMemory: boolean, processVirtualMemory: boolean, summary: boolean, swapFree: boolean, swapLogical: boolean, swapMax: boolean, swapPhysical: boolean, swapReserved: boolean, swapVirtual: boolean, swaps: boolean) -> None:
    """Synopsis:
---
---
...
def menu(allowOptionBoxes: boolean, defineTemplate: string, deleteAllItems: boolean, docTag: string, enable: boolean, exists: boolean, familyImage: string, helpMenu: boolean, itemArray: boolean, label: string, mnemonic: string, numberOfItems: boolean, parent: string, postMenuCommand: script, postMenuCommandOnce: boolean, scrollable: boolean, tearOff: boolean, useTemplate: string, version: string, visible: boolean) -> string:
    """Synopsis:
---
---
 menu(
...
def menuEditor(annotation: string, backgroundColor: tuple[float, float, float], cellHeight: int, cellWidth: int, cellWidthHeight: tuple[int, int], checkBoxPresent: tuple[boolean, string, int], checkBoxState: tuple[boolean, string, int], command: tuple[string, string, int], defineTemplate: string, delete: tuple[string, int], docTag: string, dragCallback: script, dropCallback: script, enable: boolean, enableBackground: boolean, enableKeyboardFocus: boolean, exists: boolean, fullPathName: boolean, height: int, highlightColor: tuple[float, float, float], iconMenuCallback: string, image: tuple[string, string, int], isObscured: boolean, label: tuple[string, string, int], manage: boolean, menuItemTypes: boolean, noBackground: boolean, numberOfPopupMenus: boolean, optionBoxCommand: tuple[string, string, int], optionBoxPresent: tuple[boolean, string, int], parent: string, popupMenuArray: boolean, preventOverride: boolean, radioButtonPresent: tuple[boolean, string, int], radioButtonState: tuple[boolean, string, int], separator: tuple[string, int], statusBarMessage: string, style: string, subMenuAt: tuple[string, int], subMenuEditorWindow: string, subMenuEditorsOpen: boolean, subMenuOf: tuple[string, string, int], topLevelMenu: string, useTemplate: string, visible: boolean, visibleChangeCommand: script, width: int) -> string:
    """Synopsis:
---
---
 menuEditor(
...
def menuSet(addMenu: string, allMenuSets: boolean, currentMenuSet: string, exists: string, hotBoxVisible: boolean, insertMenu: tuple[string, uint], label: string, menuArray: list[string], moveMenu: tuple[string, uint], moveMenuSet: tuple[string, uint], numberOfMenuSets: boolean, numberOfMenus: boolean, permanent: boolean, removeMenu: string, removeMenuSet: string) -> string:
    """Synopsis:
---
---
 menuSet(
...
def menuSetPref(exists: boolean, force: boolean, loadAll: boolean, removeAll: boolean, saveAll: boolean, saveBackup: boolean, version: boolean) -> None:
    """Synopsis:
---
---
 menuSetPref(
...
def mimicManipulation(manipulations: string, prevalidation: boolean, refresh: boolean) -> boolean[]:
    """Synopsis:
---
---
...
def mirrorJoint(mirrorBehavior: boolean, mirrorXY: boolean, mirrorXZ: boolean, mirrorYZ: boolean, searchReplace: tuple[string, string]) -> list[string]:
    """Synopsis:
---
---
 mirrorJoint(
...
def modelCurrentTimeCtx(exists: boolean, history: boolean, image1: string, image2: string, image3: string, name: string, percent: float) -> string:
    """Synopsis:
---
---
 modelCurrentTimeCtx(
...
def modelPanel(barLayout: boolean, camera: string, control: boolean, copy: string, createString: boolean, defineTemplate: string, docTag: string, editString: boolean, exists: boolean, init: boolean, isUnique: boolean, label: string, menuBarRepeatLast: boolean, menuBarVisible: boolean, modelEditor: boolean, needsInit: boolean, parent: string, popupMenuProcedure: script, replacePanel: string, tearOff: boolean, tearOffCopy: string, tearOffRestore: boolean, unParent: boolean, useTemplate: string) -> string:
    """Synopsis:
---
---
 modelPanel(
...
def moduleInfo(definition: boolean, listModules: boolean, moduleName: string, path: boolean, version: boolean) -> list[string]:
    """Synopsis:
---
---
...
def mouse(enableScrollWheel: boolean, mouseButtonTracking: int, mouseButtonTrackingStatus: boolean, scrollWheelStatus: boolean) -> int:
    """Synopsis:
---
---
...
def movIn(file: string, startTime: time) -> None:
    """Synopsis:
---
---
 movIn(
...
def movOut(comment: boolean, file: string, precision: uint, time: timerange) -> None:
    """Synopsis:
---
---
 movOut(
...
def moveKeyCtx(exists: boolean, history: boolean, image1: string, image2: string, image3: string, moveFunction: string, name: string, option: string) -> string:
    """Synopsis:
---
---
 moveKeyCtx(
...
def moveVertexAlongDirection(direction: tuple[float, float, float], magnitude: linear, normalDirection: linear, uDirection: linear, uvNormalDirection: tuple[linear, linear, linear], vDirection: linear) -> None:
    """Synopsis:
---
---
...
def movieInfo(counter: boolean, dropFrame: boolean, frameCount: boolean, frameDuration: boolean, height: boolean, movieTexture: boolean, negTimesOK: boolean, numFrames: boolean, quickTime: boolean, timeCode: boolean, timeCodeTrack: boolean, timeScale: boolean, twentyFourHourMax: boolean, width: boolean) -> None:
    """Synopsis:
---
---
...
def multiProfileBirailSurface(caching: boolean, constructionHistory: boolean, name: string, nodeState: int, object: boolean, polygon: int, tangentContinuityProfile1: boolean, tangentContinuityProfile2: boolean, transformMode: int) -> list[string]:
    """Synopsis:
---
---
...
def multiTouch(gestures: boolean, trackpad: uint) -> None:
    """Synopsis:
---
---
...
def mute(disable: boolean, force: boolean) -> list[string]:
    """Synopsis:
---
---
